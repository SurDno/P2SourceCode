...
public static class EasingFunction
{
  ...
  public static float EaseInOutBounce(float start, float end, float value)
  {
    ...
    float num = 1f;
    return value < num * 0.5 ? EaseInBounce(0.0f, end, value * 2f) * 0.5f + start : (float) (EaseOutBounce(0.0f, end, value * 2f - num) * 0.5 + end * 0.5) + start;
  }
  ...
  public static float EaseOutElastic(float start, float end, float value)
  {
    ...
    if (num3 == 0.0 || num3 < (double) Mathf.Abs(end))
    {
      ...
      num4 = num2 / 6.28318548f * Mathf.Asin(end / num3);
    return num3 * Mathf.Pow(2f, -10f * value) * Mathf.Sin((float) ((value * (double) num1 - num4) * 6.2831854820251465) / num2) + end + start;
  }
  ...
  public static float EaseInOutBounceD(float start, float end, float value)
  {
    ...
    float num = 1f;
    return value < num * 0.5 ? EaseInBounceD(0.0f, end, value * 2f) * 0.5f : EaseOutBounceD(0.0f, end, value * 2f - num) * 0.5f;
  }

  public static float EaseInBackD(float start, float end, float value)
  {
    float num = 1.70158f;
    return (float) (3.0 * (num + 1.0) * (end - (double) start) * value * value - 2.0 * num * (end - (double) start) * value);
  }
  ...
  public static float EaseInOutBackD(float start, float end, float value)
  {
    ...
    {
      float num2 = num1 * 1.525f;
      return (float) (0.5 * end * (num2 + 1.0) * value * value + end * (double) value * ((num2 + 1.0) * value - num2));
    }
    value -= 2f;
    float num3 = num1 * 1.525f;
