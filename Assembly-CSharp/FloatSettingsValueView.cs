...
public class FloatSettingsValueView : SettingsValueView<float> {
	...
	public override void ApplyVisibleValue() {
		SettingsValue.Value = visibleValue;
	}
	...
	private void OnValueChanged(float value) {
		if (changeEventDisabled)
			return;
		var visibleValue = this.visibleValue;
	...
	public override void RevertVisibleValue() {
		SetVisibleValue(SettingsValue.Value);
	}
	...
	private void UpdateName() {
		var valueText = this.valueText;
		var valueNameFunction = this.valueNameFunction;
		var str = valueNameFunction != null ? valueNameFunction(visibleValue) : null;
