...
public class DialogLightingProfile : ScriptableObject {
	[SerializeField] private Vector2 keyLightRotation = new(15f, -120f);
	[SerializeField] private Vector2 backLightRotation = new(0.0f, 30f);
	[SerializeField] private Vector2 fillLightRotation = new(-15f, 90f);
