...
public class NpcStateDialogNpc : INpcState {
	...
	public NpcStateStatusEnum Status =>
		!infinite && timeLeft <= 0.0 ? NpcStateStatusEnum.Success : NpcStateStatusEnum.Running;
	...
	public void Activate(GameObject targetCharacter, float time, bool speaking) {
		...
		var setupPoint = npcState.Owner.GetComponent<NavigationComponent>().SetupPoint;
		var animationSetup = poiSetup.GetAnimationSetup(POIAnimationEnum.S_Dialog);
