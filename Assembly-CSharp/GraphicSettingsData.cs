...
public class GraphicSettingsData : ScriptableObjectInstance<GraphicSettingsData> {
	[Space] [SerializeField] private ShadowSettings[] shadowSettings;
	[Space] [SerializeField] private TextureSettings[] textureSettings;
	[Space] [SerializeField] private int defaultPreset;
	[SerializeField] private GraphicSettingsPreset[] presets;
	...
	public int MaxSupportedTextureSettings() {
		for (var index = 0; index < textureSettings.Length; ++index)
