...
public class JoystickLayoutSwitcher {
	...
	public KeyLayouts CurrentLayout {
		...
		private set {
			...
			var onLayoutChanged = OnLayoutChanged;
	...
	public float JoystickLayoutValidation(float value) {
		return SettingsViewUtility.RoundValue(value, 1f);
	}
