...
public class Lipsync : MonoBehaviour
{
  ...
  private void LateUpdate() => UpdateAnnoLipsync();

  private void UpdateLipsync(int msTime)
  {
    animator.SetFloat("Random", Random.value);
    PhonemeMixtureArticulationData lipsyncAtTime = annoReader.GetLipsyncAtTime(msTime);
    animator.SetInteger("LipSync/PhonemeIndex0", lipsyncAtTime.Constituents[0].Phoneme);
    layer0Weigth = !LipsyncUtility.Vowels.Contains(lipsyncAtTime.Constituents[0].Phoneme) ? Mathf.MoveTowards(layer0Weigth, lipsyncAtTime.Constituents[0].Weight, Time.deltaTime / consonantSmoothTime) : Mathf.MoveTowards(layer0Weigth, lipsyncAtTime.Constituents[0].Weight, Time.deltaTime / vowelsSmoothTime);
    ...
    if (lipsyncAtTime.Constituents.Length > 1)
    {
      ...
      layer1Weigth = !LipsyncUtility.Vowels.Contains(lipsyncAtTime.Constituents[1].Phoneme) ? Mathf.MoveTowards(layer1Weigth, lipsyncAtTime.Constituents[1].Weight, Time.deltaTime / consonantSmoothTime) : Mathf.MoveTowards(layer1Weigth, lipsyncAtTime.Constituents[1].Weight, Time.deltaTime / vowelsSmoothTime);
    ...
    if (lipsyncAtTime.Constituents.Length > 2)
    {
      ...
      layer2Weigth = !LipsyncUtility.Vowels.Contains(lipsyncAtTime.Constituents[2].Phoneme) ? Mathf.MoveTowards(layer2Weigth, lipsyncAtTime.Constituents[2].Weight, Time.deltaTime / consonantSmoothTime) : Mathf.MoveTowards(layer2Weigth, lipsyncAtTime.Constituents[2].Weight, Time.deltaTime / vowelsSmoothTime);
