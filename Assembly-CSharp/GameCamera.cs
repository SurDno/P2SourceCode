...
public class GameCamera : EngineDependent {
	...
	[SerializeField] private PostProcessingStackOverride settingsPostProcessingOverride;
	[SerializeField] private PostProcessingStackOverride gamePostProcessingOverride;
	...
	private void ApplyFov() {
		var num = cutsceneFov != 0.0
			? cutsceneFov
			: InstanceByRequest<GraphicsGameSettings>.Instance.FieldOfView.Value + additionalFov;
		Camera.fieldOfView = num;
		for (var index = 0; index < additionalCameras.Length; ++index)
