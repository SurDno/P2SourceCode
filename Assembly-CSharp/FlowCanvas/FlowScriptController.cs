...
public class FlowScriptController : MonoBehaviour, ISerializationCallbackReceiver {
	...
	[SerializeField] private string boundGraphSerialization = "";
	[SerializeField] private List<Object> boundGraphObjectReferences = new();
	[HideInInspector] public EnableAction enableAction = EnableAction.EnableBehaviour;
	[HideInInspector] public DisableAction disableAction = DisableAction.DisableBehaviour;
	...
	void ISerializationCallbackReceiver.OnAfterDeserialize() {
		...
		if (EngineApplication.MainThread == Thread.CurrentThread &&
		    ExternalSettingsInstance<ExternalOptimizationSettings>.Instance.BlueprintsInSeparateThread) {
