...
// Type: FlowCanvas.Nodes.PureFunctionNode`10
...
namespace FlowCanvas.Nodes
{
    ...
    PureFunctionNodeBase
  {
    ...
    protected override sealed void OnRegisterPorts(FlowNode node)
    {
      ...
      node.AddValueOutput<TResult>("Value", (ValueHandler<TResult>) (() => this.Invoke(p1.value, p2.value, p3.value, p4.value, p5.value, p6.value, p7.value, p8.value, p9.value)));
    }
  }
}
