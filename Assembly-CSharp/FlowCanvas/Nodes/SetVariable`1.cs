...
public class SetVariable<T> : FlowNode {
	...
	public override string name =>
		string.Format("{0}{1}{2}", targetVariable, OperationTools.GetOperationString(operation), "Value");
		...
		if (operation != 0) {
			if (typeof(T) == typeof(float))
				...
				targetVariable.value =
					(T)(object)OperationTools.Operate((int)(object)targetVariable.value, (int)(object)value, operation);
