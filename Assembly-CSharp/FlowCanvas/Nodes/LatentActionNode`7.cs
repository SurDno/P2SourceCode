...
// Type: FlowCanvas.Nodes.LatentActionNode`7
...
namespace FlowCanvas.Nodes
{
  public abstract class LatentActionNode<T1, T2, T3, T4, T5, T6, T7> : LatentActionNodeBase
  {
    ...
    protected override sealed void OnRegisterPorts(FlowNode node)
    {
      ...
      node.AddFlowInput("In", (FlowHandler) (() => this.Begin(this.Invoke(p1.value, p2.value, p3.value, p4.value, p5.value, p6.value, p7.value))));
