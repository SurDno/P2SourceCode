...
public class GameSettingsData : ScriptableObjectInstance<GameSettingsData> {
	[Header("Common")] public LayerMask FlamethrowerLayer;
	...
	[Header("Mixers")] public AudioMixerGroup NpcSpeechOutdoorMixer;
	...
	[Header("Steps")] public LayerMask PuddlesLayer;
	public LayerMask StepsLayer;
	[Header("Times")] public DateTimeField OffsetTime;
	public TimeSpanField Morning;
	public TimeSpanField Day;
	public TimeSpanField Evening;
	public TimeSpanField Night;
	[Header("Navigation")] public int IndoorNavigationAreaIndex;
