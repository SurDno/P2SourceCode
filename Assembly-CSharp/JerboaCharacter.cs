...
public class JerboaCharacter : MonoBehaviour {
	...
	public void Attack() {
		jerboaAnimator.SetTrigger(nameof(Attack));
	}

	public void Hit() {
		jerboaAnimator.SetTrigger(nameof(Hit));
	}

	public void Grooming() {
		jerboaAnimator.SetTrigger(nameof(Grooming));
	}
	...
	private void CheckGroundStatus() {
		isGrounded = Physics.Raycast(transform.position + transform.up * groundCheckOffset, Vector3.down, out var _,
			groundCheckDistance);
