...
public class ReputationIsLow : Conditional, IStub, ISerializeDataWrite, ISerializeDataRead
{
  ...
  public override void OnAwake()
  {
    ...
    else
    {
      ...
      if (navigation != null)
        return;
      Debug.LogWarningFormat("{0}: doesn't contain {1} engine component", (object) gameObject.name, (object) typeof (INavigationComponent).Name);
    }
  }

  public override TaskStatus OnUpdate()
  {
    return entity == null || navigation == null || navigation.Region == null || navigation.Region.Reputation == null ? TaskStatus.Failure : (navigation.Region.Reputation.Value < (double) Threshold.Value ? TaskStatus.Success : TaskStatus.Failure);
  }
