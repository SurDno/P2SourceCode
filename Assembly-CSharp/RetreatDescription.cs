...
public class RetreatDescription : ScriptableObject {
	[Header("Передвижение")] [Tooltip("Если дистанция до игрока меньше, то NPC бежит задом")]
	...
	[Header("Другое")] [Tooltip("Если дистанция до игрока меньше, то NPC может атаковать")]
