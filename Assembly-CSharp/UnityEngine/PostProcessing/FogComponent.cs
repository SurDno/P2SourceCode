...
public sealed class FogComponent : PostProcessingComponentCommandBuffer<FogModel> {
	...
	public override bool active =>
		model.enabled && context.isGBufferAvailable && RenderSettings.fog && !context.interrupted;
	...
	public override void PopulateCommandBuffer(CommandBuffer cb) {
		...
		var mat = context.materialFactory.Get("Hidden/Post FX/Fog");
		mat.shaderKeywords = null;
		var color = GraphicsUtils.isLinearColorSpace ? RenderSettings.fogColor.linear : RenderSettings.fogColor;
