...
namespace UnityEngine.PostProcessing
{
    ...
    PostProcessingComponentRenderTexture<EyeAdaptationModel>
  {
    ...
    {
      get => this.model.enabled && SystemInfo.supportsComputeShaders && !this.context.interrupted;
    }
    ...
    private Vector4 GetHistogramScaleOffsetRes()
    {
      ...
      return new Vector4(x, y, Mathf.Max(1f, Mathf.Floor((float) this.context.width / 2f)), Mathf.Max(1f, Mathf.Floor((float) this.context.height / 2f)));
    }
