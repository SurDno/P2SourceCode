...
public sealed class AmbientOcclusionComponent :
	...
	private OcclusionSource occlusionSource {
		get {
			...
			return model.settings.highPrecision &&
			       (!context.isGBufferAvailable || model.settings.forceForwardCompatibility)
				? OcclusionSource.DepthTexture
				: OcclusionSource.DepthNormalsTexture;
		}
	}

	private bool ambientOnlySupported => context.isHdr && model.settings.ambientOnly && context.isGBufferAvailable &&
	...
	public override DepthTextureMode GetCameraFlags() {
		var cameraFlags = DepthTextureMode.None;
	...
	public override CameraEvent GetCameraEvent() {
		return !ambientOnlySupported ||
		       context.profile.debugViews.IsModeActive(BuiltinDebugViewsModel.Mode.AmbientOcclusion)
	...
	public override void PopulateCommandBuffer(CommandBuffer cb) {
		...
		var material = context.materialFactory.Get("Hidden/Post FX/Ambient Occlusion");
		...
		var num = settings.downsampling ? 2 : 1;
		var occlusionTexture1 = Uniforms._OcclusionTexture1;
		cb.GetTemporaryRT(occlusionTexture1, width / num, height / num, 0, FilterMode.Bilinear,
			RenderTextureFormat.ARGB32, RenderTextureReadWrite.Linear);
		cb.Blit(null, occlusionTexture1, material, (int)occlusionSource);
		var occlusionTexture2 = Uniforms._OcclusionTexture2;
		cb.GetTemporaryRT(occlusionTexture2, width, height, 0, FilterMode.Bilinear, RenderTextureFormat.ARGB32,
		...
		var occlusionTexture = Uniforms._OcclusionTexture;
		cb.GetTemporaryRT(occlusionTexture, width, height, 0, FilterMode.Bilinear, RenderTextureFormat.ARGB32,
			RenderTextureReadWrite.Linear);
