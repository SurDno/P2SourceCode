...
public abstract class SettingsValueView<T> :
	...
	protected void FireVisibleValueChangeEvent() {
		var valueChangeEvent = VisibleValueChangeEvent;
	...
	public void OnPointerEnter(PointerEventData eventData) {
		var pointerEnterEvent = PointerEnterEvent;
	...
	public void OnPointerExit(PointerEventData eventData) {
		var pointerExitEvent = PointerExitEvent;
	...
	public void SetSetting(IValue<T> settingsValue) {
