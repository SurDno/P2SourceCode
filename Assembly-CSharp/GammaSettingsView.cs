...
public class GammaSettingsView : MonoBehaviour {
	[SerializeField] private FloatSettingsValueView view;
	[SerializeField] private Button pcButton;
	[SerializeField] private GameObject controllButtonHint;
	private Coroutine changingCoroutine;
	private bool InputBlocked;

	private void Awake() {
		var gamma = InstanceByRequest<GraphicsGameSettings>.Instance.Gamma;
