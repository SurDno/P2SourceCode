...
namespace SteamNative
{
  ...
  internal struct LeaderboardFindResult_t
  {
    ...
    {
      return Platform.PackSmall ? (PackSmall) Marshal.PtrToStructure(p, typeof (PackSmall)) : (LeaderboardFindResult_t) Marshal.PtrToStructure(p, typeof (LeaderboardFindResult_t));
    }
      ...
      Action<LeaderboardFindResult_t, bool> CallbackFunction)
    {
      ...
      if (Config.UseThisCall)
      {
        ...
        Callback.ThisCall.GetSize d3 = _ => Marshal.SizeOf(typeof (LeaderboardFindResult_t));
      ...
      else
      {
        ...
        Callback.StdCall.GetSize d6 = () => Marshal.SizeOf(typeof (LeaderboardFindResult_t));
        if (Platform.PackSmall)
    ...
    internal struct PackSmall
    {
      ...
      public static implicit operator LeaderboardFindResult_t(PackSmall d)
      {
