...
namespace SteamNative
{
  ...
  internal struct DownloadClanActivityCountsResult_t
  {
    ...
    {
      return Platform.PackSmall ? (PackSmall) Marshal.PtrToStructure(p, typeof (PackSmall)) : (DownloadClanActivityCountsResult_t) Marshal.PtrToStructure(p, typeof (DownloadClanActivityCountsResult_t));
    }
      ...
      Action<DownloadClanActivityCountsResult_t, bool> CallbackFunction)
    {
      ...
      if (Config.UseThisCall)
      {
        ...
        Callback.ThisCall.GetSize d3 = _ => Marshal.SizeOf(typeof (DownloadClanActivityCountsResult_t));
      ...
      else
      {
        ...
        Callback.StdCall.GetSize d6 = () => Marshal.SizeOf(typeof (DownloadClanActivityCountsResult_t));
        if (Platform.PackSmall)
