...
internal struct GSStatsReceived_t {
	public const int CallbackId = 1800;
	...
	public static GSStatsReceived_t FromPointer(IntPtr p) {
		return Platform.PackSmall
			...
			: (GSStatsReceived_t)Marshal.PtrToStructure(p, typeof(GSStatsReceived_t));
	}

	public static CallbackHandle CallResult(
		BaseSteamworks steamworks,
		SteamAPICall_t call,
		Action<GSStatsReceived_t, bool> CallbackFunction) {
	...
	public static void RegisterCallback(
		...
		steamworks.native.api.SteamAPI_RegisterCallback(handle.PinnedCallback.AddrOfPinnedObject(), 1800);
