...
namespace SteamNative
{
  ...
  internal struct CreateItemResult_t
  {
    ...
    {
      return Platform.PackSmall ? (PackSmall) Marshal.PtrToStructure(p, typeof (PackSmall)) : (CreateItemResult_t) Marshal.PtrToStructure(p, typeof (CreateItemResult_t));
    }
      ...
      Action<CreateItemResult_t, bool> CallbackFunction)
    {
      ...
      if (Config.UseThisCall)
      {
        ...
        Callback.ThisCall.GetSize d3 = _ => Marshal.SizeOf(typeof (CreateItemResult_t));
      ...
      else
      {
        ...
        Callback.StdCall.GetSize d6 = () => Marshal.SizeOf(typeof (CreateItemResult_t));
        if (Platform.PackSmall)
    ...
    internal struct PackSmall
    {
      ...
      public static implicit operator CreateItemResult_t(PackSmall d)
      {
