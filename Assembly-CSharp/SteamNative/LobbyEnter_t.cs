...
namespace SteamNative
{
  ...
  internal struct LobbyEnter_t
  {
    ...
    {
      return Platform.PackSmall ? (PackSmall) Marshal.PtrToStructure(p, typeof (PackSmall)) : (LobbyEnter_t) Marshal.PtrToStructure(p, typeof (LobbyEnter_t));
    }
      ...
      Action<LobbyEnter_t, bool> CallbackFunction)
    {
      ...
      if (Config.UseThisCall)
      {
        ...
        Callback.ThisCall.GetSize d3 = _ => Marshal.SizeOf(typeof (LobbyEnter_t));
      ...
      else
      {
        ...
        Callback.StdCall.GetSize d6 = () => Marshal.SizeOf(typeof (LobbyEnter_t));
        if (Platform.PackSmall)
    ...
    internal struct PackSmall
    {
      ...
      public static implicit operator LobbyEnter_t(PackSmall d)
      {
