...
namespace SteamNative
{
  ...
  internal struct SteamUGCRequestUGCDetailsResult_t
  {
    ...
    {
      return Platform.PackSmall ? (PackSmall) Marshal.PtrToStructure(p, typeof (PackSmall)) : (SteamUGCRequestUGCDetailsResult_t) Marshal.PtrToStructure(p, typeof (SteamUGCRequestUGCDetailsResult_t));
    }
      ...
      Action<SteamUGCRequestUGCDetailsResult_t, bool> CallbackFunction)
    {
      ...
      if (Config.UseThisCall)
      {
        ...
        Callback.ThisCall.GetSize d3 = _ => Marshal.SizeOf(typeof (SteamUGCRequestUGCDetailsResult_t));
      ...
      else
      {
        ...
        Callback.StdCall.GetSize d6 = () => Marshal.SizeOf(typeof (SteamUGCRequestUGCDetailsResult_t));
        if (Platform.PackSmall)
