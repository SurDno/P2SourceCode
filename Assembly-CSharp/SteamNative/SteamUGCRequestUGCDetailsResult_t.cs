...
// Type: SteamNative.SteamUGCRequestUGCDetailsResult_t
...
namespace SteamNative
{
  ...
  {
    public const int CallbackId = 3402;
    ...
    {
      return Platform.PackSmall ? (SteamUGCRequestUGCDetailsResult_t) (SteamUGCRequestUGCDetailsResult_t.PackSmall) Marshal.PtrToStructure(p, typeof (SteamUGCRequestUGCDetailsResult_t.PackSmall)) : (SteamUGCRequestUGCDetailsResult_t) Marshal.PtrToStructure(p, typeof (SteamUGCRequestUGCDetailsResult_t));
    }

    public static void RegisterCallback(
      BaseSteamworks steamworks,
      Action<SteamUGCRequestUGCDetailsResult_t, bool> CallbackFunction)
    {
      CallbackHandle handle = new CallbackHandle();
      handle.steamworks = steamworks;
      if (Config.UseThisCall)
      {
        Callback.ThisCall.Result d1 = (Callback.ThisCall.Result) ((_, p) => CallbackFunction(SteamUGCRequestUGCDetailsResult_t.FromPointer(p), false));
        Callback.ThisCall.ResultWithInfo d2 = (Callback.ThisCall.ResultWithInfo) ((_, p, bIOFailure, hSteamAPICall) => CallbackFunction(SteamUGCRequestUGCDetailsResult_t.FromPointer(p), bIOFailure));
        Callback.ThisCall.GetSize d3 = (Callback.ThisCall.GetSize) (_ => Marshal.SizeOf(typeof (SteamUGCRequestUGCDetailsResult_t)));
        if (Platform.PackSmall)
          d3 = (Callback.ThisCall.GetSize) (_ => Marshal.SizeOf(typeof (SteamUGCRequestUGCDetailsResult_t.PackSmall)));
      ...
      {
        Callback.StdCall.Result d4 = (Callback.StdCall.Result) (p => CallbackFunction(SteamUGCRequestUGCDetailsResult_t.FromPointer(p), false));
        Callback.StdCall.ResultWithInfo d5 = (Callback.StdCall.ResultWithInfo) ((p, bIOFailure, hSteamAPICall) => CallbackFunction(SteamUGCRequestUGCDetailsResult_t.FromPointer(p), bIOFailure));
        Callback.StdCall.GetSize d6 = (Callback.StdCall.GetSize) (() => Marshal.SizeOf(typeof (SteamUGCRequestUGCDetailsResult_t)));
        if (Platform.PackSmall)
          d6 = (Callback.StdCall.GetSize) (() => Marshal.SizeOf(typeof (SteamUGCRequestUGCDetailsResult_t.PackSmall)));
      ...
      steamworks.native.api.SteamAPI_RegisterCallback(handle.PinnedCallback.AddrOfPinnedObject(), 3402);
    ...
    internal struct PackSmall
    {
      ...
      public static implicit operator SteamUGCRequestUGCDetailsResult_t(
        SteamUGCRequestUGCDetailsResult_t.PackSmall d)
      {
