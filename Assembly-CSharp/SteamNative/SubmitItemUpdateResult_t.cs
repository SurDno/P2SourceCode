...
internal struct SubmitItemUpdateResult_t {
	...
	[MarshalAs(UnmanagedType.I1)] public bool UserNeedsToAcceptWorkshopLegalAgreement;
	...
	public static SubmitItemUpdateResult_t FromPointer(IntPtr p) {
		return Platform.PackSmall
			...
			: (SubmitItemUpdateResult_t)Marshal.PtrToStructure(p, typeof(SubmitItemUpdateResult_t));
	}
