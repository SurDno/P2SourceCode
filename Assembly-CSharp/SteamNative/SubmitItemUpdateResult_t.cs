...
namespace SteamNative
{
  ...
  internal struct SubmitItemUpdateResult_t
  {
    ...
    {
      return Platform.PackSmall ? (PackSmall) Marshal.PtrToStructure(p, typeof (PackSmall)) : (SubmitItemUpdateResult_t) Marshal.PtrToStructure(p, typeof (SubmitItemUpdateResult_t));
    }
      ...
      Action<SubmitItemUpdateResult_t, bool> CallbackFunction)
    {
      ...
      if (Config.UseThisCall)
      {
        ...
        Callback.ThisCall.GetSize d3 = _ => Marshal.SizeOf(typeof (SubmitItemUpdateResult_t));
      ...
      else
      {
        ...
        Callback.StdCall.GetSize d6 = () => Marshal.SizeOf(typeof (SubmitItemUpdateResult_t));
        if (Platform.PackSmall)
    ...
    internal struct PackSmall
    {
      ...
      public static implicit operator SubmitItemUpdateResult_t(PackSmall d)
      {
