...
// Type: SteamNative.GamepadTextInputDismissed_t
...
namespace SteamNative
{
  ...
  internal struct GamepadTextInputDismissed_t
  {
    ...
    {
      return Platform.PackSmall ? (GamepadTextInputDismissed_t) (GamepadTextInputDismissed_t.PackSmall) Marshal.PtrToStructure(p, typeof (GamepadTextInputDismissed_t.PackSmall)) : (GamepadTextInputDismissed_t) Marshal.PtrToStructure(p, typeof (GamepadTextInputDismissed_t));
    }
      ...
      Action<GamepadTextInputDismissed_t, bool> CallbackFunction)
    {
      ...
      {
        Callback.ThisCall.Result d1 = (Callback.ThisCall.Result) ((_, p) => CallbackFunction(GamepadTextInputDismissed_t.FromPointer(p), false));
        Callback.ThisCall.ResultWithInfo d2 = (Callback.ThisCall.ResultWithInfo) ((_, p, bIOFailure, hSteamAPICall) => CallbackFunction(GamepadTextInputDismissed_t.FromPointer(p), bIOFailure));
        Callback.ThisCall.GetSize d3 = (Callback.ThisCall.GetSize) (_ => Marshal.SizeOf(typeof (GamepadTextInputDismissed_t)));
        if (Platform.PackSmall)
          d3 = (Callback.ThisCall.GetSize) (_ => Marshal.SizeOf(typeof (GamepadTextInputDismissed_t.PackSmall)));
      ...
      {
        Callback.StdCall.Result d4 = (Callback.StdCall.Result) (p => CallbackFunction(GamepadTextInputDismissed_t.FromPointer(p), false));
        Callback.StdCall.ResultWithInfo d5 = (Callback.StdCall.ResultWithInfo) ((p, bIOFailure, hSteamAPICall) => CallbackFunction(GamepadTextInputDismissed_t.FromPointer(p), bIOFailure));
        Callback.StdCall.GetSize d6 = (Callback.StdCall.GetSize) (() => Marshal.SizeOf(typeof (GamepadTextInputDismissed_t)));
        if (Platform.PackSmall)
          d6 = (Callback.StdCall.GetSize) (() => Marshal.SizeOf(typeof (GamepadTextInputDismissed_t.PackSmall)));
    ...
    internal struct PackSmall
    {
      ...
      public static implicit operator GamepadTextInputDismissed_t(
        GamepadTextInputDismissed_t.PackSmall d)
      {
