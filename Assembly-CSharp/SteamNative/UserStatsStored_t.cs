...
namespace SteamNative
{
  ...
  internal struct UserStatsStored_t
  {
    ...
    {
      return Platform.PackSmall ? (PackSmall) Marshal.PtrToStructure(p, typeof (PackSmall)) : (UserStatsStored_t) Marshal.PtrToStructure(p, typeof (UserStatsStored_t));
    }
      ...
      Action<UserStatsStored_t, bool> CallbackFunction)
    {
      ...
      if (Config.UseThisCall)
      {
        ...
        Callback.ThisCall.GetSize d3 = _ => Marshal.SizeOf(typeof (UserStatsStored_t));
      ...
      else
      {
        ...
        Callback.StdCall.GetSize d6 = () => Marshal.SizeOf(typeof (UserStatsStored_t));
        if (Platform.PackSmall)
    ...
    internal struct PackSmall
    {
      ...
      public static implicit operator UserStatsStored_t(PackSmall d)
      {
