...
namespace SteamNative
{
  ...
  internal struct DownloadItemResult_t
  {
    ...
    {
      return Platform.PackSmall ? (PackSmall) Marshal.PtrToStructure(p, typeof (PackSmall)) : (DownloadItemResult_t) Marshal.PtrToStructure(p, typeof (DownloadItemResult_t));
    }
      ...
      Action<DownloadItemResult_t, bool> CallbackFunction)
    {
      ...
      if (Config.UseThisCall)
      {
        ...
        Callback.ThisCall.GetSize d3 = _ => Marshal.SizeOf(typeof (DownloadItemResult_t));
      ...
      else
      {
        ...
        Callback.StdCall.GetSize d6 = () => Marshal.SizeOf(typeof (DownloadItemResult_t));
        if (Platform.PackSmall)
    ...
    internal struct PackSmall
    {
      ...
      public static implicit operator DownloadItemResult_t(PackSmall d)
      {
