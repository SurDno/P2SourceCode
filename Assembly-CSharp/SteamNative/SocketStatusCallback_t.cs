...
namespace SteamNative
{
  ...
  internal struct SocketStatusCallback_t
  {
    ...
    {
      return Platform.PackSmall ? (PackSmall) Marshal.PtrToStructure(p, typeof (PackSmall)) : (SocketStatusCallback_t) Marshal.PtrToStructure(p, typeof (SocketStatusCallback_t));
    }
      ...
      Action<SocketStatusCallback_t, bool> CallbackFunction)
    {
      ...
      if (Config.UseThisCall)
      {
        ...
        Callback.ThisCall.GetSize d3 = _ => Marshal.SizeOf(typeof (SocketStatusCallback_t));
      ...
      else
      {
        ...
        Callback.StdCall.GetSize d6 = () => Marshal.SizeOf(typeof (SocketStatusCallback_t));
        if (Platform.PackSmall)
    ...
    internal struct PackSmall
    {
      ...
      public static implicit operator SocketStatusCallback_t(PackSmall d)
      {
