...
namespace SteamNative
{
  ...
  internal struct UserAchievementStored_t
  {
    ...
    {
      return Platform.PackSmall ? (PackSmall) Marshal.PtrToStructure(p, typeof (PackSmall)) : (UserAchievementStored_t) Marshal.PtrToStructure(p, typeof (UserAchievementStored_t));
    }
      ...
      Action<UserAchievementStored_t, bool> CallbackFunction)
    {
      ...
      if (Config.UseThisCall)
      {
        ...
        Callback.ThisCall.GetSize d3 = _ => Marshal.SizeOf(typeof (UserAchievementStored_t));
      ...
      else
      {
        ...
        Callback.StdCall.GetSize d6 = () => Marshal.SizeOf(typeof (UserAchievementStored_t));
        if (Platform.PackSmall)
    ...
    internal struct PackSmall
    {
      ...
      public static implicit operator UserAchievementStored_t(PackSmall d)
      {
