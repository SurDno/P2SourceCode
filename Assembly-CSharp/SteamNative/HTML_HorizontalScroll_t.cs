...
namespace SteamNative
{
  ...
  internal struct HTML_HorizontalScroll_t
  {
    ...
    {
      return Platform.PackSmall ? (PackSmall) Marshal.PtrToStructure(p, typeof (PackSmall)) : (HTML_HorizontalScroll_t) Marshal.PtrToStructure(p, typeof (HTML_HorizontalScroll_t));
    }
      ...
      Action<HTML_HorizontalScroll_t, bool> CallbackFunction)
    {
      ...
      if (Config.UseThisCall)
      {
        ...
        Callback.ThisCall.GetSize d3 = _ => Marshal.SizeOf(typeof (HTML_HorizontalScroll_t));
      ...
      else
      {
        ...
        Callback.StdCall.GetSize d6 = () => Marshal.SizeOf(typeof (HTML_HorizontalScroll_t));
        if (Platform.PackSmall)
    ...
    internal struct PackSmall
    {
      ...
      public static implicit operator HTML_HorizontalScroll_t(PackSmall d)
      {
