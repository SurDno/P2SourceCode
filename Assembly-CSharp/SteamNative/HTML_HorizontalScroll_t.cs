...
// Type: SteamNative.HTML_HorizontalScroll_t
...
namespace SteamNative
{
  ...
  internal struct HTML_HorizontalScroll_t
  {
    ...
    {
      return Platform.PackSmall ? (HTML_HorizontalScroll_t) (HTML_HorizontalScroll_t.PackSmall) Marshal.PtrToStructure(p, typeof (HTML_HorizontalScroll_t.PackSmall)) : (HTML_HorizontalScroll_t) Marshal.PtrToStructure(p, typeof (HTML_HorizontalScroll_t));
    }

    public static void RegisterCallback(
      BaseSteamworks steamworks,
      Action<HTML_HorizontalScroll_t, bool> CallbackFunction)
    {
      CallbackHandle handle = new CallbackHandle();
      handle.steamworks = steamworks;
      if (Config.UseThisCall)
      {
        Callback.ThisCall.Result d1 = (Callback.ThisCall.Result) ((_, p) => CallbackFunction(HTML_HorizontalScroll_t.FromPointer(p), false));
        Callback.ThisCall.ResultWithInfo d2 = (Callback.ThisCall.ResultWithInfo) ((_, p, bIOFailure, hSteamAPICall) => CallbackFunction(HTML_HorizontalScroll_t.FromPointer(p), bIOFailure));
        Callback.ThisCall.GetSize d3 = (Callback.ThisCall.GetSize) (_ => Marshal.SizeOf(typeof (HTML_HorizontalScroll_t)));
        if (Platform.PackSmall)
          d3 = (Callback.ThisCall.GetSize) (_ => Marshal.SizeOf(typeof (HTML_HorizontalScroll_t.PackSmall)));
      ...
      {
        Callback.StdCall.Result d4 = (Callback.StdCall.Result) (p => CallbackFunction(HTML_HorizontalScroll_t.FromPointer(p), false));
        Callback.StdCall.ResultWithInfo d5 = (Callback.StdCall.ResultWithInfo) ((p, bIOFailure, hSteamAPICall) => CallbackFunction(HTML_HorizontalScroll_t.FromPointer(p), bIOFailure));
        Callback.StdCall.GetSize d6 = (Callback.StdCall.GetSize) (() => Marshal.SizeOf(typeof (HTML_HorizontalScroll_t)));
        if (Platform.PackSmall)
          d6 = (Callback.StdCall.GetSize) (() => Marshal.SizeOf(typeof (HTML_HorizontalScroll_t.PackSmall)));
      ...
      steamworks.native.api.SteamAPI_RegisterCallback(handle.PinnedCallback.AddrOfPinnedObject(), 4511);
