...
// Type: SteamNative.SteamUnifiedMessagesSendMethodResult_t
...
namespace SteamNative
{
  ...
  {
    public const int CallbackId = 2501;
    public ulong Handle;
    ...
    {
      return Platform.PackSmall ? (SteamUnifiedMessagesSendMethodResult_t) (SteamUnifiedMessagesSendMethodResult_t.PackSmall) Marshal.PtrToStructure(p, typeof (SteamUnifiedMessagesSendMethodResult_t.PackSmall)) : (SteamUnifiedMessagesSendMethodResult_t) Marshal.PtrToStructure(p, typeof (SteamUnifiedMessagesSendMethodResult_t));
    }

    public static void RegisterCallback(
      BaseSteamworks steamworks,
      Action<SteamUnifiedMessagesSendMethodResult_t, bool> CallbackFunction)
    {
      CallbackHandle handle = new CallbackHandle();
      handle.steamworks = steamworks;
      if (Config.UseThisCall)
      {
        Callback.ThisCall.Result d1 = (Callback.ThisCall.Result) ((_, p) => CallbackFunction(SteamUnifiedMessagesSendMethodResult_t.FromPointer(p), false));
        Callback.ThisCall.ResultWithInfo d2 = (Callback.ThisCall.ResultWithInfo) ((_, p, bIOFailure, hSteamAPICall) => CallbackFunction(SteamUnifiedMessagesSendMethodResult_t.FromPointer(p), bIOFailure));
        Callback.ThisCall.GetSize d3 = (Callback.ThisCall.GetSize) (_ => Marshal.SizeOf(typeof (SteamUnifiedMessagesSendMethodResult_t)));
        if (Platform.PackSmall)
          d3 = (Callback.ThisCall.GetSize) (_ => Marshal.SizeOf(typeof (SteamUnifiedMessagesSendMethodResult_t.PackSmall)));
      ...
      {
        Callback.StdCall.Result d4 = (Callback.StdCall.Result) (p => CallbackFunction(SteamUnifiedMessagesSendMethodResult_t.FromPointer(p), false));
        Callback.StdCall.ResultWithInfo d5 = (Callback.StdCall.ResultWithInfo) ((p, bIOFailure, hSteamAPICall) => CallbackFunction(SteamUnifiedMessagesSendMethodResult_t.FromPointer(p), bIOFailure));
        Callback.StdCall.GetSize d6 = (Callback.StdCall.GetSize) (() => Marshal.SizeOf(typeof (SteamUnifiedMessagesSendMethodResult_t)));
        if (Platform.PackSmall)
          d6 = (Callback.StdCall.GetSize) (() => Marshal.SizeOf(typeof (SteamUnifiedMessagesSendMethodResult_t.PackSmall)));
      ...
      steamworks.native.api.SteamAPI_RegisterCallback(handle.PinnedCallback.AddrOfPinnedObject(), 2501);
    ...
    internal struct PackSmall
    {
      ...
      public static implicit operator SteamUnifiedMessagesSendMethodResult_t(
        SteamUnifiedMessagesSendMethodResult_t.PackSmall d)
      {
