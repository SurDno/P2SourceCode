...
namespace SteamNative
{
  ...
  internal struct SteamUnifiedMessagesSendMethodResult_t
  {
    ...
    {
      return Platform.PackSmall ? (PackSmall) Marshal.PtrToStructure(p, typeof (PackSmall)) : (SteamUnifiedMessagesSendMethodResult_t) Marshal.PtrToStructure(p, typeof (SteamUnifiedMessagesSendMethodResult_t));
    }
      ...
      Action<SteamUnifiedMessagesSendMethodResult_t, bool> CallbackFunction)
    {
      ...
      if (Config.UseThisCall)
      {
        ...
        Callback.ThisCall.GetSize d3 = _ => Marshal.SizeOf(typeof (SteamUnifiedMessagesSendMethodResult_t));
      ...
      else
      {
        ...
        Callback.StdCall.GetSize d6 = () => Marshal.SizeOf(typeof (SteamUnifiedMessagesSendMethodResult_t));
        if (Platform.PackSmall)
