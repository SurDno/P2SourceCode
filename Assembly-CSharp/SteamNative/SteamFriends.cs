...
internal class SteamFriends : IDisposable {
	...
	public CallbackHandle EnumerateFollowingList(
		...
		var call = platform.ISteamFriends_EnumerateFollowingList(unStartIndex);
		return CallbackFunction == null
			? null
			: FriendsEnumerateFollowingList_t.CallResult(steamworks, call, CallbackFunction);
	}
	...
	public bool GetClanActivityCounts(
		...
		out int pnInGame,
		out int pnChatting) {
		return platform.ISteamFriends_GetClanActivityCounts(steamIDClan.Value, out pnOnline, out pnInGame,
			out pnChatting);
	}
	...
	public int GetClanChatMessage(
		...
		return platform.ISteamFriends_GetClanChatMessage(steamIDClanChat.Value, iMessage, prgchText, cchTextMax,
			out peChatEntryType, out psteamidChatter.Value);
	}
	...
	public CallbackHandle GetFollowerCount(
		...
		SteamAPICall_t steamApiCallT = 0UL;
		var followerCount = platform.ISteamFriends_GetFollowerCount(steamID.Value);
		return CallbackFunction == null
			? null
			: FriendsGetFollowerCount_t.CallResult(steamworks, followerCount, CallbackFunction);
	}
	...
	public int GetFriendMessage(
		...
		int cubData,
		out ChatEntryType peChatEntryType) {
		return platform.ISteamFriends_GetFriendMessage(steamIDFriend.Value, iMessageID, pvData, cubData,
			out peChatEntryType);
	}
	...
	public string GetFriendPersonaNameHistory(CSteamID steamIDFriend, int iPersonaName) {
		return Marshal.PtrToStringAnsi(
			platform.ISteamFriends_GetFriendPersonaNameHistory(steamIDFriend.Value, iPersonaName));
	}
	...
	public string GetFriendRichPresenceKeyByIndex(CSteamID steamIDFriend, int iKey) {
		return Marshal.PtrToStringAnsi(
			platform.ISteamFriends_GetFriendRichPresenceKeyByIndex(steamIDFriend.Value, iKey));
	}
	...
	public CallbackHandle IsFollowing(
		...
		SteamAPICall_t steamApiCallT = 0UL;
		var call = platform.ISteamFriends_IsFollowing(steamID.Value);
	...
	public CallbackHandle JoinClanChatRoom(
		...
		SteamAPICall_t steamApiCallT = 0UL;
		var call = platform.ISteamFriends_JoinClanChatRoom(steamIDClan.Value);
		return CallbackFunction == null
			? null
			: JoinClanChatRoomCompletionResult_t.CallResult(steamworks, call, CallbackFunction);
	}
	...
	public CallbackHandle RequestClanOfficerList(
		...
		SteamAPICall_t steamApiCallT = 0UL;
		var call = platform.ISteamFriends_RequestClanOfficerList(steamIDClan.Value);
		return CallbackFunction == null
			? null
			: ClanOfficerListResponse_t.CallResult(steamworks, call, CallbackFunction);
	}
	...
	public CallbackHandle SetPersonaName(
		...
		SteamAPICall_t steamApiCallT = 0UL;
		var call = platform.ISteamFriends_SetPersonaName(pchPersonaName);
		return CallbackFunction == null
			? null
			: SetPersonaNameResponse_t.CallResult(steamworks, call, CallbackFunction);
	}
