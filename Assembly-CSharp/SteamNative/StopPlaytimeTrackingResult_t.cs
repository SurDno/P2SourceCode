...
namespace SteamNative
{
  ...
  internal struct StopPlaytimeTrackingResult_t
  {
    ...
    {
      return Platform.PackSmall ? (PackSmall) Marshal.PtrToStructure(p, typeof (PackSmall)) : (StopPlaytimeTrackingResult_t) Marshal.PtrToStructure(p, typeof (StopPlaytimeTrackingResult_t));
    }
      ...
      Action<StopPlaytimeTrackingResult_t, bool> CallbackFunction)
    {
      ...
      if (Config.UseThisCall)
      {
        ...
        Callback.ThisCall.GetSize d3 = _ => Marshal.SizeOf(typeof (StopPlaytimeTrackingResult_t));
      ...
      else
      {
        ...
        Callback.StdCall.GetSize d6 = () => Marshal.SizeOf(typeof (StopPlaytimeTrackingResult_t));
        if (Platform.PackSmall)
