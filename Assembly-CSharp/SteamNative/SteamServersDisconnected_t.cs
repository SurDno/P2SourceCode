...
namespace SteamNative
{
  ...
  internal struct SteamServersDisconnected_t
  {
    ...
    {
      return Platform.PackSmall ? (PackSmall) Marshal.PtrToStructure(p, typeof (PackSmall)) : (SteamServersDisconnected_t) Marshal.PtrToStructure(p, typeof (SteamServersDisconnected_t));
    }
      ...
      Action<SteamServersDisconnected_t, bool> CallbackFunction)
    {
      ...
      if (Config.UseThisCall)
      {
        ...
        Callback.ThisCall.GetSize d3 = _ => Marshal.SizeOf(typeof (SteamServersDisconnected_t));
      ...
      else
      {
        ...
        Callback.StdCall.GetSize d6 = () => Marshal.SizeOf(typeof (SteamServersDisconnected_t));
        if (Platform.PackSmall)
