...
namespace SteamNative
{
  ...
  internal struct RemoteStorageEnumerateUserSharedWorkshopFilesResult_t
  {
    ...
    {
      return Platform.PackSmall ? (PackSmall) Marshal.PtrToStructure(p, typeof (PackSmall)) : (RemoteStorageEnumerateUserSharedWorkshopFilesResult_t) Marshal.PtrToStructure(p, typeof (RemoteStorageEnumerateUserSharedWorkshopFilesResult_t));
    }
      ...
      Action<RemoteStorageEnumerateUserSharedWorkshopFilesResult_t, bool> CallbackFunction)
    {
      ...
      if (Config.UseThisCall)
      {
        ...
        Callback.ThisCall.GetSize d3 = _ => Marshal.SizeOf(typeof (RemoteStorageEnumerateUserSharedWorkshopFilesResult_t));
      ...
      else
      {
        ...
        Callback.StdCall.GetSize d6 = () => Marshal.SizeOf(typeof (RemoteStorageEnumerateUserSharedWorkshopFilesResult_t));
        if (Platform.PackSmall)
