...
namespace SteamNative
{
  ...
  internal struct RemoteStorageGetPublishedFileDetailsResult_t
  {
    ...
    {
      return Platform.PackSmall ? (PackSmall) Marshal.PtrToStructure(p, typeof (PackSmall)) : (RemoteStorageGetPublishedFileDetailsResult_t) Marshal.PtrToStructure(p, typeof (RemoteStorageGetPublishedFileDetailsResult_t));
    }
      ...
      Action<RemoteStorageGetPublishedFileDetailsResult_t, bool> CallbackFunction)
    {
      ...
      if (Config.UseThisCall)
      {
        ...
        Callback.ThisCall.GetSize d3 = _ => Marshal.SizeOf(typeof (RemoteStorageGetPublishedFileDetailsResult_t));
      ...
      else
      {
        ...
        Callback.StdCall.GetSize d6 = () => Marshal.SizeOf(typeof (RemoteStorageGetPublishedFileDetailsResult_t));
        if (Platform.PackSmall)
