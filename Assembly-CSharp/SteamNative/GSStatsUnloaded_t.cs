...
namespace SteamNative
{
  ...
  internal struct GSStatsUnloaded_t
  {
    ...
    {
      return Platform.PackSmall ? (PackSmall) Marshal.PtrToStructure(p, typeof (PackSmall)) : (GSStatsUnloaded_t) Marshal.PtrToStructure(p, typeof (GSStatsUnloaded_t));
    }
      ...
      Action<GSStatsUnloaded_t, bool> CallbackFunction)
    {
      ...
      if (Config.UseThisCall)
      {
        ...
        Callback.ThisCall.GetSize d3 = _ => Marshal.SizeOf(typeof (GSStatsUnloaded_t));
      ...
      else
      {
        ...
        Callback.StdCall.GetSize d6 = () => Marshal.SizeOf(typeof (GSStatsUnloaded_t));
        if (Platform.PackSmall)
    ...
    internal struct PackSmall
    {
      ...
      public static implicit operator GSStatsUnloaded_t(PackSmall d)
      {
