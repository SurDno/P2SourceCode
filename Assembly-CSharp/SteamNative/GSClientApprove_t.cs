...
namespace SteamNative
{
  ...
  internal struct GSClientApprove_t
  {
    ...
    {
      return Platform.PackSmall ? (PackSmall) Marshal.PtrToStructure(p, typeof (PackSmall)) : (GSClientApprove_t) Marshal.PtrToStructure(p, typeof (GSClientApprove_t));
    }
      ...
      Action<GSClientApprove_t, bool> CallbackFunction)
    {
      ...
      if (Config.UseThisCall)
      {
        ...
        Callback.ThisCall.GetSize d3 = _ => Marshal.SizeOf(typeof (GSClientApprove_t));
      ...
      else
      {
        ...
        Callback.StdCall.GetSize d6 = () => Marshal.SizeOf(typeof (GSClientApprove_t));
        if (Platform.PackSmall)
    ...
    internal struct PackSmall
    {
      ...
      public static implicit operator GSClientApprove_t(PackSmall d)
      {
