...
namespace SteamNative
{
  ...
  internal struct GlobalStatsReceived_t
  {
    ...
    {
      return Platform.PackSmall ? (PackSmall) Marshal.PtrToStructure(p, typeof (PackSmall)) : (GlobalStatsReceived_t) Marshal.PtrToStructure(p, typeof (GlobalStatsReceived_t));
    }
      ...
      Action<GlobalStatsReceived_t, bool> CallbackFunction)
    {
      ...
      if (Config.UseThisCall)
      {
        ...
        Callback.ThisCall.GetSize d3 = _ => Marshal.SizeOf(typeof (GlobalStatsReceived_t));
      ...
      else
      {
        ...
        Callback.StdCall.GetSize d6 = () => Marshal.SizeOf(typeof (GlobalStatsReceived_t));
        if (Platform.PackSmall)
    ...
    internal struct PackSmall
    {
      ...
      public static implicit operator GlobalStatsReceived_t(PackSmall d)
      {
