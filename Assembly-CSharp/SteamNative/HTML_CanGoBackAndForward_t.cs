...
namespace SteamNative
{
  ...
  internal struct HTML_CanGoBackAndForward_t
  {
    ...
    {
      return Platform.PackSmall ? (PackSmall) Marshal.PtrToStructure(p, typeof (PackSmall)) : (HTML_CanGoBackAndForward_t) Marshal.PtrToStructure(p, typeof (HTML_CanGoBackAndForward_t));
    }
      ...
      Action<HTML_CanGoBackAndForward_t, bool> CallbackFunction)
    {
      ...
      if (Config.UseThisCall)
      {
        ...
        Callback.ThisCall.GetSize d3 = _ => Marshal.SizeOf(typeof (HTML_CanGoBackAndForward_t));
      ...
      else
      {
        ...
        Callback.StdCall.GetSize d6 = () => Marshal.SizeOf(typeof (HTML_CanGoBackAndForward_t));
        if (Platform.PackSmall)
