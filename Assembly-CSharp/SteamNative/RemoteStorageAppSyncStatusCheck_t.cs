...
namespace SteamNative
{
  ...
  internal struct RemoteStorageAppSyncStatusCheck_t
  {
    ...
    {
      return Platform.PackSmall ? (PackSmall) Marshal.PtrToStructure(p, typeof (PackSmall)) : (RemoteStorageAppSyncStatusCheck_t) Marshal.PtrToStructure(p, typeof (RemoteStorageAppSyncStatusCheck_t));
    }
      ...
      Action<RemoteStorageAppSyncStatusCheck_t, bool> CallbackFunction)
    {
      ...
      if (Config.UseThisCall)
      {
        ...
        Callback.ThisCall.GetSize d3 = _ => Marshal.SizeOf(typeof (RemoteStorageAppSyncStatusCheck_t));
      ...
      else
      {
        ...
        Callback.StdCall.GetSize d6 = () => Marshal.SizeOf(typeof (RemoteStorageAppSyncStatusCheck_t));
        if (Platform.PackSmall)
