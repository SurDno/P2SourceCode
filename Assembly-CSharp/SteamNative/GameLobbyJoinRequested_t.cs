...
namespace SteamNative
{
  ...
  internal struct GameLobbyJoinRequested_t
  {
    ...
    {
      return Platform.PackSmall ? (PackSmall) Marshal.PtrToStructure(p, typeof (PackSmall)) : (GameLobbyJoinRequested_t) Marshal.PtrToStructure(p, typeof (GameLobbyJoinRequested_t));
    }
      ...
      Action<GameLobbyJoinRequested_t, bool> CallbackFunction)
    {
      ...
      if (Config.UseThisCall)
      {
        ...
        Callback.ThisCall.GetSize d3 = _ => Marshal.SizeOf(typeof (GameLobbyJoinRequested_t));
      ...
      else
      {
        ...
        Callback.StdCall.GetSize d6 = () => Marshal.SizeOf(typeof (GameLobbyJoinRequested_t));
        if (Platform.PackSmall)
    ...
    internal struct PackSmall
    {
      ...
      public static implicit operator GameLobbyJoinRequested_t(PackSmall d)
      {
