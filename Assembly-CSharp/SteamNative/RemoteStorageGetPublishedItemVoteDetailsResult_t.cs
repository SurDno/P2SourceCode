...
namespace SteamNative
{
  ...
  internal struct RemoteStorageGetPublishedItemVoteDetailsResult_t
  {
    ...
    {
      return Platform.PackSmall ? (PackSmall) Marshal.PtrToStructure(p, typeof (PackSmall)) : (RemoteStorageGetPublishedItemVoteDetailsResult_t) Marshal.PtrToStructure(p, typeof (RemoteStorageGetPublishedItemVoteDetailsResult_t));
    }
      ...
      Action<RemoteStorageGetPublishedItemVoteDetailsResult_t, bool> CallbackFunction)
    {
      ...
      if (Config.UseThisCall)
      {
        ...
        Callback.ThisCall.GetSize d3 = _ => Marshal.SizeOf(typeof (RemoteStorageGetPublishedItemVoteDetailsResult_t));
      ...
      else
      {
        ...
        Callback.StdCall.GetSize d6 = () => Marshal.SizeOf(typeof (RemoteStorageGetPublishedItemVoteDetailsResult_t));
        if (Platform.PackSmall)
