...
namespace SteamNative
{
  ...
  internal struct RemoteStorageFileWriteAsyncComplete_t
  {
    ...
    {
      return Platform.PackSmall ? (PackSmall) Marshal.PtrToStructure(p, typeof (PackSmall)) : (RemoteStorageFileWriteAsyncComplete_t) Marshal.PtrToStructure(p, typeof (RemoteStorageFileWriteAsyncComplete_t));
    }
      ...
      Action<RemoteStorageFileWriteAsyncComplete_t, bool> CallbackFunction)
    {
      ...
      if (Config.UseThisCall)
      {
        ...
        Callback.ThisCall.GetSize d3 = _ => Marshal.SizeOf(typeof (RemoteStorageFileWriteAsyncComplete_t));
      ...
      else
      {
        ...
        Callback.StdCall.GetSize d6 = () => Marshal.SizeOf(typeof (RemoteStorageFileWriteAsyncComplete_t));
        if (Platform.PackSmall)
