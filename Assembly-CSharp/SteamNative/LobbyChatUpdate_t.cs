...
namespace SteamNative
{
  ...
  internal struct LobbyChatUpdate_t
  {
    ...
    {
      return Platform.PackSmall ? (PackSmall) Marshal.PtrToStructure(p, typeof (PackSmall)) : (LobbyChatUpdate_t) Marshal.PtrToStructure(p, typeof (LobbyChatUpdate_t));
    }
      ...
      Action<LobbyChatUpdate_t, bool> CallbackFunction)
    {
      ...
      if (Config.UseThisCall)
      {
        ...
        Callback.ThisCall.GetSize d3 = _ => Marshal.SizeOf(typeof (LobbyChatUpdate_t));
      ...
      else
      {
        ...
        Callback.StdCall.GetSize d6 = () => Marshal.SizeOf(typeof (LobbyChatUpdate_t));
        if (Platform.PackSmall)
    ...
    internal struct PackSmall
    {
      ...
      public static implicit operator LobbyChatUpdate_t(PackSmall d)
      {
