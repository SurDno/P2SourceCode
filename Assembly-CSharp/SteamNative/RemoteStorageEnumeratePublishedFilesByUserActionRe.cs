...
namespace SteamNative
{
  ...
  internal struct RemoteStorageEnumeratePublishedFilesByUserActionResult_t
  {
    ...
    {
      return Platform.PackSmall ? (PackSmall) Marshal.PtrToStructure(p, typeof (PackSmall)) : (RemoteStorageEnumeratePublishedFilesByUserActionResult_t) Marshal.PtrToStructure(p, typeof (RemoteStorageEnumeratePublishedFilesByUserActionResult_t));
    }

    public static CallbackHandle CallResult(
      BaseSteamworks steamworks,
      SteamAPICall_t call,
      Action<RemoteStorageEnumeratePublishedFilesByUserActionResult_t, bool> CallbackFunction)
    {
      ...
      if (Config.UseThisCall)
      {
        ...
        Callback.ThisCall.GetSize d3 = _ => Marshal.SizeOf(typeof (RemoteStorageEnumeratePublishedFilesByUserActionResult_t));
      ...
      else
      {
        ...
        Callback.StdCall.GetSize d6 = () => Marshal.SizeOf(typeof (RemoteStorageEnumeratePublishedFilesByUserActionResult_t));
        if (Platform.PackSmall)
