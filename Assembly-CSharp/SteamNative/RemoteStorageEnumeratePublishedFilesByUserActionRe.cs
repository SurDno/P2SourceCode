...
internal struct RemoteStorageEnumeratePublishedFilesByUserActionResult_t {
	...
	public static RemoteStorageEnumeratePublishedFilesByUserActionResult_t FromPointer(IntPtr p) {
		return Platform.PackSmall
			...
			: (RemoteStorageEnumeratePublishedFilesByUserActionResult_t)Marshal.PtrToStructure(p,
	...
	public static CallbackHandle CallResult(
		...
		if (Config.UseThisCall) {
			...
			Callback.ThisCall.GetSize d3 = _ =>
				Marshal.SizeOf(typeof(RemoteStorageEnumeratePublishedFilesByUserActionResult_t));
