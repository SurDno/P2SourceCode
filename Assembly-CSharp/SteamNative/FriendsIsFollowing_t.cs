...
namespace SteamNative
{
  ...
  internal struct FriendsIsFollowing_t
  {
    ...
    {
      return Platform.PackSmall ? (PackSmall) Marshal.PtrToStructure(p, typeof (PackSmall)) : (FriendsIsFollowing_t) Marshal.PtrToStructure(p, typeof (FriendsIsFollowing_t));
    }
      ...
      Action<FriendsIsFollowing_t, bool> CallbackFunction)
    {
      ...
      if (Config.UseThisCall)
      {
        ...
        Callback.ThisCall.GetSize d3 = _ => Marshal.SizeOf(typeof (FriendsIsFollowing_t));
      ...
      else
      {
        ...
        Callback.StdCall.GetSize d6 = () => Marshal.SizeOf(typeof (FriendsIsFollowing_t));
        if (Platform.PackSmall)
    ...
    internal struct PackSmall
    {
      ...
      public static implicit operator FriendsIsFollowing_t(PackSmall d)
      {
