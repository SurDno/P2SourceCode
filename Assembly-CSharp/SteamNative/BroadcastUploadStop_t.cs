...
namespace SteamNative
{
  ...
  internal struct BroadcastUploadStop_t
  {
    ...
    {
      return Platform.PackSmall ? (PackSmall) Marshal.PtrToStructure(p, typeof (PackSmall)) : (BroadcastUploadStop_t) Marshal.PtrToStructure(p, typeof (BroadcastUploadStop_t));
    }
      ...
      Action<BroadcastUploadStop_t, bool> CallbackFunction)
    {
      ...
      if (Config.UseThisCall)
      {
        ...
        Callback.ThisCall.GetSize d3 = _ => Marshal.SizeOf(typeof (BroadcastUploadStop_t));
      ...
      else
      {
        ...
        Callback.StdCall.GetSize d6 = () => Marshal.SizeOf(typeof (BroadcastUploadStop_t));
        if (Platform.PackSmall)
    ...
    internal struct PackSmall
    {
      ...
      public static implicit operator BroadcastUploadStop_t(PackSmall d)
      {
