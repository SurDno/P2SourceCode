...
namespace SteamNative
{
  ...
  internal struct GSClientKick_t
  {
    ...
    {
      return Platform.PackSmall ? (PackSmall) Marshal.PtrToStructure(p, typeof (PackSmall)) : (GSClientKick_t) Marshal.PtrToStructure(p, typeof (GSClientKick_t));
    }
      ...
      Action<GSClientKick_t, bool> CallbackFunction)
    {
      ...
      if (Config.UseThisCall)
      {
        ...
        Callback.ThisCall.GetSize d3 = _ => Marshal.SizeOf(typeof (GSClientKick_t));
      ...
      else
      {
        ...
        Callback.StdCall.GetSize d6 = () => Marshal.SizeOf(typeof (GSClientKick_t));
        if (Platform.PackSmall)
    ...
    internal struct PackSmall
    {
      ...
      public static implicit operator GSClientKick_t(PackSmall d)
      {
