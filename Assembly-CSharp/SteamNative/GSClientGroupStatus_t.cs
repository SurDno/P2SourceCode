...
// Type: SteamNative.GSClientGroupStatus_t
...
namespace SteamNative
{
  ...
  internal struct GSClientGroupStatus_t
  {
    ...
    {
      return Platform.PackSmall ? (GSClientGroupStatus_t) (GSClientGroupStatus_t.PackSmall) Marshal.PtrToStructure(p, typeof (GSClientGroupStatus_t.PackSmall)) : (GSClientGroupStatus_t) Marshal.PtrToStructure(p, typeof (GSClientGroupStatus_t));
    }
      ...
      Action<GSClientGroupStatus_t, bool> CallbackFunction)
    {
      ...
      {
        Callback.ThisCall.Result d1 = (Callback.ThisCall.Result) ((_, p) => CallbackFunction(GSClientGroupStatus_t.FromPointer(p), false));
        Callback.ThisCall.ResultWithInfo d2 = (Callback.ThisCall.ResultWithInfo) ((_, p, bIOFailure, hSteamAPICall) => CallbackFunction(GSClientGroupStatus_t.FromPointer(p), bIOFailure));
        Callback.ThisCall.GetSize d3 = (Callback.ThisCall.GetSize) (_ => Marshal.SizeOf(typeof (GSClientGroupStatus_t)));
        if (Platform.PackSmall)
          d3 = (Callback.ThisCall.GetSize) (_ => Marshal.SizeOf(typeof (GSClientGroupStatus_t.PackSmall)));
      ...
      {
        Callback.StdCall.Result d4 = (Callback.StdCall.Result) (p => CallbackFunction(GSClientGroupStatus_t.FromPointer(p), false));
        Callback.StdCall.ResultWithInfo d5 = (Callback.StdCall.ResultWithInfo) ((p, bIOFailure, hSteamAPICall) => CallbackFunction(GSClientGroupStatus_t.FromPointer(p), bIOFailure));
        Callback.StdCall.GetSize d6 = (Callback.StdCall.GetSize) (() => Marshal.SizeOf(typeof (GSClientGroupStatus_t)));
        if (Platform.PackSmall)
          d6 = (Callback.StdCall.GetSize) (() => Marshal.SizeOf(typeof (GSClientGroupStatus_t.PackSmall)));
