...
internal struct GSClientGroupStatus_t {
	...
	[MarshalAs(UnmanagedType.I1)] public bool Member;
	[MarshalAs(UnmanagedType.I1)] public bool Officer;
	...
	public static GSClientGroupStatus_t FromPointer(IntPtr p) {
		return Platform.PackSmall
			...
			: (GSClientGroupStatus_t)Marshal.PtrToStructure(p, typeof(GSClientGroupStatus_t));
	}
