...
namespace SteamNative
{
  ...
  internal struct NumberOfCurrentPlayers_t
  {
    ...
    {
      return Platform.PackSmall ? (PackSmall) Marshal.PtrToStructure(p, typeof (PackSmall)) : (NumberOfCurrentPlayers_t) Marshal.PtrToStructure(p, typeof (NumberOfCurrentPlayers_t));
    }
      ...
      Action<NumberOfCurrentPlayers_t, bool> CallbackFunction)
    {
      ...
      if (Config.UseThisCall)
      {
        ...
        Callback.ThisCall.GetSize d3 = _ => Marshal.SizeOf(typeof (NumberOfCurrentPlayers_t));
      ...
      else
      {
        ...
        Callback.StdCall.GetSize d6 = () => Marshal.SizeOf(typeof (NumberOfCurrentPlayers_t));
        if (Platform.PackSmall)
    ...
    internal struct PackSmall
    {
      ...
      public static implicit operator NumberOfCurrentPlayers_t(PackSmall d)
      {
