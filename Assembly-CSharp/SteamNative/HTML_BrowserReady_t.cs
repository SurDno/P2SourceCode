...
namespace SteamNative
{
  ...
  internal struct HTML_BrowserReady_t
  {
    ...
    {
      return Platform.PackSmall ? (PackSmall) Marshal.PtrToStructure(p, typeof (PackSmall)) : (HTML_BrowserReady_t) Marshal.PtrToStructure(p, typeof (HTML_BrowserReady_t));
    }
      ...
      Action<HTML_BrowserReady_t, bool> CallbackFunction)
    {
      ...
      if (Config.UseThisCall)
      {
        ...
        Callback.ThisCall.GetSize d3 = _ => Marshal.SizeOf(typeof (HTML_BrowserReady_t));
      ...
      else
      {
        ...
        Callback.StdCall.GetSize d6 = () => Marshal.SizeOf(typeof (HTML_BrowserReady_t));
        if (Platform.PackSmall)
    ...
    internal struct PackSmall
    {
      ...
      public static implicit operator HTML_BrowserReady_t(PackSmall d)
      {
