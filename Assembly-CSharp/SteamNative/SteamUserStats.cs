...
// Type: SteamNative.SteamUserStats
...
namespace SteamNative
{
  internal class SteamUserStats : IDisposable
  {
      ...
      Action<LeaderboardUGCSet_t, bool> CallbackFunction = null)
    {
      ...
      SteamAPICall_t call = this.platform.ISteamUserStats_AttachLeaderboardUGC(hSteamLeaderboard.Value, hUGC.Value);
      return CallbackFunction == null ? (CallbackHandle) null : LeaderboardUGCSet_t.CallResult(this.steamworks, call, CallbackFunction);
    }
    ...
    {
      SteamAPICall_t steamApiCallT = (SteamAPICall_t) 0UL;
      SteamAPICall_t call = this.platform.ISteamUserStats_DownloadLeaderboardEntries(hSteamLeaderboard.Value, eLeaderboardDataRequest, nRangeStart, nRangeEnd);
      return CallbackFunction == null ? (CallbackHandle) null : LeaderboardScoresDownloaded_t.CallResult(this.steamworks, call, CallbackFunction);
    }
    ...
    {
      SteamAPICall_t steamApiCallT = (SteamAPICall_t) 0UL;
      SteamAPICall_t call = this.platform.ISteamUserStats_DownloadLeaderboardEntriesForUsers(hSteamLeaderboard.Value, prgUsers, cUsers);
      return CallbackFunction == null ? (CallbackHandle) null : LeaderboardScoresDownloaded_t.CallResult(this.steamworks, call, CallbackFunction);
    }
    ...
    {
      SteamAPICall_t steamApiCallT = (SteamAPICall_t) 0UL;
      SteamAPICall_t leaderboard = this.platform.ISteamUserStats_FindLeaderboard(pchLeaderboardName);
      return CallbackFunction == null ? (CallbackHandle) null : LeaderboardFindResult_t.CallResult(this.steamworks, leaderboard, CallbackFunction);
    }
    ...
    {
      SteamAPICall_t steamApiCallT = (SteamAPICall_t) 0UL;
      SteamAPICall_t createLeaderboard = this.platform.ISteamUserStats_FindOrCreateLeaderboard(pchLeaderboardName, eLeaderboardSortMethod, eLeaderboardDisplayType);
      return CallbackFunction == null ? (CallbackHandle) null : LeaderboardFindResult_t.CallResult(this.steamworks, createLeaderboard, CallbackFunction);
    }
      ...
      ref bool pbAchieved)
    {
      ...
      int achievedAchievementInfo = this.platform.ISteamUserStats_GetMostAchievedAchievementInfo(stringBuilder, unNameBufLen, out pflPercent, ref pbAchieved);
      ...
      ref bool pbAchieved)
    {
      ...
      StringBuilder stringBuilder = Helpers.TakeStringBuilder();
      uint unNameBufLen = 4096;
      int achievedAchievementInfo = this.platform.ISteamUserStats_GetNextMostAchievedAchievementInfo(iIteratorPrevious, stringBuilder, unNameBufLen, out pflPercent, ref pbAchieved);
      if (achievedAchievementInfo <= 0)
        return achievedAchievementInfo;
      pchName = stringBuilder.ToString();
      return achievedAchievementInfo;
    ...
    public uint GetNumAchievements() => this.platform.ISteamUserStats_GetNumAchievements();

    public CallbackHandle GetNumberOfCurrentPlayers(
      Action<NumberOfCurrentPlayers_t, bool> CallbackFunction = null)
    {
      SteamAPICall_t steamApiCallT = (SteamAPICall_t) 0UL;
      SteamAPICall_t ofCurrentPlayers = this.platform.ISteamUserStats_GetNumberOfCurrentPlayers();
      return CallbackFunction == null ? (CallbackHandle) null : NumberOfCurrentPlayers_t.CallResult(this.steamworks, ofCurrentPlayers, CallbackFunction);
    }
    ...
    public bool RequestCurrentStats() => this.platform.ISteamUserStats_RequestCurrentStats();
    ...
    {
      SteamAPICall_t steamApiCallT = (SteamAPICall_t) 0UL;
      SteamAPICall_t call = this.platform.ISteamUserStats_RequestGlobalAchievementPercentages();
      return CallbackFunction == null ? (CallbackHandle) null : GlobalAchievementPercentagesReady_t.CallResult(this.steamworks, call, CallbackFunction);
    }
    ...
    {
      SteamAPICall_t steamApiCallT = (SteamAPICall_t) 0UL;
      SteamAPICall_t call = this.platform.ISteamUserStats_RequestGlobalStats(nHistoryDays);
      return CallbackFunction == null ? (CallbackHandle) null : GlobalStatsReceived_t.CallResult(this.steamworks, call, CallbackFunction);
    }
    ...
    {
      SteamAPICall_t steamApiCallT = (SteamAPICall_t) 0UL;
      SteamAPICall_t call = this.platform.ISteamUserStats_RequestUserStats(steamIDUser.Value);
      return CallbackFunction == null ? (CallbackHandle) null : UserStatsReceived_t.CallResult(this.steamworks, call, CallbackFunction);
    }
    ...
    public bool StoreStats() => this.platform.ISteamUserStats_StoreStats();
    ...
    {
      SteamAPICall_t steamApiCallT = (SteamAPICall_t) 0UL;
      SteamAPICall_t call = this.platform.ISteamUserStats_UploadLeaderboardScore(hSteamLeaderboard.Value, eLeaderboardUploadScoreMethod, nScore, pScoreDetails, cScoreDetailsCount);
      return CallbackFunction == null ? (CallbackHandle) null : LeaderboardScoreUploaded_t.CallResult(this.steamworks, call, CallbackFunction);
    }
  }
}
