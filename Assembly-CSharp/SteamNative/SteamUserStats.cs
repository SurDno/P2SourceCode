...
internal class SteamUserStats : IDisposable {
	...
	public CallbackHandle AttachLeaderboardUGC(
		...
		var call = platform.ISteamUserStats_AttachLeaderboardUGC(hSteamLeaderboard.Value, hUGC.Value);
	...
	public CallbackHandle DownloadLeaderboardEntries(
		...
		SteamAPICall_t steamApiCallT = 0UL;
		var call = platform.ISteamUserStats_DownloadLeaderboardEntries(hSteamLeaderboard.Value, eLeaderboardDataRequest,
			nRangeStart, nRangeEnd);
		return CallbackFunction == null
			? null
			: LeaderboardScoresDownloaded_t.CallResult(steamworks, call, CallbackFunction);
	}
	...
	public CallbackHandle DownloadLeaderboardEntriesForUsers(
		...
		Action<LeaderboardScoresDownloaded_t, bool> CallbackFunction = null) {
		SteamAPICall_t steamApiCallT = 0UL;
		var call = platform.ISteamUserStats_DownloadLeaderboardEntriesForUsers(hSteamLeaderboard.Value, prgUsers,
			cUsers);
		return CallbackFunction == null
			? null
			: LeaderboardScoresDownloaded_t.CallResult(steamworks, call, CallbackFunction);
	...
	public CallbackHandle FindLeaderboard(
		...
		SteamAPICall_t steamApiCallT = 0UL;
		var leaderboard = platform.ISteamUserStats_FindLeaderboard(pchLeaderboardName);
		return CallbackFunction == null
			? null
			: LeaderboardFindResult_t.CallResult(steamworks, leaderboard, CallbackFunction);
	}
	...
	public CallbackHandle FindOrCreateLeaderboard(
		...
		Action<LeaderboardFindResult_t, bool> CallbackFunction = null) {
		SteamAPICall_t steamApiCallT = 0UL;
		var createLeaderboard =
			platform.ISteamUserStats_FindOrCreateLeaderboard(pchLeaderboardName, eLeaderboardSortMethod,
				eLeaderboardDisplayType);
		return CallbackFunction == null
			? null
			: LeaderboardFindResult_t.CallResult(steamworks, createLeaderboard, CallbackFunction);
	}
	...
	public bool GetDownloadedLeaderboardEntry(
		...
		IntPtr pDetails,
		int cDetailsMax) {
		return platform.ISteamUserStats_GetDownloadedLeaderboardEntry(hSteamLeaderboardEntries.Value, index,
	...
	public int GetMostAchievedAchievementInfo(
		...
		var achievedAchievementInfo =
			platform.ISteamUserStats_GetMostAchievedAchievementInfo(stringBuilder, unNameBufLen, out pflPercent,
				ref pbAchieved);
	...
	public int GetNextMostAchievedAchievementInfo(
		...
		var stringBuilder = Helpers.TakeStringBuilder();
		uint unNameBufLen = 4096;
		var achievedAchievementInfo = platform.ISteamUserStats_GetNextMostAchievedAchievementInfo(iIteratorPrevious,
			stringBuilder, unNameBufLen, out pflPercent, ref pbAchieved);
		if (achievedAchievementInfo <= 0)
			return achievedAchievementInfo;
		pchName = stringBuilder.ToString();
		return achievedAchievementInfo;
	...
	public CallbackHandle GetNumberOfCurrentPlayers(
		...
		SteamAPICall_t steamApiCallT = 0UL;
		var ofCurrentPlayers = platform.ISteamUserStats_GetNumberOfCurrentPlayers();
		return CallbackFunction == null
			? null
			: NumberOfCurrentPlayers_t.CallResult(steamworks, ofCurrentPlayers, CallbackFunction);
	}
	...
	public bool GetUserAchievementAndUnlockTime(
		...
		ref bool pbAchieved,
		out uint punUnlockTime) {
		return platform.ISteamUserStats_GetUserAchievementAndUnlockTime(steamIDUser.Value, pchName, ref pbAchieved,
			out punUnlockTime);
	}
	...
	public CallbackHandle RequestGlobalAchievementPercentages(
		...
		SteamAPICall_t steamApiCallT = 0UL;
		var call = platform.ISteamUserStats_RequestGlobalAchievementPercentages();
		return CallbackFunction == null
			? null
			: GlobalAchievementPercentagesReady_t.CallResult(steamworks, call, CallbackFunction);
	}
	...
	public CallbackHandle RequestGlobalStats(
		...
		SteamAPICall_t steamApiCallT = 0UL;
		var call = platform.ISteamUserStats_RequestGlobalStats(nHistoryDays);
	...
	public CallbackHandle RequestUserStats(
		...
		SteamAPICall_t steamApiCallT = 0UL;
		var call = platform.ISteamUserStats_RequestUserStats(steamIDUser.Value);
	...
	public CallbackHandle UploadLeaderboardScore(
		...
		SteamAPICall_t steamApiCallT = 0UL;
		var call = platform.ISteamUserStats_UploadLeaderboardScore(hSteamLeaderboard.Value,
			eLeaderboardUploadScoreMethod, nScore, pScoreDetails, cScoreDetailsCount);
		return CallbackFunction == null
			? null
			: LeaderboardScoreUploaded_t.CallResult(steamworks, call, CallbackFunction);
	}
}