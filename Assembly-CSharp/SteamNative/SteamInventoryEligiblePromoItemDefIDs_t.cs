...
namespace SteamNative
{
  ...
  internal struct SteamInventoryEligiblePromoItemDefIDs_t
  {
    ...
    {
      return Platform.PackSmall ? (PackSmall) Marshal.PtrToStructure(p, typeof (PackSmall)) : (SteamInventoryEligiblePromoItemDefIDs_t) Marshal.PtrToStructure(p, typeof (SteamInventoryEligiblePromoItemDefIDs_t));
    }
      ...
      Action<SteamInventoryEligiblePromoItemDefIDs_t, bool> CallbackFunction)
    {
      ...
      if (Config.UseThisCall)
      {
        ...
        Callback.ThisCall.GetSize d3 = _ => Marshal.SizeOf(typeof (SteamInventoryEligiblePromoItemDefIDs_t));
      ...
      else
      {
        ...
        Callback.StdCall.GetSize d6 = () => Marshal.SizeOf(typeof (SteamInventoryEligiblePromoItemDefIDs_t));
        if (Platform.PackSmall)
