...
// Type: SteamNative.SteamInventoryEligiblePromoItemDefIDs_t
...
namespace SteamNative
{
  ...
  {
    public const int CallbackId = 4703;
    public Result Esult;
    ...
    {
      return Platform.PackSmall ? (SteamInventoryEligiblePromoItemDefIDs_t) (SteamInventoryEligiblePromoItemDefIDs_t.PackSmall) Marshal.PtrToStructure(p, typeof (SteamInventoryEligiblePromoItemDefIDs_t.PackSmall)) : (SteamInventoryEligiblePromoItemDefIDs_t) Marshal.PtrToStructure(p, typeof (SteamInventoryEligiblePromoItemDefIDs_t));
    }

    public static CallbackHandle CallResult(
      BaseSteamworks steamworks,
      SteamAPICall_t call,
      Action<SteamInventoryEligiblePromoItemDefIDs_t, bool> CallbackFunction)
    {
      ...
      if (Config.UseThisCall)
      {
        ...
        {
          handle.Dispose();
          CallbackFunction(SteamInventoryEligiblePromoItemDefIDs_t.FromPointer(p), false);
        });
        Callback.ThisCall.ResultWithInfo d2 = (Callback.ThisCall.ResultWithInfo) ((_, p, bIOFailure, hSteamAPICall) =>
        {
          ...
          handle.Dispose();
          CallbackFunction(SteamInventoryEligiblePromoItemDefIDs_t.FromPointer(p), bIOFailure);
        });
        Callback.ThisCall.GetSize d3 = (Callback.ThisCall.GetSize) (_ => Marshal.SizeOf(typeof (SteamInventoryEligiblePromoItemDefIDs_t)));
        if (Platform.PackSmall)
          d3 = (Callback.ThisCall.GetSize) (_ => Marshal.SizeOf(typeof (SteamInventoryEligiblePromoItemDefIDs_t.PackSmall)));
      ...
      else
      {
        ...
        Callback.StdCall.GetSize d6 = (Callback.StdCall.GetSize) (() => Marshal.SizeOf(typeof (SteamInventoryEligiblePromoItemDefIDs_t)));
        if (Platform.PackSmall)
          d6 = (Callback.StdCall.GetSize) (() => Marshal.SizeOf(typeof (SteamInventoryEligiblePromoItemDefIDs_t.PackSmall)));
      ...
      Action<SteamInventoryEligiblePromoItemDefIDs_t, bool> CallbackFunction)
    {
      ...
      if (Config.UseThisCall)
      {
        Callback.ThisCall.Result d1 = (Callback.ThisCall.Result) ((_, p) => CallbackFunction(SteamInventoryEligiblePromoItemDefIDs_t.FromPointer(p), false));
        Callback.ThisCall.ResultWithInfo d2 = (Callback.ThisCall.ResultWithInfo) ((_, p, bIOFailure, hSteamAPICall) => CallbackFunction(SteamInventoryEligiblePromoItemDefIDs_t.FromPointer(p), bIOFailure));
        Callback.ThisCall.GetSize d3 = (Callback.ThisCall.GetSize) (_ => Marshal.SizeOf(typeof (SteamInventoryEligiblePromoItemDefIDs_t)));
        if (Platform.PackSmall)
          d3 = (Callback.ThisCall.GetSize) (_ => Marshal.SizeOf(typeof (SteamInventoryEligiblePromoItemDefIDs_t.PackSmall)));
        handle.FuncA = GCHandle.Alloc((object) d1);
      ...
      {
        Callback.StdCall.Result d4 = (Callback.StdCall.Result) (p => CallbackFunction(SteamInventoryEligiblePromoItemDefIDs_t.FromPointer(p), false));
        Callback.StdCall.ResultWithInfo d5 = (Callback.StdCall.ResultWithInfo) ((p, bIOFailure, hSteamAPICall) => CallbackFunction(SteamInventoryEligiblePromoItemDefIDs_t.FromPointer(p), bIOFailure));
        Callback.StdCall.GetSize d6 = (Callback.StdCall.GetSize) (() => Marshal.SizeOf(typeof (SteamInventoryEligiblePromoItemDefIDs_t)));
        if (Platform.PackSmall)
          d6 = (Callback.StdCall.GetSize) (() => Marshal.SizeOf(typeof (SteamInventoryEligiblePromoItemDefIDs_t.PackSmall)));
        handle.FuncA = GCHandle.Alloc((object) d4);
      ...
      steamworks.native.api.SteamAPI_RegisterCallback(handle.PinnedCallback.AddrOfPinnedObject(), 4703);
    ...
    internal struct PackSmall
    {
      ...
      public static implicit operator SteamInventoryEligiblePromoItemDefIDs_t(
        SteamInventoryEligiblePromoItemDefIDs_t.PackSmall d)
      {
