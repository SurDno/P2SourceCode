...
namespace SteamNative
{
  ...
  internal struct AppProofOfPurchaseKeyResponse_t
  {
    ...
    {
      return Platform.PackSmall ? (PackSmall) Marshal.PtrToStructure(p, typeof (PackSmall)) : (AppProofOfPurchaseKeyResponse_t) Marshal.PtrToStructure(p, typeof (AppProofOfPurchaseKeyResponse_t));
    }
      ...
      Action<AppProofOfPurchaseKeyResponse_t, bool> CallbackFunction)
    {
      ...
      if (Config.UseThisCall)
      {
        ...
        Callback.ThisCall.GetSize d3 = _ => Marshal.SizeOf(typeof (AppProofOfPurchaseKeyResponse_t));
      ...
      else
      {
        ...
        Callback.StdCall.GetSize d6 = () => Marshal.SizeOf(typeof (AppProofOfPurchaseKeyResponse_t));
        if (Platform.PackSmall)
