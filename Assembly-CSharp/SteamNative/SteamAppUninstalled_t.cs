...
namespace SteamNative
{
  ...
  internal struct SteamAppUninstalled_t
  {
    ...
    {
      return Platform.PackSmall ? (PackSmall) Marshal.PtrToStructure(p, typeof (PackSmall)) : (SteamAppUninstalled_t) Marshal.PtrToStructure(p, typeof (SteamAppUninstalled_t));
    }
      ...
      Action<SteamAppUninstalled_t, bool> CallbackFunction)
    {
      ...
      if (Config.UseThisCall)
      {
        ...
        Callback.ThisCall.GetSize d3 = _ => Marshal.SizeOf(typeof (SteamAppUninstalled_t));
      ...
      else
      {
        ...
        Callback.StdCall.GetSize d6 = () => Marshal.SizeOf(typeof (SteamAppUninstalled_t));
        if (Platform.PackSmall)
    ...
    internal struct PackSmall
    {
      ...
      public static implicit operator SteamAppUninstalled_t(PackSmall d)
      {
