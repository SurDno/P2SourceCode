...
namespace SteamNative
{
  ...
  internal struct StoreAuthURLResponse_t
  {
    ...
    {
      return Platform.PackSmall ? (PackSmall) Marshal.PtrToStructure(p, typeof (PackSmall)) : (StoreAuthURLResponse_t) Marshal.PtrToStructure(p, typeof (StoreAuthURLResponse_t));
    }
      ...
      Action<StoreAuthURLResponse_t, bool> CallbackFunction)
    {
      ...
      if (Config.UseThisCall)
      {
        ...
        Callback.ThisCall.GetSize d3 = _ => Marshal.SizeOf(typeof (StoreAuthURLResponse_t));
      ...
      else
      {
        ...
        Callback.StdCall.GetSize d6 = () => Marshal.SizeOf(typeof (StoreAuthURLResponse_t));
        if (Platform.PackSmall)
    ...
    internal struct PackSmall
    {
      ...
      public static implicit operator StoreAuthURLResponse_t(PackSmall d)
      {
