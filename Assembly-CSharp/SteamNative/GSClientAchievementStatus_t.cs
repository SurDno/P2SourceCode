...
namespace SteamNative
{
  ...
  internal struct GSClientAchievementStatus_t
  {
    ...
    {
      return Platform.PackSmall ? (PackSmall) Marshal.PtrToStructure(p, typeof (PackSmall)) : (GSClientAchievementStatus_t) Marshal.PtrToStructure(p, typeof (GSClientAchievementStatus_t));
    }
      ...
      Action<GSClientAchievementStatus_t, bool> CallbackFunction)
    {
      ...
      if (Config.UseThisCall)
      {
        ...
        Callback.ThisCall.GetSize d3 = _ => Marshal.SizeOf(typeof (GSClientAchievementStatus_t));
      ...
      else
      {
        ...
        Callback.StdCall.GetSize d6 = () => Marshal.SizeOf(typeof (GSClientAchievementStatus_t));
        if (Platform.PackSmall)
