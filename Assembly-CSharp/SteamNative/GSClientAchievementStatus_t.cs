...
// Type: SteamNative.GSClientAchievementStatus_t
...
namespace SteamNative
{
  ...
  internal struct GSClientAchievementStatus_t
  {
    ...
    public string PchAchievement;
    [MarshalAs(UnmanagedType.I1)]
    public bool Unlocked;

    public static GSClientAchievementStatus_t FromPointer(IntPtr p)
    {
      return Platform.PackSmall ? (GSClientAchievementStatus_t) (GSClientAchievementStatus_t.PackSmall) Marshal.PtrToStructure(p, typeof (GSClientAchievementStatus_t.PackSmall)) : (GSClientAchievementStatus_t) Marshal.PtrToStructure(p, typeof (GSClientAchievementStatus_t));
    }

    public static void RegisterCallback(
      BaseSteamworks steamworks,
      Action<GSClientAchievementStatus_t, bool> CallbackFunction)
    {
      CallbackHandle handle = new CallbackHandle();
      handle.steamworks = steamworks;
      if (Config.UseThisCall)
      {
        Callback.ThisCall.Result d1 = (Callback.ThisCall.Result) ((_, p) => CallbackFunction(GSClientAchievementStatus_t.FromPointer(p), false));
        Callback.ThisCall.ResultWithInfo d2 = (Callback.ThisCall.ResultWithInfo) ((_, p, bIOFailure, hSteamAPICall) => CallbackFunction(GSClientAchievementStatus_t.FromPointer(p), bIOFailure));
        Callback.ThisCall.GetSize d3 = (Callback.ThisCall.GetSize) (_ => Marshal.SizeOf(typeof (GSClientAchievementStatus_t)));
        if (Platform.PackSmall)
          d3 = (Callback.ThisCall.GetSize) (_ => Marshal.SizeOf(typeof (GSClientAchievementStatus_t.PackSmall)));
      ...
      {
        Callback.StdCall.Result d4 = (Callback.StdCall.Result) (p => CallbackFunction(GSClientAchievementStatus_t.FromPointer(p), false));
        Callback.StdCall.ResultWithInfo d5 = (Callback.StdCall.ResultWithInfo) ((p, bIOFailure, hSteamAPICall) => CallbackFunction(GSClientAchievementStatus_t.FromPointer(p), bIOFailure));
        Callback.StdCall.GetSize d6 = (Callback.StdCall.GetSize) (() => Marshal.SizeOf(typeof (GSClientAchievementStatus_t)));
        if (Platform.PackSmall)
          d6 = (Callback.StdCall.GetSize) (() => Marshal.SizeOf(typeof (GSClientAchievementStatus_t.PackSmall)));
      ...
      steamworks.native.api.SteamAPI_RegisterCallback(handle.PinnedCallback.AddrOfPinnedObject(), 206);
    ...
    internal struct PackSmall
    {
      ...
      public static implicit operator GSClientAchievementStatus_t(
        GSClientAchievementStatus_t.PackSmall d)
      {
