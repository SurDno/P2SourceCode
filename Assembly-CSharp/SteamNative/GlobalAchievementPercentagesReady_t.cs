...
// Type: SteamNative.GlobalAchievementPercentagesReady_t
...
namespace SteamNative
{
  ...
  internal struct GlobalAchievementPercentagesReady_t
  {
    ...
    {
      return Platform.PackSmall ? (GlobalAchievementPercentagesReady_t) (GlobalAchievementPercentagesReady_t.PackSmall) Marshal.PtrToStructure(p, typeof (GlobalAchievementPercentagesReady_t.PackSmall)) : (GlobalAchievementPercentagesReady_t) Marshal.PtrToStructure(p, typeof (GlobalAchievementPercentagesReady_t));
    }

    public static CallbackHandle CallResult(
      BaseSteamworks steamworks,
      SteamAPICall_t call,
      Action<GlobalAchievementPercentagesReady_t, bool> CallbackFunction)
    {
      ...
      if (Config.UseThisCall)
      {
        ...
        {
          handle.Dispose();
          CallbackFunction(GlobalAchievementPercentagesReady_t.FromPointer(p), false);
        });
        Callback.ThisCall.ResultWithInfo d2 = (Callback.ThisCall.ResultWithInfo) ((_, p, bIOFailure, hSteamAPICall) =>
        {
          ...
          handle.Dispose();
          CallbackFunction(GlobalAchievementPercentagesReady_t.FromPointer(p), bIOFailure);
        });
        Callback.ThisCall.GetSize d3 = (Callback.ThisCall.GetSize) (_ => Marshal.SizeOf(typeof (GlobalAchievementPercentagesReady_t)));
        if (Platform.PackSmall)
          d3 = (Callback.ThisCall.GetSize) (_ => Marshal.SizeOf(typeof (GlobalAchievementPercentagesReady_t.PackSmall)));
      ...
      else
      {
        ...
        Callback.StdCall.GetSize d6 = (Callback.StdCall.GetSize) (() => Marshal.SizeOf(typeof (GlobalAchievementPercentagesReady_t)));
        if (Platform.PackSmall)
          d6 = (Callback.StdCall.GetSize) (() => Marshal.SizeOf(typeof (GlobalAchievementPercentagesReady_t.PackSmall)));
      ...
      Action<GlobalAchievementPercentagesReady_t, bool> CallbackFunction)
    {
      ...
      if (Config.UseThisCall)
      {
        Callback.ThisCall.Result d1 = (Callback.ThisCall.Result) ((_, p) => CallbackFunction(GlobalAchievementPercentagesReady_t.FromPointer(p), false));
        Callback.ThisCall.ResultWithInfo d2 = (Callback.ThisCall.ResultWithInfo) ((_, p, bIOFailure, hSteamAPICall) => CallbackFunction(GlobalAchievementPercentagesReady_t.FromPointer(p), bIOFailure));
        Callback.ThisCall.GetSize d3 = (Callback.ThisCall.GetSize) (_ => Marshal.SizeOf(typeof (GlobalAchievementPercentagesReady_t)));
        if (Platform.PackSmall)
          d3 = (Callback.ThisCall.GetSize) (_ => Marshal.SizeOf(typeof (GlobalAchievementPercentagesReady_t.PackSmall)));
        handle.FuncA = GCHandle.Alloc((object) d1);
      ...
      {
        Callback.StdCall.Result d4 = (Callback.StdCall.Result) (p => CallbackFunction(GlobalAchievementPercentagesReady_t.FromPointer(p), false));
        Callback.StdCall.ResultWithInfo d5 = (Callback.StdCall.ResultWithInfo) ((p, bIOFailure, hSteamAPICall) => CallbackFunction(GlobalAchievementPercentagesReady_t.FromPointer(p), bIOFailure));
        Callback.StdCall.GetSize d6 = (Callback.StdCall.GetSize) (() => Marshal.SizeOf(typeof (GlobalAchievementPercentagesReady_t)));
        if (Platform.PackSmall)
          d6 = (Callback.StdCall.GetSize) (() => Marshal.SizeOf(typeof (GlobalAchievementPercentagesReady_t.PackSmall)));
        handle.FuncA = GCHandle.Alloc((object) d4);
      ...
      steamworks.native.api.SteamAPI_RegisterCallback(handle.PinnedCallback.AddrOfPinnedObject(), 1110);
    ...
    internal struct PackSmall
    {
      ...
      public static implicit operator GlobalAchievementPercentagesReady_t(
        GlobalAchievementPercentagesReady_t.PackSmall d)
      {
