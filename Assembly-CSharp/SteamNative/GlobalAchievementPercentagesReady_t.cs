...
namespace SteamNative
{
  ...
  internal struct GlobalAchievementPercentagesReady_t
  {
    ...
    {
      return Platform.PackSmall ? (PackSmall) Marshal.PtrToStructure(p, typeof (PackSmall)) : (GlobalAchievementPercentagesReady_t) Marshal.PtrToStructure(p, typeof (GlobalAchievementPercentagesReady_t));
    }
      ...
      Action<GlobalAchievementPercentagesReady_t, bool> CallbackFunction)
    {
      ...
      if (Config.UseThisCall)
      {
        ...
        Callback.ThisCall.GetSize d3 = _ => Marshal.SizeOf(typeof (GlobalAchievementPercentagesReady_t));
      ...
      else
      {
        ...
        Callback.StdCall.GetSize d6 = () => Marshal.SizeOf(typeof (GlobalAchievementPercentagesReady_t));
        if (Platform.PackSmall)
