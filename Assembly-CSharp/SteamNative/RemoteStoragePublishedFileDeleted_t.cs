...
// Type: SteamNative.RemoteStoragePublishedFileDeleted_t
...
namespace SteamNative
{
  ...
  internal struct RemoteStoragePublishedFileDeleted_t
  {
    ...
    {
      return Platform.PackSmall ? (RemoteStoragePublishedFileDeleted_t) (RemoteStoragePublishedFileDeleted_t.PackSmall) Marshal.PtrToStructure(p, typeof (RemoteStoragePublishedFileDeleted_t.PackSmall)) : (RemoteStoragePublishedFileDeleted_t) Marshal.PtrToStructure(p, typeof (RemoteStoragePublishedFileDeleted_t));
    }
      ...
      Action<RemoteStoragePublishedFileDeleted_t, bool> CallbackFunction)
    {
      ...
      {
        Callback.ThisCall.Result d1 = (Callback.ThisCall.Result) ((_, p) => CallbackFunction(RemoteStoragePublishedFileDeleted_t.FromPointer(p), false));
        Callback.ThisCall.ResultWithInfo d2 = (Callback.ThisCall.ResultWithInfo) ((_, p, bIOFailure, hSteamAPICall) => CallbackFunction(RemoteStoragePublishedFileDeleted_t.FromPointer(p), bIOFailure));
        Callback.ThisCall.GetSize d3 = (Callback.ThisCall.GetSize) (_ => Marshal.SizeOf(typeof (RemoteStoragePublishedFileDeleted_t)));
        if (Platform.PackSmall)
          d3 = (Callback.ThisCall.GetSize) (_ => Marshal.SizeOf(typeof (RemoteStoragePublishedFileDeleted_t.PackSmall)));
      ...
      {
        Callback.StdCall.Result d4 = (Callback.StdCall.Result) (p => CallbackFunction(RemoteStoragePublishedFileDeleted_t.FromPointer(p), false));
        Callback.StdCall.ResultWithInfo d5 = (Callback.StdCall.ResultWithInfo) ((p, bIOFailure, hSteamAPICall) => CallbackFunction(RemoteStoragePublishedFileDeleted_t.FromPointer(p), bIOFailure));
        Callback.StdCall.GetSize d6 = (Callback.StdCall.GetSize) (() => Marshal.SizeOf(typeof (RemoteStoragePublishedFileDeleted_t)));
        if (Platform.PackSmall)
          d6 = (Callback.StdCall.GetSize) (() => Marshal.SizeOf(typeof (RemoteStoragePublishedFileDeleted_t.PackSmall)));
    ...
    internal struct PackSmall
    {
      ...
      public static implicit operator RemoteStoragePublishedFileDeleted_t(
        RemoteStoragePublishedFileDeleted_t.PackSmall d)
      {
