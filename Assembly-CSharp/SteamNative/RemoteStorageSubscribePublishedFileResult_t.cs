...
namespace SteamNative
{
  ...
  internal struct RemoteStorageSubscribePublishedFileResult_t
  {
    ...
    {
      return Platform.PackSmall ? (PackSmall) Marshal.PtrToStructure(p, typeof (PackSmall)) : (RemoteStorageSubscribePublishedFileResult_t) Marshal.PtrToStructure(p, typeof (RemoteStorageSubscribePublishedFileResult_t));
    }
      ...
      Action<RemoteStorageSubscribePublishedFileResult_t, bool> CallbackFunction)
    {
      ...
      if (Config.UseThisCall)
      {
        ...
        Callback.ThisCall.GetSize d3 = _ => Marshal.SizeOf(typeof (RemoteStorageSubscribePublishedFileResult_t));
      ...
      else
      {
        ...
        Callback.StdCall.GetSize d6 = () => Marshal.SizeOf(typeof (RemoteStorageSubscribePublishedFileResult_t));
        if (Platform.PackSmall)
