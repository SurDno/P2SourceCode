...
namespace SteamNative
{
  ...
  internal struct HTML_VerticalScroll_t
  {
    ...
    {
      return Platform.PackSmall ? (PackSmall) Marshal.PtrToStructure(p, typeof (PackSmall)) : (HTML_VerticalScroll_t) Marshal.PtrToStructure(p, typeof (HTML_VerticalScroll_t));
    }
      ...
      Action<HTML_VerticalScroll_t, bool> CallbackFunction)
    {
      ...
      if (Config.UseThisCall)
      {
        ...
        Callback.ThisCall.GetSize d3 = _ => Marshal.SizeOf(typeof (HTML_VerticalScroll_t));
      ...
      else
      {
        ...
        Callback.StdCall.GetSize d6 = () => Marshal.SizeOf(typeof (HTML_VerticalScroll_t));
        if (Platform.PackSmall)
    ...
    internal struct PackSmall
    {
      ...
      public static implicit operator HTML_VerticalScroll_t(PackSmall d)
      {
