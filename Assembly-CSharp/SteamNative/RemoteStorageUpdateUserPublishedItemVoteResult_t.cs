...
namespace SteamNative
{
  ...
  internal struct RemoteStorageUpdateUserPublishedItemVoteResult_t
  {
    ...
    {
      return Platform.PackSmall ? (PackSmall) Marshal.PtrToStructure(p, typeof (PackSmall)) : (RemoteStorageUpdateUserPublishedItemVoteResult_t) Marshal.PtrToStructure(p, typeof (RemoteStorageUpdateUserPublishedItemVoteResult_t));
    }
      ...
      Action<RemoteStorageUpdateUserPublishedItemVoteResult_t, bool> CallbackFunction)
    {
      ...
      if (Config.UseThisCall)
      {
        ...
        Callback.ThisCall.GetSize d3 = _ => Marshal.SizeOf(typeof (RemoteStorageUpdateUserPublishedItemVoteResult_t));
      ...
      else
      {
        ...
        Callback.StdCall.GetSize d6 = () => Marshal.SizeOf(typeof (RemoteStorageUpdateUserPublishedItemVoteResult_t));
        if (Platform.PackSmall)
