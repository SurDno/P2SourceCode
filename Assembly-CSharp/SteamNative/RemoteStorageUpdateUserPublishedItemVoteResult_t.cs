...
internal struct RemoteStorageUpdateUserPublishedItemVoteResult_t {
	...
	public static RemoteStorageUpdateUserPublishedItemVoteResult_t FromPointer(IntPtr p) {
		return Platform.PackSmall
			...
			: (RemoteStorageUpdateUserPublishedItemVoteResult_t)Marshal.PtrToStructure(p,
	...
	public static CallbackHandle CallResult(
		...
		if (Config.UseThisCall) {
			...
			Callback.ThisCall.GetSize d3 = _ =>
				Marshal.SizeOf(typeof(RemoteStorageUpdateUserPublishedItemVoteResult_t));
