...
namespace SteamNative
{
  ...
  internal struct RemoteStoragePublishFileProgress_t
  {
    ...
    {
      return Platform.PackSmall ? (PackSmall) Marshal.PtrToStructure(p, typeof (PackSmall)) : (RemoteStoragePublishFileProgress_t) Marshal.PtrToStructure(p, typeof (RemoteStoragePublishFileProgress_t));
    }
      ...
      Action<RemoteStoragePublishFileProgress_t, bool> CallbackFunction)
    {
      ...
      if (Config.UseThisCall)
      {
        ...
        Callback.ThisCall.GetSize d3 = _ => Marshal.SizeOf(typeof (RemoteStoragePublishFileProgress_t));
      ...
      else
      {
        ...
        Callback.StdCall.GetSize d6 = () => Marshal.SizeOf(typeof (RemoteStoragePublishFileProgress_t));
        if (Platform.PackSmall)
