...
namespace SteamNative
{
  ...
  internal struct LobbyMatchList_t
  {
    ...
    {
      return Platform.PackSmall ? (PackSmall) Marshal.PtrToStructure(p, typeof (PackSmall)) : (LobbyMatchList_t) Marshal.PtrToStructure(p, typeof (LobbyMatchList_t));
    }
      ...
      Action<LobbyMatchList_t, bool> CallbackFunction)
    {
      ...
      if (Config.UseThisCall)
      {
        ...
        Callback.ThisCall.GetSize d3 = _ => Marshal.SizeOf(typeof (LobbyMatchList_t));
      ...
      else
      {
        ...
        Callback.StdCall.GetSize d6 = () => Marshal.SizeOf(typeof (LobbyMatchList_t));
        if (Platform.PackSmall)
    ...
    internal struct PackSmall
    {
      ...
      public static implicit operator LobbyMatchList_t(PackSmall d)
      {
