...
namespace SteamNative
{
  ...
  internal struct EncryptedAppTicketResponse_t
  {
    ...
    {
      return Platform.PackSmall ? (PackSmall) Marshal.PtrToStructure(p, typeof (PackSmall)) : (EncryptedAppTicketResponse_t) Marshal.PtrToStructure(p, typeof (EncryptedAppTicketResponse_t));
    }
      ...
      Action<EncryptedAppTicketResponse_t, bool> CallbackFunction)
    {
      ...
      if (Config.UseThisCall)
      {
        ...
        Callback.ThisCall.GetSize d3 = _ => Marshal.SizeOf(typeof (EncryptedAppTicketResponse_t));
      ...
      else
      {
        ...
        Callback.StdCall.GetSize d6 = () => Marshal.SizeOf(typeof (EncryptedAppTicketResponse_t));
        if (Platform.PackSmall)
