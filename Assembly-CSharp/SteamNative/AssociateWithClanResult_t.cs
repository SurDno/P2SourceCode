...
namespace SteamNative
{
  ...
  internal struct AssociateWithClanResult_t
  {
    ...
    {
      return Platform.PackSmall ? (PackSmall) Marshal.PtrToStructure(p, typeof (PackSmall)) : (AssociateWithClanResult_t) Marshal.PtrToStructure(p, typeof (AssociateWithClanResult_t));
    }
      ...
      Action<AssociateWithClanResult_t, bool> CallbackFunction)
    {
      ...
      if (Config.UseThisCall)
      {
        ...
        Callback.ThisCall.GetSize d3 = _ => Marshal.SizeOf(typeof (AssociateWithClanResult_t));
      ...
      else
      {
        ...
        Callback.StdCall.GetSize d6 = () => Marshal.SizeOf(typeof (AssociateWithClanResult_t));
        if (Platform.PackSmall)
