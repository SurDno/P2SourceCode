...
namespace SteamNative
{
  ...
  internal struct StartPlaytimeTrackingResult_t
  {
    ...
    {
      return Platform.PackSmall ? (PackSmall) Marshal.PtrToStructure(p, typeof (PackSmall)) : (StartPlaytimeTrackingResult_t) Marshal.PtrToStructure(p, typeof (StartPlaytimeTrackingResult_t));
    }
      ...
      Action<StartPlaytimeTrackingResult_t, bool> CallbackFunction)
    {
      ...
      if (Config.UseThisCall)
      {
        ...
        Callback.ThisCall.GetSize d3 = _ => Marshal.SizeOf(typeof (StartPlaytimeTrackingResult_t));
      ...
      else
      {
        ...
        Callback.StdCall.GetSize d6 = () => Marshal.SizeOf(typeof (StartPlaytimeTrackingResult_t));
        if (Platform.PackSmall)
