...
namespace SteamNative
{
  ...
  internal struct GameWebCallback_t
  {
    ...
    {
      return Platform.PackSmall ? (PackSmall) Marshal.PtrToStructure(p, typeof (PackSmall)) : (GameWebCallback_t) Marshal.PtrToStructure(p, typeof (GameWebCallback_t));
    }
      ...
      Action<GameWebCallback_t, bool> CallbackFunction)
    {
      ...
      if (Config.UseThisCall)
      {
        ...
        Callback.ThisCall.GetSize d3 = _ => Marshal.SizeOf(typeof (GameWebCallback_t));
      ...
      else
      {
        ...
        Callback.StdCall.GetSize d6 = () => Marshal.SizeOf(typeof (GameWebCallback_t));
        if (Platform.PackSmall)
    ...
    internal struct PackSmall
    {
      ...
      public static implicit operator GameWebCallback_t(PackSmall d)
      {
