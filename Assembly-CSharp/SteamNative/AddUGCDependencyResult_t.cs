...
namespace SteamNative
{
  ...
  internal struct AddUGCDependencyResult_t
  {
    ...
    {
      return Platform.PackSmall ? (PackSmall) Marshal.PtrToStructure(p, typeof (PackSmall)) : (AddUGCDependencyResult_t) Marshal.PtrToStructure(p, typeof (AddUGCDependencyResult_t));
    }
      ...
      Action<AddUGCDependencyResult_t, bool> CallbackFunction)
    {
      ...
      if (Config.UseThisCall)
      {
        ...
        Callback.ThisCall.GetSize d3 = _ => Marshal.SizeOf(typeof (AddUGCDependencyResult_t));
      ...
      else
      {
        ...
        Callback.StdCall.GetSize d6 = () => Marshal.SizeOf(typeof (AddUGCDependencyResult_t));
        if (Platform.PackSmall)
    ...
    internal struct PackSmall
    {
      ...
      public static implicit operator AddUGCDependencyResult_t(PackSmall d)
      {
