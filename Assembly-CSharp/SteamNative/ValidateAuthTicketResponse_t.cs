...
// Type: SteamNative.ValidateAuthTicketResponse_t
...
namespace SteamNative
{
  ...
  {
    public const int CallbackId = 143;
    ...
    {
      return Platform.PackSmall ? (ValidateAuthTicketResponse_t) (ValidateAuthTicketResponse_t.PackSmall) Marshal.PtrToStructure(p, typeof (ValidateAuthTicketResponse_t.PackSmall)) : (ValidateAuthTicketResponse_t) Marshal.PtrToStructure(p, typeof (ValidateAuthTicketResponse_t));
    }

    public static void RegisterCallback(
      BaseSteamworks steamworks,
      Action<ValidateAuthTicketResponse_t, bool> CallbackFunction)
    {
      CallbackHandle handle = new CallbackHandle();
      handle.steamworks = steamworks;
      if (Config.UseThisCall)
      {
        Callback.ThisCall.Result d1 = (Callback.ThisCall.Result) ((_, p) => CallbackFunction(ValidateAuthTicketResponse_t.FromPointer(p), false));
        Callback.ThisCall.ResultWithInfo d2 = (Callback.ThisCall.ResultWithInfo) ((_, p, bIOFailure, hSteamAPICall) => CallbackFunction(ValidateAuthTicketResponse_t.FromPointer(p), bIOFailure));
        Callback.ThisCall.GetSize d3 = (Callback.ThisCall.GetSize) (_ => Marshal.SizeOf(typeof (ValidateAuthTicketResponse_t)));
        if (Platform.PackSmall)
          d3 = (Callback.ThisCall.GetSize) (_ => Marshal.SizeOf(typeof (ValidateAuthTicketResponse_t.PackSmall)));
      ...
      {
        Callback.StdCall.Result d4 = (Callback.StdCall.Result) (p => CallbackFunction(ValidateAuthTicketResponse_t.FromPointer(p), false));
        Callback.StdCall.ResultWithInfo d5 = (Callback.StdCall.ResultWithInfo) ((p, bIOFailure, hSteamAPICall) => CallbackFunction(ValidateAuthTicketResponse_t.FromPointer(p), bIOFailure));
        Callback.StdCall.GetSize d6 = (Callback.StdCall.GetSize) (() => Marshal.SizeOf(typeof (ValidateAuthTicketResponse_t)));
        if (Platform.PackSmall)
          d6 = (Callback.StdCall.GetSize) (() => Marshal.SizeOf(typeof (ValidateAuthTicketResponse_t.PackSmall)));
      ...
      steamworks.native.api.SteamAPI_RegisterCallback(handle.PinnedCallback.AddrOfPinnedObject(), 143);
    ...
    internal struct PackSmall
    {
      ...
      public static implicit operator ValidateAuthTicketResponse_t(
        ValidateAuthTicketResponse_t.PackSmall d)
      {
