...
namespace SteamNative
{
  ...
  internal struct ValidateAuthTicketResponse_t
  {
    ...
    {
      return Platform.PackSmall ? (PackSmall) Marshal.PtrToStructure(p, typeof (PackSmall)) : (ValidateAuthTicketResponse_t) Marshal.PtrToStructure(p, typeof (ValidateAuthTicketResponse_t));
    }
      ...
      Action<ValidateAuthTicketResponse_t, bool> CallbackFunction)
    {
      ...
      if (Config.UseThisCall)
      {
        ...
        Callback.ThisCall.GetSize d3 = _ => Marshal.SizeOf(typeof (ValidateAuthTicketResponse_t));
      ...
      else
      {
        ...
        Callback.StdCall.GetSize d6 = () => Marshal.SizeOf(typeof (ValidateAuthTicketResponse_t));
        if (Platform.PackSmall)
