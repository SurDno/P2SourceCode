...
internal struct RemoteStorageFileReadAsyncComplete_t {
	...
	public static RemoteStorageFileReadAsyncComplete_t FromPointer(IntPtr p) {
		return Platform.PackSmall
			...
			: (RemoteStorageFileReadAsyncComplete_t)Marshal.PtrToStructure(p,
	...
	public static CallbackHandle CallResult(
		...
		SteamAPICall_t call,
		Action<RemoteStorageFileReadAsyncComplete_t, bool> CallbackFunction) {
	...
	public static void RegisterCallback(
		...
		steamworks.native.api.SteamAPI_RegisterCallback(handle.PinnedCallback.AddrOfPinnedObject(), 1332);
