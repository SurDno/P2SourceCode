...
namespace SteamNative
{
  ...
  internal struct RemoteStorageUpdatePublishedFileResult_t
  {
    ...
    {
      return Platform.PackSmall ? (PackSmall) Marshal.PtrToStructure(p, typeof (PackSmall)) : (RemoteStorageUpdatePublishedFileResult_t) Marshal.PtrToStructure(p, typeof (RemoteStorageUpdatePublishedFileResult_t));
    }
      ...
      Action<RemoteStorageUpdatePublishedFileResult_t, bool> CallbackFunction)
    {
      ...
      if (Config.UseThisCall)
      {
        ...
        Callback.ThisCall.GetSize d3 = _ => Marshal.SizeOf(typeof (RemoteStorageUpdatePublishedFileResult_t));
      ...
      else
      {
        ...
        Callback.StdCall.GetSize d6 = () => Marshal.SizeOf(typeof (RemoteStorageUpdatePublishedFileResult_t));
        if (Platform.PackSmall)
