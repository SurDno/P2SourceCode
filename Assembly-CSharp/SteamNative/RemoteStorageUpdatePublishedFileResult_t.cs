...
// Type: SteamNative.RemoteStorageUpdatePublishedFileResult_t
...
namespace SteamNative
{
  ...
  {
    public const int CallbackId = 1316;
    ...
    {
      return Platform.PackSmall ? (RemoteStorageUpdatePublishedFileResult_t) (RemoteStorageUpdatePublishedFileResult_t.PackSmall) Marshal.PtrToStructure(p, typeof (RemoteStorageUpdatePublishedFileResult_t.PackSmall)) : (RemoteStorageUpdatePublishedFileResult_t) Marshal.PtrToStructure(p, typeof (RemoteStorageUpdatePublishedFileResult_t));
    }

    public static CallbackHandle CallResult(
      BaseSteamworks steamworks,
      SteamAPICall_t call,
      Action<RemoteStorageUpdatePublishedFileResult_t, bool> CallbackFunction)
    {
      ...
      if (Config.UseThisCall)
      {
        ...
        {
          handle.Dispose();
          CallbackFunction(RemoteStorageUpdatePublishedFileResult_t.FromPointer(p), false);
        });
        Callback.ThisCall.ResultWithInfo d2 = (Callback.ThisCall.ResultWithInfo) ((_, p, bIOFailure, hSteamAPICall) =>
        {
          ...
          handle.Dispose();
          CallbackFunction(RemoteStorageUpdatePublishedFileResult_t.FromPointer(p), bIOFailure);
        });
        Callback.ThisCall.GetSize d3 = (Callback.ThisCall.GetSize) (_ => Marshal.SizeOf(typeof (RemoteStorageUpdatePublishedFileResult_t)));
        if (Platform.PackSmall)
          d3 = (Callback.ThisCall.GetSize) (_ => Marshal.SizeOf(typeof (RemoteStorageUpdatePublishedFileResult_t.PackSmall)));
      ...
      else
      {
        ...
        Callback.StdCall.GetSize d6 = (Callback.StdCall.GetSize) (() => Marshal.SizeOf(typeof (RemoteStorageUpdatePublishedFileResult_t)));
        if (Platform.PackSmall)
          d6 = (Callback.StdCall.GetSize) (() => Marshal.SizeOf(typeof (RemoteStorageUpdatePublishedFileResult_t.PackSmall)));
      ...
      Action<RemoteStorageUpdatePublishedFileResult_t, bool> CallbackFunction)
    {
      ...
      if (Config.UseThisCall)
      {
        Callback.ThisCall.Result d1 = (Callback.ThisCall.Result) ((_, p) => CallbackFunction(RemoteStorageUpdatePublishedFileResult_t.FromPointer(p), false));
        Callback.ThisCall.ResultWithInfo d2 = (Callback.ThisCall.ResultWithInfo) ((_, p, bIOFailure, hSteamAPICall) => CallbackFunction(RemoteStorageUpdatePublishedFileResult_t.FromPointer(p), bIOFailure));
        Callback.ThisCall.GetSize d3 = (Callback.ThisCall.GetSize) (_ => Marshal.SizeOf(typeof (RemoteStorageUpdatePublishedFileResult_t)));
        if (Platform.PackSmall)
          d3 = (Callback.ThisCall.GetSize) (_ => Marshal.SizeOf(typeof (RemoteStorageUpdatePublishedFileResult_t.PackSmall)));
        handle.FuncA = GCHandle.Alloc((object) d1);
      ...
      {
        Callback.StdCall.Result d4 = (Callback.StdCall.Result) (p => CallbackFunction(RemoteStorageUpdatePublishedFileResult_t.FromPointer(p), false));
        Callback.StdCall.ResultWithInfo d5 = (Callback.StdCall.ResultWithInfo) ((p, bIOFailure, hSteamAPICall) => CallbackFunction(RemoteStorageUpdatePublishedFileResult_t.FromPointer(p), bIOFailure));
        Callback.StdCall.GetSize d6 = (Callback.StdCall.GetSize) (() => Marshal.SizeOf(typeof (RemoteStorageUpdatePublishedFileResult_t)));
        if (Platform.PackSmall)
          d6 = (Callback.StdCall.GetSize) (() => Marshal.SizeOf(typeof (RemoteStorageUpdatePublishedFileResult_t.PackSmall)));
        handle.FuncA = GCHandle.Alloc((object) d4);
      ...
      steamworks.native.api.SteamAPI_RegisterCallback(handle.PinnedCallback.AddrOfPinnedObject(), 1316);
    ...
    internal struct PackSmall
    {
      ...
      public static implicit operator RemoteStorageUpdatePublishedFileResult_t(
        RemoteStorageUpdatePublishedFileResult_t.PackSmall d)
      {
