...
namespace SteamNative
{
  ...
  internal struct FavoritesListAccountsUpdated_t
  {
    ...
    {
      return Platform.PackSmall ? (PackSmall) Marshal.PtrToStructure(p, typeof (PackSmall)) : (FavoritesListAccountsUpdated_t) Marshal.PtrToStructure(p, typeof (FavoritesListAccountsUpdated_t));
    }
      ...
      Action<FavoritesListAccountsUpdated_t, bool> CallbackFunction)
    {
      ...
      if (Config.UseThisCall)
      {
        ...
        Callback.ThisCall.GetSize d3 = _ => Marshal.SizeOf(typeof (FavoritesListAccountsUpdated_t));
      ...
      else
      {
        ...
        Callback.StdCall.GetSize d6 = () => Marshal.SizeOf(typeof (FavoritesListAccountsUpdated_t));
        if (Platform.PackSmall)
