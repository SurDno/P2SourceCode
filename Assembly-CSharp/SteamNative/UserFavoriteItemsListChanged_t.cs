...
namespace SteamNative
{
  ...
  internal struct UserFavoriteItemsListChanged_t
  {
    ...
    {
      return Platform.PackSmall ? (PackSmall) Marshal.PtrToStructure(p, typeof (PackSmall)) : (UserFavoriteItemsListChanged_t) Marshal.PtrToStructure(p, typeof (UserFavoriteItemsListChanged_t));
    }
      ...
      Action<UserFavoriteItemsListChanged_t, bool> CallbackFunction)
    {
      ...
      if (Config.UseThisCall)
      {
        ...
        Callback.ThisCall.GetSize d3 = _ => Marshal.SizeOf(typeof (UserFavoriteItemsListChanged_t));
      ...
      else
      {
        ...
        Callback.StdCall.GetSize d6 = () => Marshal.SizeOf(typeof (UserFavoriteItemsListChanged_t));
        if (Platform.PackSmall)
