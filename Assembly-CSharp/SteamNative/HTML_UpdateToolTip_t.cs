...
namespace SteamNative
{
  ...
  internal struct HTML_UpdateToolTip_t
  {
    ...
    {
      return Platform.PackSmall ? (PackSmall) Marshal.PtrToStructure(p, typeof (PackSmall)) : (HTML_UpdateToolTip_t) Marshal.PtrToStructure(p, typeof (HTML_UpdateToolTip_t));
    }
      ...
      Action<HTML_UpdateToolTip_t, bool> CallbackFunction)
    {
      ...
      if (Config.UseThisCall)
      {
        ...
        Callback.ThisCall.GetSize d3 = _ => Marshal.SizeOf(typeof (HTML_UpdateToolTip_t));
      ...
      else
      {
        ...
        Callback.StdCall.GetSize d6 = () => Marshal.SizeOf(typeof (HTML_UpdateToolTip_t));
        if (Platform.PackSmall)
    ...
    internal struct PackSmall
    {
      ...
      public static implicit operator HTML_UpdateToolTip_t(PackSmall d)
      {
