...
namespace SteamNative
{
  ...
  internal struct GameOverlayActivated_t
  {
    ...
    {
      return Platform.PackSmall ? (PackSmall) Marshal.PtrToStructure(p, typeof (PackSmall)) : (GameOverlayActivated_t) Marshal.PtrToStructure(p, typeof (GameOverlayActivated_t));
    }
      ...
      Action<GameOverlayActivated_t, bool> CallbackFunction)
    {
      ...
      if (Config.UseThisCall)
      {
        ...
        Callback.ThisCall.GetSize d3 = _ => Marshal.SizeOf(typeof (GameOverlayActivated_t));
      ...
      else
      {
        ...
        Callback.StdCall.GetSize d6 = () => Marshal.SizeOf(typeof (GameOverlayActivated_t));
        if (Platform.PackSmall)
    ...
    internal struct PackSmall
    {
      ...
      public static implicit operator GameOverlayActivated_t(PackSmall d)
      {
