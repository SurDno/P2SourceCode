...
namespace SteamNative
{
  ...
  internal struct LobbyGameCreated_t
  {
    ...
    {
      return Platform.PackSmall ? (PackSmall) Marshal.PtrToStructure(p, typeof (PackSmall)) : (LobbyGameCreated_t) Marshal.PtrToStructure(p, typeof (LobbyGameCreated_t));
    }
      ...
      Action<LobbyGameCreated_t, bool> CallbackFunction)
    {
      ...
      if (Config.UseThisCall)
      {
        ...
        Callback.ThisCall.GetSize d3 = _ => Marshal.SizeOf(typeof (LobbyGameCreated_t));
      ...
      else
      {
        ...
        Callback.StdCall.GetSize d6 = () => Marshal.SizeOf(typeof (LobbyGameCreated_t));
        if (Platform.PackSmall)
    ...
    internal struct PackSmall
    {
      ...
      public static implicit operator LobbyGameCreated_t(PackSmall d)
      {
