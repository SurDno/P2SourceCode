...
namespace SteamNative
{
  ...
  internal struct HTML_URLChanged_t
  {
    ...
    {
      return Platform.PackSmall ? (PackSmall) Marshal.PtrToStructure(p, typeof (PackSmall)) : (HTML_URLChanged_t) Marshal.PtrToStructure(p, typeof (HTML_URLChanged_t));
    }
      ...
      Action<HTML_URLChanged_t, bool> CallbackFunction)
    {
      ...
      if (Config.UseThisCall)
      {
        ...
        Callback.ThisCall.GetSize d3 = _ => Marshal.SizeOf(typeof (HTML_URLChanged_t));
      ...
      else
      {
        ...
        Callback.StdCall.GetSize d6 = () => Marshal.SizeOf(typeof (HTML_URLChanged_t));
        if (Platform.PackSmall)
    ...
    internal struct PackSmall
    {
      ...
      public static implicit operator HTML_URLChanged_t(PackSmall d)
      {
