...
namespace SteamNative
{
  ...
  internal struct LobbyDataUpdate_t
  {
    ...
    {
      return Platform.PackSmall ? (PackSmall) Marshal.PtrToStructure(p, typeof (PackSmall)) : (LobbyDataUpdate_t) Marshal.PtrToStructure(p, typeof (LobbyDataUpdate_t));
    }
      ...
      Action<LobbyDataUpdate_t, bool> CallbackFunction)
    {
      ...
      if (Config.UseThisCall)
      {
        ...
        Callback.ThisCall.GetSize d3 = _ => Marshal.SizeOf(typeof (LobbyDataUpdate_t));
      ...
      else
      {
        ...
        Callback.StdCall.GetSize d6 = () => Marshal.SizeOf(typeof (LobbyDataUpdate_t));
        if (Platform.PackSmall)
    ...
    internal struct PackSmall
    {
      ...
      public static implicit operator LobbyDataUpdate_t(PackSmall d)
      {
