...
namespace SteamNative
{
  ...
  internal struct RegisterActivationCodeResponse_t
  {
    ...
    {
      return Platform.PackSmall ? (PackSmall) Marshal.PtrToStructure(p, typeof (PackSmall)) : (RegisterActivationCodeResponse_t) Marshal.PtrToStructure(p, typeof (RegisterActivationCodeResponse_t));
    }
      ...
      Action<RegisterActivationCodeResponse_t, bool> CallbackFunction)
    {
      ...
      if (Config.UseThisCall)
      {
        ...
        Callback.ThisCall.GetSize d3 = _ => Marshal.SizeOf(typeof (RegisterActivationCodeResponse_t));
      ...
      else
      {
        ...
        Callback.StdCall.GetSize d6 = () => Marshal.SizeOf(typeof (RegisterActivationCodeResponse_t));
        if (Platform.PackSmall)
