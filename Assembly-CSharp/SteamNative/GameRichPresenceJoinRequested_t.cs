...
namespace SteamNative
{
  ...
  internal struct GameRichPresenceJoinRequested_t
  {
    ...
    {
      return Platform.PackSmall ? (PackSmall) Marshal.PtrToStructure(p, typeof (PackSmall)) : (GameRichPresenceJoinRequested_t) Marshal.PtrToStructure(p, typeof (GameRichPresenceJoinRequested_t));
    }
      ...
      Action<GameRichPresenceJoinRequested_t, bool> CallbackFunction)
    {
      ...
      if (Config.UseThisCall)
      {
        ...
        Callback.ThisCall.GetSize d3 = _ => Marshal.SizeOf(typeof (GameRichPresenceJoinRequested_t));
      ...
      else
      {
        ...
        Callback.StdCall.GetSize d6 = () => Marshal.SizeOf(typeof (GameRichPresenceJoinRequested_t));
        if (Platform.PackSmall)
