...
// Type: SteamNative.MusicPlayerWantsShuffled_t
...
namespace SteamNative
{
  ...
  {
    public const int CallbackId = 4109;
    [MarshalAs(UnmanagedType.I1)]
    public bool Shuffled;

    public static MusicPlayerWantsShuffled_t FromPointer(IntPtr p)
    {
      return Platform.PackSmall ? (MusicPlayerWantsShuffled_t) (MusicPlayerWantsShuffled_t.PackSmall) Marshal.PtrToStructure(p, typeof (MusicPlayerWantsShuffled_t.PackSmall)) : (MusicPlayerWantsShuffled_t) Marshal.PtrToStructure(p, typeof (MusicPlayerWantsShuffled_t));
    }

    public static void RegisterCallback(
      BaseSteamworks steamworks,
      Action<MusicPlayerWantsShuffled_t, bool> CallbackFunction)
    {
      CallbackHandle handle = new CallbackHandle();
      handle.steamworks = steamworks;
      if (Config.UseThisCall)
      {
        Callback.ThisCall.Result d1 = (Callback.ThisCall.Result) ((_, p) => CallbackFunction(MusicPlayerWantsShuffled_t.FromPointer(p), false));
        Callback.ThisCall.ResultWithInfo d2 = (Callback.ThisCall.ResultWithInfo) ((_, p, bIOFailure, hSteamAPICall) => CallbackFunction(MusicPlayerWantsShuffled_t.FromPointer(p), bIOFailure));
        Callback.ThisCall.GetSize d3 = (Callback.ThisCall.GetSize) (_ => Marshal.SizeOf(typeof (MusicPlayerWantsShuffled_t)));
        if (Platform.PackSmall)
          d3 = (Callback.ThisCall.GetSize) (_ => Marshal.SizeOf(typeof (MusicPlayerWantsShuffled_t.PackSmall)));
      ...
      {
        Callback.StdCall.Result d4 = (Callback.StdCall.Result) (p => CallbackFunction(MusicPlayerWantsShuffled_t.FromPointer(p), false));
        Callback.StdCall.ResultWithInfo d5 = (Callback.StdCall.ResultWithInfo) ((p, bIOFailure, hSteamAPICall) => CallbackFunction(MusicPlayerWantsShuffled_t.FromPointer(p), bIOFailure));
        Callback.StdCall.GetSize d6 = (Callback.StdCall.GetSize) (() => Marshal.SizeOf(typeof (MusicPlayerWantsShuffled_t)));
        if (Platform.PackSmall)
          d6 = (Callback.StdCall.GetSize) (() => Marshal.SizeOf(typeof (MusicPlayerWantsShuffled_t.PackSmall)));
      ...
      steamworks.native.api.SteamAPI_RegisterCallback(handle.PinnedCallback.AddrOfPinnedObject(), 4109);
    ...
    internal struct PackSmall
    {
      ...
      public static implicit operator MusicPlayerWantsShuffled_t(
        MusicPlayerWantsShuffled_t.PackSmall d)
      {
