...
namespace SteamNative
{
  ...
  internal struct MusicPlayerWantsShuffled_t
  {
    ...
    {
      return Platform.PackSmall ? (PackSmall) Marshal.PtrToStructure(p, typeof (PackSmall)) : (MusicPlayerWantsShuffled_t) Marshal.PtrToStructure(p, typeof (MusicPlayerWantsShuffled_t));
    }
      ...
      Action<MusicPlayerWantsShuffled_t, bool> CallbackFunction)
    {
      ...
      if (Config.UseThisCall)
      {
        ...
        Callback.ThisCall.GetSize d3 = _ => Marshal.SizeOf(typeof (MusicPlayerWantsShuffled_t));
      ...
      else
      {
        ...
        Callback.StdCall.GetSize d6 = () => Marshal.SizeOf(typeof (MusicPlayerWantsShuffled_t));
        if (Platform.PackSmall)
