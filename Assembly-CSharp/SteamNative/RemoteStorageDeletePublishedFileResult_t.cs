...
namespace SteamNative
{
  ...
  internal struct RemoteStorageDeletePublishedFileResult_t
  {
    ...
    {
      return Platform.PackSmall ? (PackSmall) Marshal.PtrToStructure(p, typeof (PackSmall)) : (RemoteStorageDeletePublishedFileResult_t) Marshal.PtrToStructure(p, typeof (RemoteStorageDeletePublishedFileResult_t));
    }
      ...
      Action<RemoteStorageDeletePublishedFileResult_t, bool> CallbackFunction)
    {
      ...
      if (Config.UseThisCall)
      {
        ...
        Callback.ThisCall.GetSize d3 = _ => Marshal.SizeOf(typeof (RemoteStorageDeletePublishedFileResult_t));
      ...
      else
      {
        ...
        Callback.StdCall.GetSize d6 = () => Marshal.SizeOf(typeof (RemoteStorageDeletePublishedFileResult_t));
        if (Platform.PackSmall)
