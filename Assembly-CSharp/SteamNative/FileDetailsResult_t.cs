...
namespace SteamNative
{
  ...
  internal struct FileDetailsResult_t
  {
    ...
    {
      return Platform.PackSmall ? (PackSmall) Marshal.PtrToStructure(p, typeof (PackSmall)) : (FileDetailsResult_t) Marshal.PtrToStructure(p, typeof (FileDetailsResult_t));
    }
      ...
      Action<FileDetailsResult_t, bool> CallbackFunction)
    {
      ...
      if (Config.UseThisCall)
      {
        ...
        Callback.ThisCall.GetSize d3 = _ => Marshal.SizeOf(typeof (FileDetailsResult_t));
      ...
      else
      {
        ...
        Callback.StdCall.GetSize d6 = () => Marshal.SizeOf(typeof (FileDetailsResult_t));
        if (Platform.PackSmall)
