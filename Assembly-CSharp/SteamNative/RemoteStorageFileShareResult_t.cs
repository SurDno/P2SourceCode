...
// Type: SteamNative.RemoteStorageFileShareResult_t
...
namespace SteamNative
{
  ...
  {
    public const int CallbackId = 1307;
    ...
    {
      return Platform.PackSmall ? (RemoteStorageFileShareResult_t) (RemoteStorageFileShareResult_t.PackSmall) Marshal.PtrToStructure(p, typeof (RemoteStorageFileShareResult_t.PackSmall)) : (RemoteStorageFileShareResult_t) Marshal.PtrToStructure(p, typeof (RemoteStorageFileShareResult_t));
    }

    public static CallbackHandle CallResult(
      BaseSteamworks steamworks,
      SteamAPICall_t call,
      Action<RemoteStorageFileShareResult_t, bool> CallbackFunction)
    {
      ...
      if (Config.UseThisCall)
      {
        ...
        {
          handle.Dispose();
          CallbackFunction(RemoteStorageFileShareResult_t.FromPointer(p), false);
        });
        Callback.ThisCall.ResultWithInfo d2 = (Callback.ThisCall.ResultWithInfo) ((_, p, bIOFailure, hSteamAPICall) =>
        {
          ...
          handle.Dispose();
          CallbackFunction(RemoteStorageFileShareResult_t.FromPointer(p), bIOFailure);
        });
        Callback.ThisCall.GetSize d3 = (Callback.ThisCall.GetSize) (_ => Marshal.SizeOf(typeof (RemoteStorageFileShareResult_t)));
        if (Platform.PackSmall)
          d3 = (Callback.ThisCall.GetSize) (_ => Marshal.SizeOf(typeof (RemoteStorageFileShareResult_t.PackSmall)));
      ...
      else
      {
        ...
        Callback.StdCall.GetSize d6 = (Callback.StdCall.GetSize) (() => Marshal.SizeOf(typeof (RemoteStorageFileShareResult_t)));
        if (Platform.PackSmall)
          d6 = (Callback.StdCall.GetSize) (() => Marshal.SizeOf(typeof (RemoteStorageFileShareResult_t.PackSmall)));
      ...
      Action<RemoteStorageFileShareResult_t, bool> CallbackFunction)
    {
      ...
      if (Config.UseThisCall)
      {
        Callback.ThisCall.Result d1 = (Callback.ThisCall.Result) ((_, p) => CallbackFunction(RemoteStorageFileShareResult_t.FromPointer(p), false));
        Callback.ThisCall.ResultWithInfo d2 = (Callback.ThisCall.ResultWithInfo) ((_, p, bIOFailure, hSteamAPICall) => CallbackFunction(RemoteStorageFileShareResult_t.FromPointer(p), bIOFailure));
        Callback.ThisCall.GetSize d3 = (Callback.ThisCall.GetSize) (_ => Marshal.SizeOf(typeof (RemoteStorageFileShareResult_t)));
        if (Platform.PackSmall)
          d3 = (Callback.ThisCall.GetSize) (_ => Marshal.SizeOf(typeof (RemoteStorageFileShareResult_t.PackSmall)));
        handle.FuncA = GCHandle.Alloc((object) d1);
      ...
      {
        Callback.StdCall.Result d4 = (Callback.StdCall.Result) (p => CallbackFunction(RemoteStorageFileShareResult_t.FromPointer(p), false));
        Callback.StdCall.ResultWithInfo d5 = (Callback.StdCall.ResultWithInfo) ((p, bIOFailure, hSteamAPICall) => CallbackFunction(RemoteStorageFileShareResult_t.FromPointer(p), bIOFailure));
        Callback.StdCall.GetSize d6 = (Callback.StdCall.GetSize) (() => Marshal.SizeOf(typeof (RemoteStorageFileShareResult_t)));
        if (Platform.PackSmall)
          d6 = (Callback.StdCall.GetSize) (() => Marshal.SizeOf(typeof (RemoteStorageFileShareResult_t.PackSmall)));
        handle.FuncA = GCHandle.Alloc((object) d4);
      ...
      steamworks.native.api.SteamAPI_RegisterCallback(handle.PinnedCallback.AddrOfPinnedObject(), 1307);
    ...
    internal struct PackSmall
    {
      ...
      public static implicit operator RemoteStorageFileShareResult_t(
        RemoteStorageFileShareResult_t.PackSmall d)
      {
