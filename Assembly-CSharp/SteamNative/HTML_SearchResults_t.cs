...
namespace SteamNative
{
  ...
  internal struct HTML_SearchResults_t
  {
    ...
    {
      return Platform.PackSmall ? (PackSmall) Marshal.PtrToStructure(p, typeof (PackSmall)) : (HTML_SearchResults_t) Marshal.PtrToStructure(p, typeof (HTML_SearchResults_t));
    }
      ...
      Action<HTML_SearchResults_t, bool> CallbackFunction)
    {
      ...
      if (Config.UseThisCall)
      {
        ...
        Callback.ThisCall.GetSize d3 = _ => Marshal.SizeOf(typeof (HTML_SearchResults_t));
      ...
      else
      {
        ...
        Callback.StdCall.GetSize d6 = () => Marshal.SizeOf(typeof (HTML_SearchResults_t));
        if (Platform.PackSmall)
    ...
    internal struct PackSmall
    {
      ...
      public static implicit operator HTML_SearchResults_t(PackSmall d)
      {
