...
namespace SteamNative
{
  ...
  internal struct HTML_FileOpenDialog_t
  {
    ...
    {
      return Platform.PackSmall ? (PackSmall) Marshal.PtrToStructure(p, typeof (PackSmall)) : (HTML_FileOpenDialog_t) Marshal.PtrToStructure(p, typeof (HTML_FileOpenDialog_t));
    }
      ...
      Action<HTML_FileOpenDialog_t, bool> CallbackFunction)
    {
      ...
      if (Config.UseThisCall)
      {
        ...
        Callback.ThisCall.GetSize d3 = _ => Marshal.SizeOf(typeof (HTML_FileOpenDialog_t));
      ...
      else
      {
        ...
        Callback.StdCall.GetSize d6 = () => Marshal.SizeOf(typeof (HTML_FileOpenDialog_t));
        if (Platform.PackSmall)
    ...
    internal struct PackSmall
    {
      ...
      public static implicit operator HTML_FileOpenDialog_t(PackSmall d)
      {
