...
namespace SteamNative
{
  ...
  internal struct UserStatsUnloaded_t
  {
    ...
    {
      return Platform.PackSmall ? (PackSmall) Marshal.PtrToStructure(p, typeof (PackSmall)) : (UserStatsUnloaded_t) Marshal.PtrToStructure(p, typeof (UserStatsUnloaded_t));
    }
      ...
      Action<UserStatsUnloaded_t, bool> CallbackFunction)
    {
      ...
      if (Config.UseThisCall)
      {
        ...
        Callback.ThisCall.GetSize d3 = _ => Marshal.SizeOf(typeof (UserStatsUnloaded_t));
      ...
      else
      {
        ...
        Callback.StdCall.GetSize d6 = () => Marshal.SizeOf(typeof (UserStatsUnloaded_t));
        if (Platform.PackSmall)
    ...
    internal struct PackSmall
    {
      ...
      public static implicit operator UserStatsUnloaded_t(PackSmall d)
      {
