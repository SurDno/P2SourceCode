...
namespace SteamNative
{
  ...
  internal struct HTML_FinishedRequest_t
  {
    ...
    {
      return Platform.PackSmall ? (PackSmall) Marshal.PtrToStructure(p, typeof (PackSmall)) : (HTML_FinishedRequest_t) Marshal.PtrToStructure(p, typeof (HTML_FinishedRequest_t));
    }
      ...
      Action<HTML_FinishedRequest_t, bool> CallbackFunction)
    {
      ...
      if (Config.UseThisCall)
      {
        ...
        Callback.ThisCall.GetSize d3 = _ => Marshal.SizeOf(typeof (HTML_FinishedRequest_t));
      ...
      else
      {
        ...
        Callback.StdCall.GetSize d6 = () => Marshal.SizeOf(typeof (HTML_FinishedRequest_t));
        if (Platform.PackSmall)
    ...
    internal struct PackSmall
    {
      ...
      public static implicit operator HTML_FinishedRequest_t(PackSmall d)
      {
