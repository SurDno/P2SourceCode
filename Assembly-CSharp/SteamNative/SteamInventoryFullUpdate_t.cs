...
namespace SteamNative
{
  ...
  internal struct SteamInventoryFullUpdate_t
  {
    ...
    {
      return Platform.PackSmall ? (PackSmall) Marshal.PtrToStructure(p, typeof (PackSmall)) : (SteamInventoryFullUpdate_t) Marshal.PtrToStructure(p, typeof (SteamInventoryFullUpdate_t));
    }
      ...
      Action<SteamInventoryFullUpdate_t, bool> CallbackFunction)
    {
      ...
      if (Config.UseThisCall)
      {
        ...
        Callback.ThisCall.GetSize d3 = _ => Marshal.SizeOf(typeof (SteamInventoryFullUpdate_t));
      ...
      else
      {
        ...
        Callback.StdCall.GetSize d6 = () => Marshal.SizeOf(typeof (SteamInventoryFullUpdate_t));
        if (Platform.PackSmall)
