...
namespace SteamNative
{
  ...
  internal struct RemoteStorageUserVoteDetails_t
  {
    ...
    {
      return Platform.PackSmall ? (PackSmall) Marshal.PtrToStructure(p, typeof (PackSmall)) : (RemoteStorageUserVoteDetails_t) Marshal.PtrToStructure(p, typeof (RemoteStorageUserVoteDetails_t));
    }
      ...
      Action<RemoteStorageUserVoteDetails_t, bool> CallbackFunction)
    {
      ...
      if (Config.UseThisCall)
      {
        ...
        Callback.ThisCall.GetSize d3 = _ => Marshal.SizeOf(typeof (RemoteStorageUserVoteDetails_t));
      ...
      else
      {
        ...
        Callback.StdCall.GetSize d6 = () => Marshal.SizeOf(typeof (RemoteStorageUserVoteDetails_t));
        if (Platform.PackSmall)
