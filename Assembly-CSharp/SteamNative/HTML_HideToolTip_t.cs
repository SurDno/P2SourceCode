...
namespace SteamNative
{
  ...
  internal struct HTML_HideToolTip_t
  {
    ...
    {
      return Platform.PackSmall ? (PackSmall) Marshal.PtrToStructure(p, typeof (PackSmall)) : (HTML_HideToolTip_t) Marshal.PtrToStructure(p, typeof (HTML_HideToolTip_t));
    }
      ...
      Action<HTML_HideToolTip_t, bool> CallbackFunction)
    {
      ...
      if (Config.UseThisCall)
      {
        ...
        Callback.ThisCall.GetSize d3 = _ => Marshal.SizeOf(typeof (HTML_HideToolTip_t));
      ...
      else
      {
        ...
        Callback.StdCall.GetSize d6 = () => Marshal.SizeOf(typeof (HTML_HideToolTip_t));
        if (Platform.PackSmall)
    ...
    internal struct PackSmall
    {
      ...
      public static implicit operator HTML_HideToolTip_t(PackSmall d)
      {
