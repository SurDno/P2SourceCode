...
namespace SteamNative
{
  ...
  internal struct MusicPlayerWantsLooped_t
  {
    ...
    {
      return Platform.PackSmall ? (PackSmall) Marshal.PtrToStructure(p, typeof (PackSmall)) : (MusicPlayerWantsLooped_t) Marshal.PtrToStructure(p, typeof (MusicPlayerWantsLooped_t));
    }
      ...
      Action<MusicPlayerWantsLooped_t, bool> CallbackFunction)
    {
      ...
      if (Config.UseThisCall)
      {
        ...
        Callback.ThisCall.GetSize d3 = _ => Marshal.SizeOf(typeof (MusicPlayerWantsLooped_t));
      ...
      else
      {
        ...
        Callback.StdCall.GetSize d6 = () => Marshal.SizeOf(typeof (MusicPlayerWantsLooped_t));
        if (Platform.PackSmall)
    ...
    internal struct PackSmall
    {
      ...
      public static implicit operator MusicPlayerWantsLooped_t(PackSmall d)
      {
