...
namespace SteamNative
{
  ...
  internal struct FriendsGetFollowerCount_t
  {
    ...
    {
      return Platform.PackSmall ? (PackSmall) Marshal.PtrToStructure(p, typeof (PackSmall)) : (FriendsGetFollowerCount_t) Marshal.PtrToStructure(p, typeof (FriendsGetFollowerCount_t));
    }
      ...
      Action<FriendsGetFollowerCount_t, bool> CallbackFunction)
    {
      ...
      if (Config.UseThisCall)
      {
        ...
        Callback.ThisCall.GetSize d3 = _ => Marshal.SizeOf(typeof (FriendsGetFollowerCount_t));
      ...
      else
      {
        ...
        Callback.StdCall.GetSize d6 = () => Marshal.SizeOf(typeof (FriendsGetFollowerCount_t));
        if (Platform.PackSmall)
