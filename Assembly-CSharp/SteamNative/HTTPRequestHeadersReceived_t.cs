...
namespace SteamNative
{
  ...
  internal struct HTTPRequestHeadersReceived_t
  {
    ...
    {
      return Platform.PackSmall ? (PackSmall) Marshal.PtrToStructure(p, typeof (PackSmall)) : (HTTPRequestHeadersReceived_t) Marshal.PtrToStructure(p, typeof (HTTPRequestHeadersReceived_t));
    }
      ...
      Action<HTTPRequestHeadersReceived_t, bool> CallbackFunction)
    {
      ...
      if (Config.UseThisCall)
      {
        ...
        Callback.ThisCall.GetSize d3 = _ => Marshal.SizeOf(typeof (HTTPRequestHeadersReceived_t));
      ...
      else
      {
        ...
        Callback.StdCall.GetSize d6 = () => Marshal.SizeOf(typeof (HTTPRequestHeadersReceived_t));
        if (Platform.PackSmall)
