...
// Type: SteamNative.UserAchievementIconFetched_t
...
namespace SteamNative
{
  ...
  internal struct UserAchievementIconFetched_t
  {
    ...
    {
      return Platform.PackSmall ? (UserAchievementIconFetched_t) (UserAchievementIconFetched_t.PackSmall) Marshal.PtrToStructure(p, typeof (UserAchievementIconFetched_t.PackSmall)) : (UserAchievementIconFetched_t) Marshal.PtrToStructure(p, typeof (UserAchievementIconFetched_t));
    }
      ...
      Action<UserAchievementIconFetched_t, bool> CallbackFunction)
    {
      ...
      {
        Callback.ThisCall.Result d1 = (Callback.ThisCall.Result) ((_, p) => CallbackFunction(UserAchievementIconFetched_t.FromPointer(p), false));
        Callback.ThisCall.ResultWithInfo d2 = (Callback.ThisCall.ResultWithInfo) ((_, p, bIOFailure, hSteamAPICall) => CallbackFunction(UserAchievementIconFetched_t.FromPointer(p), bIOFailure));
        Callback.ThisCall.GetSize d3 = (Callback.ThisCall.GetSize) (_ => Marshal.SizeOf(typeof (UserAchievementIconFetched_t)));
        if (Platform.PackSmall)
          d3 = (Callback.ThisCall.GetSize) (_ => Marshal.SizeOf(typeof (UserAchievementIconFetched_t.PackSmall)));
      ...
      {
        Callback.StdCall.Result d4 = (Callback.StdCall.Result) (p => CallbackFunction(UserAchievementIconFetched_t.FromPointer(p), false));
        Callback.StdCall.ResultWithInfo d5 = (Callback.StdCall.ResultWithInfo) ((p, bIOFailure, hSteamAPICall) => CallbackFunction(UserAchievementIconFetched_t.FromPointer(p), bIOFailure));
        Callback.StdCall.GetSize d6 = (Callback.StdCall.GetSize) (() => Marshal.SizeOf(typeof (UserAchievementIconFetched_t)));
        if (Platform.PackSmall)
          d6 = (Callback.StdCall.GetSize) (() => Marshal.SizeOf(typeof (UserAchievementIconFetched_t.PackSmall)));
    ...
    internal struct PackSmall
    {
      ...
      public static implicit operator UserAchievementIconFetched_t(
        UserAchievementIconFetched_t.PackSmall d)
      {
