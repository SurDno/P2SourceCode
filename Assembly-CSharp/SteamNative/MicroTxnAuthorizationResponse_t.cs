...
// Type: SteamNative.MicroTxnAuthorizationResponse_t
...
namespace SteamNative
{
  ...
  {
    public const int CallbackId = 152;
    public uint AppID;
    ...
    {
      return Platform.PackSmall ? (MicroTxnAuthorizationResponse_t) (MicroTxnAuthorizationResponse_t.PackSmall) Marshal.PtrToStructure(p, typeof (MicroTxnAuthorizationResponse_t.PackSmall)) : (MicroTxnAuthorizationResponse_t) Marshal.PtrToStructure(p, typeof (MicroTxnAuthorizationResponse_t));
    }

    public static void RegisterCallback(
      BaseSteamworks steamworks,
      Action<MicroTxnAuthorizationResponse_t, bool> CallbackFunction)
    {
      CallbackHandle handle = new CallbackHandle();
      handle.steamworks = steamworks;
      if (Config.UseThisCall)
      {
        Callback.ThisCall.Result d1 = (Callback.ThisCall.Result) ((_, p) => CallbackFunction(MicroTxnAuthorizationResponse_t.FromPointer(p), false));
        Callback.ThisCall.ResultWithInfo d2 = (Callback.ThisCall.ResultWithInfo) ((_, p, bIOFailure, hSteamAPICall) => CallbackFunction(MicroTxnAuthorizationResponse_t.FromPointer(p), bIOFailure));
        Callback.ThisCall.GetSize d3 = (Callback.ThisCall.GetSize) (_ => Marshal.SizeOf(typeof (MicroTxnAuthorizationResponse_t)));
        if (Platform.PackSmall)
          d3 = (Callback.ThisCall.GetSize) (_ => Marshal.SizeOf(typeof (MicroTxnAuthorizationResponse_t.PackSmall)));
      ...
      {
        Callback.StdCall.Result d4 = (Callback.StdCall.Result) (p => CallbackFunction(MicroTxnAuthorizationResponse_t.FromPointer(p), false));
        Callback.StdCall.ResultWithInfo d5 = (Callback.StdCall.ResultWithInfo) ((p, bIOFailure, hSteamAPICall) => CallbackFunction(MicroTxnAuthorizationResponse_t.FromPointer(p), bIOFailure));
        Callback.StdCall.GetSize d6 = (Callback.StdCall.GetSize) (() => Marshal.SizeOf(typeof (MicroTxnAuthorizationResponse_t)));
        if (Platform.PackSmall)
          d6 = (Callback.StdCall.GetSize) (() => Marshal.SizeOf(typeof (MicroTxnAuthorizationResponse_t.PackSmall)));
      ...
      steamworks.native.api.SteamAPI_RegisterCallback(handle.PinnedCallback.AddrOfPinnedObject(), 152);
    ...
    internal struct PackSmall
    {
      ...
      public static implicit operator MicroTxnAuthorizationResponse_t(
        MicroTxnAuthorizationResponse_t.PackSmall d)
      {
