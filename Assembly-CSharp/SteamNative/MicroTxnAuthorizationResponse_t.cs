...
namespace SteamNative
{
  ...
  internal struct MicroTxnAuthorizationResponse_t
  {
    ...
    {
      return Platform.PackSmall ? (PackSmall) Marshal.PtrToStructure(p, typeof (PackSmall)) : (MicroTxnAuthorizationResponse_t) Marshal.PtrToStructure(p, typeof (MicroTxnAuthorizationResponse_t));
    }
      ...
      Action<MicroTxnAuthorizationResponse_t, bool> CallbackFunction)
    {
      ...
      if (Config.UseThisCall)
      {
        ...
        Callback.ThisCall.GetSize d3 = _ => Marshal.SizeOf(typeof (MicroTxnAuthorizationResponse_t));
      ...
      else
      {
        ...
        Callback.StdCall.GetSize d6 = () => Marshal.SizeOf(typeof (MicroTxnAuthorizationResponse_t));
        if (Platform.PackSmall)
