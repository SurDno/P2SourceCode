...
// Type: SteamNative.RemoteStorageEnumerateWorkshopFilesResult_t
...
namespace SteamNative
{
  ...
  {
    public const int CallbackId = 1319;
    ...
    {
      return Platform.PackSmall ? (RemoteStorageEnumerateWorkshopFilesResult_t) (RemoteStorageEnumerateWorkshopFilesResult_t.PackSmall) Marshal.PtrToStructure(p, typeof (RemoteStorageEnumerateWorkshopFilesResult_t.PackSmall)) : (RemoteStorageEnumerateWorkshopFilesResult_t) Marshal.PtrToStructure(p, typeof (RemoteStorageEnumerateWorkshopFilesResult_t));
    }

    public static CallbackHandle CallResult(
      BaseSteamworks steamworks,
      SteamAPICall_t call,
      Action<RemoteStorageEnumerateWorkshopFilesResult_t, bool> CallbackFunction)
    {
      ...
      if (Config.UseThisCall)
      {
        ...
        {
          handle.Dispose();
          CallbackFunction(RemoteStorageEnumerateWorkshopFilesResult_t.FromPointer(p), false);
        });
        Callback.ThisCall.ResultWithInfo d2 = (Callback.ThisCall.ResultWithInfo) ((_, p, bIOFailure, hSteamAPICall) =>
        {
          ...
          handle.Dispose();
          CallbackFunction(RemoteStorageEnumerateWorkshopFilesResult_t.FromPointer(p), bIOFailure);
        });
        Callback.ThisCall.GetSize d3 = (Callback.ThisCall.GetSize) (_ => Marshal.SizeOf(typeof (RemoteStorageEnumerateWorkshopFilesResult_t)));
        if (Platform.PackSmall)
          d3 = (Callback.ThisCall.GetSize) (_ => Marshal.SizeOf(typeof (RemoteStorageEnumerateWorkshopFilesResult_t.PackSmall)));
      ...
      else
      {
        ...
        Callback.StdCall.GetSize d6 = (Callback.StdCall.GetSize) (() => Marshal.SizeOf(typeof (RemoteStorageEnumerateWorkshopFilesResult_t)));
        if (Platform.PackSmall)
          d6 = (Callback.StdCall.GetSize) (() => Marshal.SizeOf(typeof (RemoteStorageEnumerateWorkshopFilesResult_t.PackSmall)));
      ...
      Action<RemoteStorageEnumerateWorkshopFilesResult_t, bool> CallbackFunction)
    {
      ...
      if (Config.UseThisCall)
      {
        Callback.ThisCall.Result d1 = (Callback.ThisCall.Result) ((_, p) => CallbackFunction(RemoteStorageEnumerateWorkshopFilesResult_t.FromPointer(p), false));
        Callback.ThisCall.ResultWithInfo d2 = (Callback.ThisCall.ResultWithInfo) ((_, p, bIOFailure, hSteamAPICall) => CallbackFunction(RemoteStorageEnumerateWorkshopFilesResult_t.FromPointer(p), bIOFailure));
        Callback.ThisCall.GetSize d3 = (Callback.ThisCall.GetSize) (_ => Marshal.SizeOf(typeof (RemoteStorageEnumerateWorkshopFilesResult_t)));
        if (Platform.PackSmall)
          d3 = (Callback.ThisCall.GetSize) (_ => Marshal.SizeOf(typeof (RemoteStorageEnumerateWorkshopFilesResult_t.PackSmall)));
        handle.FuncA = GCHandle.Alloc((object) d1);
      ...
      {
        Callback.StdCall.Result d4 = (Callback.StdCall.Result) (p => CallbackFunction(RemoteStorageEnumerateWorkshopFilesResult_t.FromPointer(p), false));
        Callback.StdCall.ResultWithInfo d5 = (Callback.StdCall.ResultWithInfo) ((p, bIOFailure, hSteamAPICall) => CallbackFunction(RemoteStorageEnumerateWorkshopFilesResult_t.FromPointer(p), bIOFailure));
        Callback.StdCall.GetSize d6 = (Callback.StdCall.GetSize) (() => Marshal.SizeOf(typeof (RemoteStorageEnumerateWorkshopFilesResult_t)));
        if (Platform.PackSmall)
          d6 = (Callback.StdCall.GetSize) (() => Marshal.SizeOf(typeof (RemoteStorageEnumerateWorkshopFilesResult_t.PackSmall)));
        handle.FuncA = GCHandle.Alloc((object) d4);
      ...
      steamworks.native.api.SteamAPI_RegisterCallback(handle.PinnedCallback.AddrOfPinnedObject(), 1319);
    ...
    internal struct PackSmall
    {
      ...
      public static implicit operator RemoteStorageEnumerateWorkshopFilesResult_t(
        RemoteStorageEnumerateWorkshopFilesResult_t.PackSmall d)
      {
