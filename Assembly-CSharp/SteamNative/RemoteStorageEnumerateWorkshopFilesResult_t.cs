...
namespace SteamNative
{
  ...
  internal struct RemoteStorageEnumerateWorkshopFilesResult_t
  {
    ...
    {
      return Platform.PackSmall ? (PackSmall) Marshal.PtrToStructure(p, typeof (PackSmall)) : (RemoteStorageEnumerateWorkshopFilesResult_t) Marshal.PtrToStructure(p, typeof (RemoteStorageEnumerateWorkshopFilesResult_t));
    }
      ...
      Action<RemoteStorageEnumerateWorkshopFilesResult_t, bool> CallbackFunction)
    {
      ...
      if (Config.UseThisCall)
      {
        ...
        Callback.ThisCall.GetSize d3 = _ => Marshal.SizeOf(typeof (RemoteStorageEnumerateWorkshopFilesResult_t));
      ...
      else
      {
        ...
        Callback.StdCall.GetSize d6 = () => Marshal.SizeOf(typeof (RemoteStorageEnumerateWorkshopFilesResult_t));
        if (Platform.PackSmall)
