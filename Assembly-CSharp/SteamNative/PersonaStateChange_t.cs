...
namespace SteamNative
{
  ...
  internal struct PersonaStateChange_t
  {
    ...
    {
      return Platform.PackSmall ? (PackSmall) Marshal.PtrToStructure(p, typeof (PackSmall)) : (PersonaStateChange_t) Marshal.PtrToStructure(p, typeof (PersonaStateChange_t));
    }
      ...
      Action<PersonaStateChange_t, bool> CallbackFunction)
    {
      ...
      if (Config.UseThisCall)
      {
        ...
        Callback.ThisCall.GetSize d3 = _ => Marshal.SizeOf(typeof (PersonaStateChange_t));
      ...
      else
      {
        ...
        Callback.StdCall.GetSize d6 = () => Marshal.SizeOf(typeof (PersonaStateChange_t));
        if (Platform.PackSmall)
    ...
    internal struct PackSmall
    {
      ...
      public static implicit operator PersonaStateChange_t(PackSmall d)
      {
