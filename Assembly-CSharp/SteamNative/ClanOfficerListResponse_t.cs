...
namespace SteamNative
{
  ...
  internal struct ClanOfficerListResponse_t
  {
    ...
    {
      return Platform.PackSmall ? (PackSmall) Marshal.PtrToStructure(p, typeof (PackSmall)) : (ClanOfficerListResponse_t) Marshal.PtrToStructure(p, typeof (ClanOfficerListResponse_t));
    }
      ...
      Action<ClanOfficerListResponse_t, bool> CallbackFunction)
    {
      ...
      if (Config.UseThisCall)
      {
        ...
        Callback.ThisCall.GetSize d3 = _ => Marshal.SizeOf(typeof (ClanOfficerListResponse_t));
      ...
      else
      {
        ...
        Callback.StdCall.GetSize d6 = () => Marshal.SizeOf(typeof (ClanOfficerListResponse_t));
        if (Platform.PackSmall)
