...
namespace SteamNative
{
  ...
  internal struct ScreenshotReady_t
  {
    ...
    {
      return Platform.PackSmall ? (PackSmall) Marshal.PtrToStructure(p, typeof (PackSmall)) : (ScreenshotReady_t) Marshal.PtrToStructure(p, typeof (ScreenshotReady_t));
    }
      ...
      Action<ScreenshotReady_t, bool> CallbackFunction)
    {
      ...
      if (Config.UseThisCall)
      {
        ...
        Callback.ThisCall.GetSize d3 = _ => Marshal.SizeOf(typeof (ScreenshotReady_t));
      ...
      else
      {
        ...
        Callback.StdCall.GetSize d6 = () => Marshal.SizeOf(typeof (ScreenshotReady_t));
        if (Platform.PackSmall)
    ...
    internal struct PackSmall
    {
      ...
      public static implicit operator ScreenshotReady_t(PackSmall d)
      {
