...
namespace SteamNative
{
  ...
  internal struct LobbyInvite_t
  {
    ...
    {
      return Platform.PackSmall ? (PackSmall) Marshal.PtrToStructure(p, typeof (PackSmall)) : (LobbyInvite_t) Marshal.PtrToStructure(p, typeof (LobbyInvite_t));
    }
      ...
      Action<LobbyInvite_t, bool> CallbackFunction)
    {
      ...
      if (Config.UseThisCall)
      {
        ...
        Callback.ThisCall.GetSize d3 = _ => Marshal.SizeOf(typeof (LobbyInvite_t));
      ...
      else
      {
        ...
        Callback.StdCall.GetSize d6 = () => Marshal.SizeOf(typeof (LobbyInvite_t));
        if (Platform.PackSmall)
    ...
    internal struct PackSmall
    {
      ...
      public static implicit operator LobbyInvite_t(PackSmall d)
      {
