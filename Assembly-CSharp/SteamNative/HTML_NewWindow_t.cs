...
// Type: SteamNative.HTML_NewWindow_t
...
namespace SteamNative
{
  ...
  internal struct HTML_NewWindow_t
  {
    ...
    {
      return Platform.PackSmall ? (HTML_NewWindow_t) (HTML_NewWindow_t.PackSmall) Marshal.PtrToStructure(p, typeof (HTML_NewWindow_t.PackSmall)) : (HTML_NewWindow_t) Marshal.PtrToStructure(p, typeof (HTML_NewWindow_t));
    }
      ...
      Action<HTML_NewWindow_t, bool> CallbackFunction)
    {
      ...
      {
        Callback.ThisCall.Result d1 = (Callback.ThisCall.Result) ((_, p) => CallbackFunction(HTML_NewWindow_t.FromPointer(p), false));
        Callback.ThisCall.ResultWithInfo d2 = (Callback.ThisCall.ResultWithInfo) ((_, p, bIOFailure, hSteamAPICall) => CallbackFunction(HTML_NewWindow_t.FromPointer(p), bIOFailure));
        Callback.ThisCall.GetSize d3 = (Callback.ThisCall.GetSize) (_ => Marshal.SizeOf(typeof (HTML_NewWindow_t)));
        if (Platform.PackSmall)
          d3 = (Callback.ThisCall.GetSize) (_ => Marshal.SizeOf(typeof (HTML_NewWindow_t.PackSmall)));
      ...
      {
        Callback.StdCall.Result d4 = (Callback.StdCall.Result) (p => CallbackFunction(HTML_NewWindow_t.FromPointer(p), false));
        Callback.StdCall.ResultWithInfo d5 = (Callback.StdCall.ResultWithInfo) ((p, bIOFailure, hSteamAPICall) => CallbackFunction(HTML_NewWindow_t.FromPointer(p), bIOFailure));
        Callback.StdCall.GetSize d6 = (Callback.StdCall.GetSize) (() => Marshal.SizeOf(typeof (HTML_NewWindow_t)));
        if (Platform.PackSmall)
          d6 = (Callback.StdCall.GetSize) (() => Marshal.SizeOf(typeof (HTML_NewWindow_t.PackSmall)));
