...
namespace SteamNative
{
  ...
  internal struct CheckFileSignature_t
  {
    ...
    {
      return Platform.PackSmall ? (PackSmall) Marshal.PtrToStructure(p, typeof (PackSmall)) : (CheckFileSignature_t) Marshal.PtrToStructure(p, typeof (CheckFileSignature_t));
    }
