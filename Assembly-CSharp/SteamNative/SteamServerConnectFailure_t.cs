...
namespace SteamNative
{
  ...
  internal struct SteamServerConnectFailure_t
  {
    ...
    {
      return Platform.PackSmall ? (PackSmall) Marshal.PtrToStructure(p, typeof (PackSmall)) : (SteamServerConnectFailure_t) Marshal.PtrToStructure(p, typeof (SteamServerConnectFailure_t));
    }
      ...
      Action<SteamServerConnectFailure_t, bool> CallbackFunction)
    {
      ...
      if (Config.UseThisCall)
      {
        ...
        Callback.ThisCall.GetSize d3 = _ => Marshal.SizeOf(typeof (SteamServerConnectFailure_t));
      ...
      else
      {
        ...
        Callback.StdCall.GetSize d6 = () => Marshal.SizeOf(typeof (SteamServerConnectFailure_t));
        if (Platform.PackSmall)
