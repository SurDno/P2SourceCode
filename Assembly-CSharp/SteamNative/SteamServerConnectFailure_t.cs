...
// Type: SteamNative.SteamServerConnectFailure_t
...
namespace SteamNative
{
  ...
  internal struct SteamServerConnectFailure_t
  {
    ...
    {
      return Platform.PackSmall ? (SteamServerConnectFailure_t) (SteamServerConnectFailure_t.PackSmall) Marshal.PtrToStructure(p, typeof (SteamServerConnectFailure_t.PackSmall)) : (SteamServerConnectFailure_t) Marshal.PtrToStructure(p, typeof (SteamServerConnectFailure_t));
    }

    public static void RegisterCallback(
      BaseSteamworks steamworks,
      Action<SteamServerConnectFailure_t, bool> CallbackFunction)
    {
      CallbackHandle handle = new CallbackHandle();
      handle.steamworks = steamworks;
      if (Config.UseThisCall)
      {
        Callback.ThisCall.Result d1 = (Callback.ThisCall.Result) ((_, p) => CallbackFunction(SteamServerConnectFailure_t.FromPointer(p), false));
        Callback.ThisCall.ResultWithInfo d2 = (Callback.ThisCall.ResultWithInfo) ((_, p, bIOFailure, hSteamAPICall) => CallbackFunction(SteamServerConnectFailure_t.FromPointer(p), bIOFailure));
        Callback.ThisCall.GetSize d3 = (Callback.ThisCall.GetSize) (_ => Marshal.SizeOf(typeof (SteamServerConnectFailure_t)));
        if (Platform.PackSmall)
          d3 = (Callback.ThisCall.GetSize) (_ => Marshal.SizeOf(typeof (SteamServerConnectFailure_t.PackSmall)));
      ...
      {
        Callback.StdCall.Result d4 = (Callback.StdCall.Result) (p => CallbackFunction(SteamServerConnectFailure_t.FromPointer(p), false));
        Callback.StdCall.ResultWithInfo d5 = (Callback.StdCall.ResultWithInfo) ((p, bIOFailure, hSteamAPICall) => CallbackFunction(SteamServerConnectFailure_t.FromPointer(p), bIOFailure));
        Callback.StdCall.GetSize d6 = (Callback.StdCall.GetSize) (() => Marshal.SizeOf(typeof (SteamServerConnectFailure_t)));
        if (Platform.PackSmall)
          d6 = (Callback.StdCall.GetSize) (() => Marshal.SizeOf(typeof (SteamServerConnectFailure_t.PackSmall)));
      ...
      steamworks.native.api.SteamAPI_RegisterCallback(handle.PinnedCallback.AddrOfPinnedObject(), 102);
    ...
    internal struct PackSmall
    {
      ...
      public static implicit operator SteamServerConnectFailure_t(
        SteamServerConnectFailure_t.PackSmall d)
      {
