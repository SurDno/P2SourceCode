...
namespace SteamNative
{
  ...
  internal struct HTML_JSConfirm_t
  {
    ...
    {
      return Platform.PackSmall ? (PackSmall) Marshal.PtrToStructure(p, typeof (PackSmall)) : (HTML_JSConfirm_t) Marshal.PtrToStructure(p, typeof (HTML_JSConfirm_t));
    }
      ...
      Action<HTML_JSConfirm_t, bool> CallbackFunction)
    {
      ...
      if (Config.UseThisCall)
      {
        ...
        Callback.ThisCall.GetSize d3 = _ => Marshal.SizeOf(typeof (HTML_JSConfirm_t));
      ...
      else
      {
        ...
        Callback.StdCall.GetSize d6 = () => Marshal.SizeOf(typeof (HTML_JSConfirm_t));
        if (Platform.PackSmall)
    ...
    internal struct PackSmall
    {
      ...
      public static implicit operator HTML_JSConfirm_t(PackSmall d)
      {
