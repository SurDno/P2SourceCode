...
// Type: SteamNative.LeaderboardScoreUploaded_t
...
namespace SteamNative
{
  ...
  internal struct LeaderboardScoreUploaded_t
  {
    ...
    {
      return Platform.PackSmall ? (LeaderboardScoreUploaded_t) (LeaderboardScoreUploaded_t.PackSmall) Marshal.PtrToStructure(p, typeof (LeaderboardScoreUploaded_t.PackSmall)) : (LeaderboardScoreUploaded_t) Marshal.PtrToStructure(p, typeof (LeaderboardScoreUploaded_t));
    }
      ...
      Action<LeaderboardScoreUploaded_t, bool> CallbackFunction)
    {
      ...
      if (Config.UseThisCall)
      {
        ...
        {
          handle.Dispose();
          CallbackFunction(LeaderboardScoreUploaded_t.FromPointer(p), false);
        });
        Callback.ThisCall.ResultWithInfo d2 = (Callback.ThisCall.ResultWithInfo) ((_, p, bIOFailure, hSteamAPICall) =>
        {
          ...
          handle.Dispose();
          CallbackFunction(LeaderboardScoreUploaded_t.FromPointer(p), bIOFailure);
        });
        Callback.ThisCall.GetSize d3 = (Callback.ThisCall.GetSize) (_ => Marshal.SizeOf(typeof (LeaderboardScoreUploaded_t)));
        if (Platform.PackSmall)
          d3 = (Callback.ThisCall.GetSize) (_ => Marshal.SizeOf(typeof (LeaderboardScoreUploaded_t.PackSmall)));
      ...
      else
      {
        ...
        Callback.StdCall.GetSize d6 = (Callback.StdCall.GetSize) (() => Marshal.SizeOf(typeof (LeaderboardScoreUploaded_t)));
        if (Platform.PackSmall)
          d6 = (Callback.StdCall.GetSize) (() => Marshal.SizeOf(typeof (LeaderboardScoreUploaded_t.PackSmall)));
      ...
      Action<LeaderboardScoreUploaded_t, bool> CallbackFunction)
    {
      ...
      if (Config.UseThisCall)
      {
        Callback.ThisCall.Result d1 = (Callback.ThisCall.Result) ((_, p) => CallbackFunction(LeaderboardScoreUploaded_t.FromPointer(p), false));
        Callback.ThisCall.ResultWithInfo d2 = (Callback.ThisCall.ResultWithInfo) ((_, p, bIOFailure, hSteamAPICall) => CallbackFunction(LeaderboardScoreUploaded_t.FromPointer(p), bIOFailure));
        Callback.ThisCall.GetSize d3 = (Callback.ThisCall.GetSize) (_ => Marshal.SizeOf(typeof (LeaderboardScoreUploaded_t)));
        if (Platform.PackSmall)
          d3 = (Callback.ThisCall.GetSize) (_ => Marshal.SizeOf(typeof (LeaderboardScoreUploaded_t.PackSmall)));
        handle.FuncA = GCHandle.Alloc((object) d1);
      ...
      {
        Callback.StdCall.Result d4 = (Callback.StdCall.Result) (p => CallbackFunction(LeaderboardScoreUploaded_t.FromPointer(p), false));
        Callback.StdCall.ResultWithInfo d5 = (Callback.StdCall.ResultWithInfo) ((p, bIOFailure, hSteamAPICall) => CallbackFunction(LeaderboardScoreUploaded_t.FromPointer(p), bIOFailure));
        Callback.StdCall.GetSize d6 = (Callback.StdCall.GetSize) (() => Marshal.SizeOf(typeof (LeaderboardScoreUploaded_t)));
        if (Platform.PackSmall)
          d6 = (Callback.StdCall.GetSize) (() => Marshal.SizeOf(typeof (LeaderboardScoreUploaded_t.PackSmall)));
        handle.FuncA = GCHandle.Alloc((object) d4);
    ...
    internal struct PackSmall
    {
      ...
      public static implicit operator LeaderboardScoreUploaded_t(
        LeaderboardScoreUploaded_t.PackSmall d)
      {
