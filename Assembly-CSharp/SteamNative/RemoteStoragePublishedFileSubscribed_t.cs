...
namespace SteamNative
{
  ...
  internal struct RemoteStoragePublishedFileSubscribed_t
  {
    ...
    {
      return Platform.PackSmall ? (PackSmall) Marshal.PtrToStructure(p, typeof (PackSmall)) : (RemoteStoragePublishedFileSubscribed_t) Marshal.PtrToStructure(p, typeof (RemoteStoragePublishedFileSubscribed_t));
    }
      ...
      Action<RemoteStoragePublishedFileSubscribed_t, bool> CallbackFunction)
    {
      ...
      if (Config.UseThisCall)
      {
        ...
        Callback.ThisCall.GetSize d3 = _ => Marshal.SizeOf(typeof (RemoteStoragePublishedFileSubscribed_t));
      ...
      else
      {
        ...
        Callback.StdCall.GetSize d6 = () => Marshal.SizeOf(typeof (RemoteStoragePublishedFileSubscribed_t));
        if (Platform.PackSmall)
