...
namespace SteamNative
{
  ...
  internal struct ItemInstalled_t
  {
    ...
    {
      return Platform.PackSmall ? (PackSmall) Marshal.PtrToStructure(p, typeof (PackSmall)) : (ItemInstalled_t) Marshal.PtrToStructure(p, typeof (ItemInstalled_t));
    }
      ...
      Action<ItemInstalled_t, bool> CallbackFunction)
    {
      ...
      if (Config.UseThisCall)
      {
        ...
        Callback.ThisCall.GetSize d3 = _ => Marshal.SizeOf(typeof (ItemInstalled_t));
      ...
      else
      {
        ...
        Callback.StdCall.GetSize d6 = () => Marshal.SizeOf(typeof (ItemInstalled_t));
        if (Platform.PackSmall)
    ...
    internal struct PackSmall
    {
      ...
      public static implicit operator ItemInstalled_t(PackSmall d)
      {
