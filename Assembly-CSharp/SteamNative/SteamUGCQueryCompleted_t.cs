...
namespace SteamNative
{
  ...
  internal struct SteamUGCQueryCompleted_t
  {
    ...
    {
      return Platform.PackSmall ? (PackSmall) Marshal.PtrToStructure(p, typeof (PackSmall)) : (SteamUGCQueryCompleted_t) Marshal.PtrToStructure(p, typeof (SteamUGCQueryCompleted_t));
    }
      ...
      Action<SteamUGCQueryCompleted_t, bool> CallbackFunction)
    {
      ...
      if (Config.UseThisCall)
      {
        ...
        Callback.ThisCall.GetSize d3 = _ => Marshal.SizeOf(typeof (SteamUGCQueryCompleted_t));
      ...
      else
      {
        ...
        Callback.StdCall.GetSize d6 = () => Marshal.SizeOf(typeof (SteamUGCQueryCompleted_t));
        if (Platform.PackSmall)
    ...
    internal struct PackSmall
    {
      ...
      public static implicit operator SteamUGCQueryCompleted_t(PackSmall d)
      {
