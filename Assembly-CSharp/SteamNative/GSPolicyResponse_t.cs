...
namespace SteamNative
{
  ...
  internal struct GSPolicyResponse_t
  {
    ...
    {
      return Platform.PackSmall ? (PackSmall) Marshal.PtrToStructure(p, typeof (PackSmall)) : (GSPolicyResponse_t) Marshal.PtrToStructure(p, typeof (GSPolicyResponse_t));
    }
      ...
      Action<GSPolicyResponse_t, bool> CallbackFunction)
    {
      ...
      if (Config.UseThisCall)
      {
        ...
        Callback.ThisCall.GetSize d3 = _ => Marshal.SizeOf(typeof (GSPolicyResponse_t));
      ...
      else
      {
        ...
        Callback.StdCall.GetSize d6 = () => Marshal.SizeOf(typeof (GSPolicyResponse_t));
        if (Platform.PackSmall)
    ...
    internal struct PackSmall
    {
      ...
      public static implicit operator GSPolicyResponse_t(PackSmall d)
      {
