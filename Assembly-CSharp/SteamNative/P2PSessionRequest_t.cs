...
namespace SteamNative
{
  ...
  internal struct P2PSessionRequest_t
  {
    ...
    {
      return Platform.PackSmall ? (PackSmall) Marshal.PtrToStructure(p, typeof (PackSmall)) : (P2PSessionRequest_t) Marshal.PtrToStructure(p, typeof (P2PSessionRequest_t));
    }
      ...
      Action<P2PSessionRequest_t, bool> CallbackFunction)
    {
      ...
      if (Config.UseThisCall)
      {
        ...
        Callback.ThisCall.GetSize d3 = _ => Marshal.SizeOf(typeof (P2PSessionRequest_t));
      ...
      else
      {
        ...
        Callback.StdCall.GetSize d6 = () => Marshal.SizeOf(typeof (P2PSessionRequest_t));
        if (Platform.PackSmall)
    ...
    internal struct PackSmall
    {
      ...
      public static implicit operator P2PSessionRequest_t(PackSmall d)
      {
