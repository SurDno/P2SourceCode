...
// Type: SteamNative.MusicPlayerSelectsPlaylistEntry_t
...
namespace SteamNative
{
  ...
  {
    public const int CallbackId = 4013;
    public int NID;

    public static MusicPlayerSelectsPlaylistEntry_t FromPointer(IntPtr p)
    {
      return Platform.PackSmall ? (MusicPlayerSelectsPlaylistEntry_t) (MusicPlayerSelectsPlaylistEntry_t.PackSmall) Marshal.PtrToStructure(p, typeof (MusicPlayerSelectsPlaylistEntry_t.PackSmall)) : (MusicPlayerSelectsPlaylistEntry_t) Marshal.PtrToStructure(p, typeof (MusicPlayerSelectsPlaylistEntry_t));
    }

    public static void RegisterCallback(
      BaseSteamworks steamworks,
      Action<MusicPlayerSelectsPlaylistEntry_t, bool> CallbackFunction)
    {
      CallbackHandle handle = new CallbackHandle();
      handle.steamworks = steamworks;
      if (Config.UseThisCall)
      {
        Callback.ThisCall.Result d1 = (Callback.ThisCall.Result) ((_, p) => CallbackFunction(MusicPlayerSelectsPlaylistEntry_t.FromPointer(p), false));
        Callback.ThisCall.ResultWithInfo d2 = (Callback.ThisCall.ResultWithInfo) ((_, p, bIOFailure, hSteamAPICall) => CallbackFunction(MusicPlayerSelectsPlaylistEntry_t.FromPointer(p), bIOFailure));
        Callback.ThisCall.GetSize d3 = (Callback.ThisCall.GetSize) (_ => Marshal.SizeOf(typeof (MusicPlayerSelectsPlaylistEntry_t)));
        if (Platform.PackSmall)
          d3 = (Callback.ThisCall.GetSize) (_ => Marshal.SizeOf(typeof (MusicPlayerSelectsPlaylistEntry_t.PackSmall)));
      ...
      {
        Callback.StdCall.Result d4 = (Callback.StdCall.Result) (p => CallbackFunction(MusicPlayerSelectsPlaylistEntry_t.FromPointer(p), false));
        Callback.StdCall.ResultWithInfo d5 = (Callback.StdCall.ResultWithInfo) ((p, bIOFailure, hSteamAPICall) => CallbackFunction(MusicPlayerSelectsPlaylistEntry_t.FromPointer(p), bIOFailure));
        Callback.StdCall.GetSize d6 = (Callback.StdCall.GetSize) (() => Marshal.SizeOf(typeof (MusicPlayerSelectsPlaylistEntry_t)));
        if (Platform.PackSmall)
          d6 = (Callback.StdCall.GetSize) (() => Marshal.SizeOf(typeof (MusicPlayerSelectsPlaylistEntry_t.PackSmall)));
      ...
      steamworks.native.api.SteamAPI_RegisterCallback(handle.PinnedCallback.AddrOfPinnedObject(), 4013);
    ...
    internal struct PackSmall
    {
      ...
      public static implicit operator MusicPlayerSelectsPlaylistEntry_t(
        MusicPlayerSelectsPlaylistEntry_t.PackSmall d)
      {
