...
namespace SteamNative
{
  ...
  internal struct MusicPlayerSelectsPlaylistEntry_t
  {
    ...
    {
      return Platform.PackSmall ? (PackSmall) Marshal.PtrToStructure(p, typeof (PackSmall)) : (MusicPlayerSelectsPlaylistEntry_t) Marshal.PtrToStructure(p, typeof (MusicPlayerSelectsPlaylistEntry_t));
    }
      ...
      Action<MusicPlayerSelectsPlaylistEntry_t, bool> CallbackFunction)
    {
      ...
      if (Config.UseThisCall)
      {
        ...
        Callback.ThisCall.GetSize d3 = _ => Marshal.SizeOf(typeof (MusicPlayerSelectsPlaylistEntry_t));
      ...
      else
      {
        ...
        Callback.StdCall.GetSize d6 = () => Marshal.SizeOf(typeof (MusicPlayerSelectsPlaylistEntry_t));
        if (Platform.PackSmall)
