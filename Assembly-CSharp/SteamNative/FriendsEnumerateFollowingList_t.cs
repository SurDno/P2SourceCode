...
// Type: SteamNative.FriendsEnumerateFollowingList_t
...
namespace SteamNative
{
  ...
  internal struct FriendsEnumerateFollowingList_t
  {
    ...
    {
      return Platform.PackSmall ? (FriendsEnumerateFollowingList_t) (FriendsEnumerateFollowingList_t.PackSmall) Marshal.PtrToStructure(p, typeof (FriendsEnumerateFollowingList_t.PackSmall)) : (FriendsEnumerateFollowingList_t) Marshal.PtrToStructure(p, typeof (FriendsEnumerateFollowingList_t));
    }
      ...
      Action<FriendsEnumerateFollowingList_t, bool> CallbackFunction)
    {
      ...
      if (Config.UseThisCall)
      {
        ...
        {
          handle.Dispose();
          CallbackFunction(FriendsEnumerateFollowingList_t.FromPointer(p), false);
        });
        Callback.ThisCall.ResultWithInfo d2 = (Callback.ThisCall.ResultWithInfo) ((_, p, bIOFailure, hSteamAPICall) =>
        {
          ...
          handle.Dispose();
          CallbackFunction(FriendsEnumerateFollowingList_t.FromPointer(p), bIOFailure);
        });
        Callback.ThisCall.GetSize d3 = (Callback.ThisCall.GetSize) (_ => Marshal.SizeOf(typeof (FriendsEnumerateFollowingList_t)));
        if (Platform.PackSmall)
          d3 = (Callback.ThisCall.GetSize) (_ => Marshal.SizeOf(typeof (FriendsEnumerateFollowingList_t.PackSmall)));
      ...
      else
      {
        ...
        Callback.StdCall.GetSize d6 = (Callback.StdCall.GetSize) (() => Marshal.SizeOf(typeof (FriendsEnumerateFollowingList_t)));
        if (Platform.PackSmall)
          d6 = (Callback.StdCall.GetSize) (() => Marshal.SizeOf(typeof (FriendsEnumerateFollowingList_t.PackSmall)));
      ...
      Action<FriendsEnumerateFollowingList_t, bool> CallbackFunction)
    {
      ...
      if (Config.UseThisCall)
      {
        Callback.ThisCall.Result d1 = (Callback.ThisCall.Result) ((_, p) => CallbackFunction(FriendsEnumerateFollowingList_t.FromPointer(p), false));
        Callback.ThisCall.ResultWithInfo d2 = (Callback.ThisCall.ResultWithInfo) ((_, p, bIOFailure, hSteamAPICall) => CallbackFunction(FriendsEnumerateFollowingList_t.FromPointer(p), bIOFailure));
        Callback.ThisCall.GetSize d3 = (Callback.ThisCall.GetSize) (_ => Marshal.SizeOf(typeof (FriendsEnumerateFollowingList_t)));
        if (Platform.PackSmall)
          d3 = (Callback.ThisCall.GetSize) (_ => Marshal.SizeOf(typeof (FriendsEnumerateFollowingList_t.PackSmall)));
        handle.FuncA = GCHandle.Alloc((object) d1);
      ...
      {
        Callback.StdCall.Result d4 = (Callback.StdCall.Result) (p => CallbackFunction(FriendsEnumerateFollowingList_t.FromPointer(p), false));
        Callback.StdCall.ResultWithInfo d5 = (Callback.StdCall.ResultWithInfo) ((p, bIOFailure, hSteamAPICall) => CallbackFunction(FriendsEnumerateFollowingList_t.FromPointer(p), bIOFailure));
        Callback.StdCall.GetSize d6 = (Callback.StdCall.GetSize) (() => Marshal.SizeOf(typeof (FriendsEnumerateFollowingList_t)));
        if (Platform.PackSmall)
          d6 = (Callback.StdCall.GetSize) (() => Marshal.SizeOf(typeof (FriendsEnumerateFollowingList_t.PackSmall)));
        handle.FuncA = GCHandle.Alloc((object) d4);
    ...
    internal struct PackSmall
    {
      ...
      public static implicit operator FriendsEnumerateFollowingList_t(
        FriendsEnumerateFollowingList_t.PackSmall d)
      {
