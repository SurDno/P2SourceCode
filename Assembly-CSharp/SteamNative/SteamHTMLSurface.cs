...
internal class SteamHTMLSurface : IDisposable {
	...
	public CallbackHandle CreateBrowser(
		...
		var browser = platform.ISteamHTMLSurface_CreateBrowser(pchUserAgent, pchUserCSS);
	...
	public void SetCookie(
		...
		bool bSecure,
		bool bHTTPOnly) {
		platform.ISteamHTMLSurface_SetCookie(pchHostname, pchKey, pchValue, pchPath, nExpires.Value, bSecure,
			bHTTPOnly);
	}
