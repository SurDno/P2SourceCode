...
namespace SteamNative
{
  ...
  internal struct HTML_ShowToolTip_t
  {
    ...
    {
      return Platform.PackSmall ? (PackSmall) Marshal.PtrToStructure(p, typeof (PackSmall)) : (HTML_ShowToolTip_t) Marshal.PtrToStructure(p, typeof (HTML_ShowToolTip_t));
    }
      ...
      Action<HTML_ShowToolTip_t, bool> CallbackFunction)
    {
      ...
      if (Config.UseThisCall)
      {
        ...
        Callback.ThisCall.GetSize d3 = _ => Marshal.SizeOf(typeof (HTML_ShowToolTip_t));
      ...
      else
      {
        ...
        Callback.StdCall.GetSize d6 = () => Marshal.SizeOf(typeof (HTML_ShowToolTip_t));
        if (Platform.PackSmall)
    ...
    internal struct PackSmall
    {
      ...
      public static implicit operator HTML_ShowToolTip_t(PackSmall d)
      {
