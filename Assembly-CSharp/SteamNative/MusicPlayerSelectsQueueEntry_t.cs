...
namespace SteamNative
{
  ...
  internal struct MusicPlayerSelectsQueueEntry_t
  {
    ...
    {
      return Platform.PackSmall ? (PackSmall) Marshal.PtrToStructure(p, typeof (PackSmall)) : (MusicPlayerSelectsQueueEntry_t) Marshal.PtrToStructure(p, typeof (MusicPlayerSelectsQueueEntry_t));
    }
      ...
      Action<MusicPlayerSelectsQueueEntry_t, bool> CallbackFunction)
    {
      ...
      if (Config.UseThisCall)
      {
        ...
        Callback.ThisCall.GetSize d3 = _ => Marshal.SizeOf(typeof (MusicPlayerSelectsQueueEntry_t));
      ...
      else
      {
        ...
        Callback.StdCall.GetSize d6 = () => Marshal.SizeOf(typeof (MusicPlayerSelectsQueueEntry_t));
        if (Platform.PackSmall)
