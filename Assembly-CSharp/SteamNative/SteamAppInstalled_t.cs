...
namespace SteamNative
{
  ...
  internal struct SteamAppInstalled_t
  {
    ...
    {
      return Platform.PackSmall ? (PackSmall) Marshal.PtrToStructure(p, typeof (PackSmall)) : (SteamAppInstalled_t) Marshal.PtrToStructure(p, typeof (SteamAppInstalled_t));
    }
      ...
      Action<SteamAppInstalled_t, bool> CallbackFunction)
    {
      ...
      if (Config.UseThisCall)
      {
        ...
        Callback.ThisCall.GetSize d3 = _ => Marshal.SizeOf(typeof (SteamAppInstalled_t));
      ...
      else
      {
        ...
        Callback.StdCall.GetSize d6 = () => Marshal.SizeOf(typeof (SteamAppInstalled_t));
        if (Platform.PackSmall)
    ...
    internal struct PackSmall
    {
      ...
      public static implicit operator SteamAppInstalled_t(PackSmall d)
      {
