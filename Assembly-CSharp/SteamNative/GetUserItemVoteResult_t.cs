...
internal struct GetUserItemVoteResult_t {
	...
	[MarshalAs(UnmanagedType.I1)] public bool VotedUp;
	[MarshalAs(UnmanagedType.I1)] public bool VotedDown;
	[MarshalAs(UnmanagedType.I1)] public bool VoteSkipped;
	...
	public static GetUserItemVoteResult_t FromPointer(IntPtr p) {
		return Platform.PackSmall
			...
			: (GetUserItemVoteResult_t)Marshal.PtrToStructure(p, typeof(GetUserItemVoteResult_t));
	}
	...
	public static CallbackHandle CallResult(
		...
		if (Config.UseThisCall) {
			...
			Callback.ThisCall.GetSize d3 = _ => Marshal.SizeOf(typeof(GetUserItemVoteResult_t));
			...
			Callback.StdCall.GetSize d6 = () => Marshal.SizeOf(typeof(GetUserItemVoteResult_t));
			if (Platform.PackSmall)
	...
	internal struct PackSmall {
		...
		public static implicit operator GetUserItemVoteResult_t(PackSmall d) {
