...
namespace SteamNative
{
  ...
  internal struct RemoteStoragePublishedFileUpdated_t
  {
    ...
    {
      return Platform.PackSmall ? (PackSmall) Marshal.PtrToStructure(p, typeof (PackSmall)) : (RemoteStoragePublishedFileUpdated_t) Marshal.PtrToStructure(p, typeof (RemoteStoragePublishedFileUpdated_t));
    }
      ...
      Action<RemoteStoragePublishedFileUpdated_t, bool> CallbackFunction)
    {
      ...
      if (Config.UseThisCall)
      {
        ...
        Callback.ThisCall.GetSize d3 = _ => Marshal.SizeOf(typeof (RemoteStoragePublishedFileUpdated_t));
      ...
      else
      {
        ...
        Callback.StdCall.GetSize d6 = () => Marshal.SizeOf(typeof (RemoteStoragePublishedFileUpdated_t));
        if (Platform.PackSmall)
