...
namespace SteamNative
{
  ...
  internal struct ClientGameServerDeny_t
  {
    ...
    {
      return Platform.PackSmall ? (PackSmall) Marshal.PtrToStructure(p, typeof (PackSmall)) : (ClientGameServerDeny_t) Marshal.PtrToStructure(p, typeof (ClientGameServerDeny_t));
    }
      ...
      Action<ClientGameServerDeny_t, bool> CallbackFunction)
    {
      ...
      if (Config.UseThisCall)
      {
        ...
        Callback.ThisCall.GetSize d3 = _ => Marshal.SizeOf(typeof (ClientGameServerDeny_t));
      ...
      else
      {
        ...
        Callback.StdCall.GetSize d6 = () => Marshal.SizeOf(typeof (ClientGameServerDeny_t));
        if (Platform.PackSmall)
    ...
    internal struct PackSmall
    {
      ...
      public static implicit operator ClientGameServerDeny_t(PackSmall d)
      {
