...
namespace SteamNative
{
  ...
  internal struct JoinClanChatRoomCompletionResult_t
  {
    ...
    {
      return Platform.PackSmall ? (PackSmall) Marshal.PtrToStructure(p, typeof (PackSmall)) : (JoinClanChatRoomCompletionResult_t) Marshal.PtrToStructure(p, typeof (JoinClanChatRoomCompletionResult_t));
    }
      ...
      Action<JoinClanChatRoomCompletionResult_t, bool> CallbackFunction)
    {
      ...
      if (Config.UseThisCall)
      {
        ...
        Callback.ThisCall.GetSize d3 = _ => Marshal.SizeOf(typeof (JoinClanChatRoomCompletionResult_t));
      ...
      else
      {
        ...
        Callback.StdCall.GetSize d6 = () => Marshal.SizeOf(typeof (JoinClanChatRoomCompletionResult_t));
        if (Platform.PackSmall)
