...
namespace SteamNative
{
  ...
  internal struct P2PSessionConnectFail_t
  {
    ...
    {
      return Platform.PackSmall ? (PackSmall) Marshal.PtrToStructure(p, typeof (PackSmall)) : (P2PSessionConnectFail_t) Marshal.PtrToStructure(p, typeof (P2PSessionConnectFail_t));
    }
      ...
      Action<P2PSessionConnectFail_t, bool> CallbackFunction)
    {
      ...
      if (Config.UseThisCall)
      {
        ...
        Callback.ThisCall.GetSize d3 = _ => Marshal.SizeOf(typeof (P2PSessionConnectFail_t));
      ...
      else
      {
        ...
        Callback.StdCall.GetSize d6 = () => Marshal.SizeOf(typeof (P2PSessionConnectFail_t));
        if (Platform.PackSmall)
    ...
    internal struct PackSmall
    {
      ...
      public static implicit operator P2PSessionConnectFail_t(PackSmall d)
      {
