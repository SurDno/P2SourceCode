...
namespace SteamNative
{
  ...
  internal struct RemoteStorageUnsubscribePublishedFileResult_t
  {
    ...
    {
      return Platform.PackSmall ? (PackSmall) Marshal.PtrToStructure(p, typeof (PackSmall)) : (RemoteStorageUnsubscribePublishedFileResult_t) Marshal.PtrToStructure(p, typeof (RemoteStorageUnsubscribePublishedFileResult_t));
    }
      ...
      Action<RemoteStorageUnsubscribePublishedFileResult_t, bool> CallbackFunction)
    {
      ...
      if (Config.UseThisCall)
      {
        ...
        Callback.ThisCall.GetSize d3 = _ => Marshal.SizeOf(typeof (RemoteStorageUnsubscribePublishedFileResult_t));
      ...
      else
      {
        ...
        Callback.StdCall.GetSize d6 = () => Marshal.SizeOf(typeof (RemoteStorageUnsubscribePublishedFileResult_t));
        if (Platform.PackSmall)
