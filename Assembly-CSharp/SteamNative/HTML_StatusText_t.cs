...
namespace SteamNative
{
  ...
  internal struct HTML_StatusText_t
  {
    ...
    {
      return Platform.PackSmall ? (PackSmall) Marshal.PtrToStructure(p, typeof (PackSmall)) : (HTML_StatusText_t) Marshal.PtrToStructure(p, typeof (HTML_StatusText_t));
    }
      ...
      Action<HTML_StatusText_t, bool> CallbackFunction)
    {
      ...
      if (Config.UseThisCall)
      {
        ...
        Callback.ThisCall.GetSize d3 = _ => Marshal.SizeOf(typeof (HTML_StatusText_t));
      ...
      else
      {
        ...
        Callback.StdCall.GetSize d6 = () => Marshal.SizeOf(typeof (HTML_StatusText_t));
        if (Platform.PackSmall)
    ...
    internal struct PackSmall
    {
      ...
      public static implicit operator HTML_StatusText_t(PackSmall d)
      {
