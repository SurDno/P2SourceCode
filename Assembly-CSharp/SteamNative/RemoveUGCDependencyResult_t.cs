...
namespace SteamNative
{
  ...
  internal struct RemoveUGCDependencyResult_t
  {
    ...
    {
      return Platform.PackSmall ? (PackSmall) Marshal.PtrToStructure(p, typeof (PackSmall)) : (RemoveUGCDependencyResult_t) Marshal.PtrToStructure(p, typeof (RemoveUGCDependencyResult_t));
    }
      ...
      Action<RemoveUGCDependencyResult_t, bool> CallbackFunction)
    {
      ...
      if (Config.UseThisCall)
      {
        ...
        Callback.ThisCall.GetSize d3 = _ => Marshal.SizeOf(typeof (RemoveUGCDependencyResult_t));
      ...
      else
      {
        ...
        Callback.StdCall.GetSize d6 = () => Marshal.SizeOf(typeof (RemoveUGCDependencyResult_t));
        if (Platform.PackSmall)
