...
namespace SteamNative
{
  ...
  internal struct GSClientDeny_t
  {
    ...
    {
      return Platform.PackSmall ? (PackSmall) Marshal.PtrToStructure(p, typeof (PackSmall)) : (GSClientDeny_t) Marshal.PtrToStructure(p, typeof (GSClientDeny_t));
    }
      ...
      Action<GSClientDeny_t, bool> CallbackFunction)
    {
      ...
      if (Config.UseThisCall)
      {
        ...
        Callback.ThisCall.GetSize d3 = _ => Marshal.SizeOf(typeof (GSClientDeny_t));
      ...
      else
      {
        ...
        Callback.StdCall.GetSize d6 = () => Marshal.SizeOf(typeof (GSClientDeny_t));
        if (Platform.PackSmall)
    ...
    internal struct PackSmall
    {
      ...
      public static implicit operator GSClientDeny_t(PackSmall d)
      {
