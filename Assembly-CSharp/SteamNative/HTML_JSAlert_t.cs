...
namespace SteamNative
{
  ...
  internal struct HTML_JSAlert_t
  {
    ...
    {
      return Platform.PackSmall ? (PackSmall) Marshal.PtrToStructure(p, typeof (PackSmall)) : (HTML_JSAlert_t) Marshal.PtrToStructure(p, typeof (HTML_JSAlert_t));
    }
      ...
      Action<HTML_JSAlert_t, bool> CallbackFunction)
    {
      ...
      if (Config.UseThisCall)
      {
        ...
        Callback.ThisCall.GetSize d3 = _ => Marshal.SizeOf(typeof (HTML_JSAlert_t));
      ...
      else
      {
        ...
        Callback.StdCall.GetSize d6 = () => Marshal.SizeOf(typeof (HTML_JSAlert_t));
        if (Platform.PackSmall)
    ...
    internal struct PackSmall
    {
      ...
      public static implicit operator HTML_JSAlert_t(PackSmall d)
      {
