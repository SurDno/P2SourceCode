...
namespace SteamNative
{
  ...
  internal struct GameServerChangeRequested_t
  {
    ...
    {
      return Platform.PackSmall ? (PackSmall) Marshal.PtrToStructure(p, typeof (PackSmall)) : (GameServerChangeRequested_t) Marshal.PtrToStructure(p, typeof (GameServerChangeRequested_t));
    }
      ...
      Action<GameServerChangeRequested_t, bool> CallbackFunction)
    {
      ...
      if (Config.UseThisCall)
      {
        ...
        Callback.ThisCall.GetSize d3 = _ => Marshal.SizeOf(typeof (GameServerChangeRequested_t));
      ...
      else
      {
        ...
        Callback.StdCall.GetSize d6 = () => Marshal.SizeOf(typeof (GameServerChangeRequested_t));
        if (Platform.PackSmall)
