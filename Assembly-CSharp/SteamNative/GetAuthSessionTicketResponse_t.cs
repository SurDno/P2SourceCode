...
// Type: SteamNative.GetAuthSessionTicketResponse_t
...
namespace SteamNative
{
  ...
  {
    public const int CallbackId = 163;
    public uint AuthTicket;
    public Result Result;

    public static GetAuthSessionTicketResponse_t FromPointer(IntPtr p)
    {
      return Platform.PackSmall ? (GetAuthSessionTicketResponse_t) (GetAuthSessionTicketResponse_t.PackSmall) Marshal.PtrToStructure(p, typeof (GetAuthSessionTicketResponse_t.PackSmall)) : (GetAuthSessionTicketResponse_t) Marshal.PtrToStructure(p, typeof (GetAuthSessionTicketResponse_t));
    }

    public static void RegisterCallback(
      BaseSteamworks steamworks,
      Action<GetAuthSessionTicketResponse_t, bool> CallbackFunction)
    {
      CallbackHandle handle = new CallbackHandle();
      handle.steamworks = steamworks;
      if (Config.UseThisCall)
      {
        Callback.ThisCall.Result d1 = (Callback.ThisCall.Result) ((_, p) => CallbackFunction(GetAuthSessionTicketResponse_t.FromPointer(p), false));
        Callback.ThisCall.ResultWithInfo d2 = (Callback.ThisCall.ResultWithInfo) ((_, p, bIOFailure, hSteamAPICall) => CallbackFunction(GetAuthSessionTicketResponse_t.FromPointer(p), bIOFailure));
        Callback.ThisCall.GetSize d3 = (Callback.ThisCall.GetSize) (_ => Marshal.SizeOf(typeof (GetAuthSessionTicketResponse_t)));
        if (Platform.PackSmall)
          d3 = (Callback.ThisCall.GetSize) (_ => Marshal.SizeOf(typeof (GetAuthSessionTicketResponse_t.PackSmall)));
      ...
      {
        Callback.StdCall.Result d4 = (Callback.StdCall.Result) (p => CallbackFunction(GetAuthSessionTicketResponse_t.FromPointer(p), false));
        Callback.StdCall.ResultWithInfo d5 = (Callback.StdCall.ResultWithInfo) ((p, bIOFailure, hSteamAPICall) => CallbackFunction(GetAuthSessionTicketResponse_t.FromPointer(p), bIOFailure));
        Callback.StdCall.GetSize d6 = (Callback.StdCall.GetSize) (() => Marshal.SizeOf(typeof (GetAuthSessionTicketResponse_t)));
        if (Platform.PackSmall)
          d6 = (Callback.StdCall.GetSize) (() => Marshal.SizeOf(typeof (GetAuthSessionTicketResponse_t.PackSmall)));
      ...
      steamworks.native.api.SteamAPI_RegisterCallback(handle.PinnedCallback.AddrOfPinnedObject(), 163);
    ...
    internal struct PackSmall
    {
      ...
      public static implicit operator GetAuthSessionTicketResponse_t(
        GetAuthSessionTicketResponse_t.PackSmall d)
      {
