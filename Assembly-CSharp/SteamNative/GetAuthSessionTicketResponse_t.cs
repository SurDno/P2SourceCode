...
namespace SteamNative
{
  ...
  internal struct GetAuthSessionTicketResponse_t
  {
    ...
    {
      return Platform.PackSmall ? (PackSmall) Marshal.PtrToStructure(p, typeof (PackSmall)) : (GetAuthSessionTicketResponse_t) Marshal.PtrToStructure(p, typeof (GetAuthSessionTicketResponse_t));
    }
      ...
      Action<GetAuthSessionTicketResponse_t, bool> CallbackFunction)
    {
      ...
      if (Config.UseThisCall)
      {
        ...
        Callback.ThisCall.GetSize d3 = _ => Marshal.SizeOf(typeof (GetAuthSessionTicketResponse_t));
      ...
      else
      {
        ...
        Callback.StdCall.GetSize d6 = () => Marshal.SizeOf(typeof (GetAuthSessionTicketResponse_t));
        if (Platform.PackSmall)
