...
namespace SteamNative
{
  ...
  internal struct HTTPRequestDataReceived_t
  {
    ...
    {
      return Platform.PackSmall ? (PackSmall) Marshal.PtrToStructure(p, typeof (PackSmall)) : (HTTPRequestDataReceived_t) Marshal.PtrToStructure(p, typeof (HTTPRequestDataReceived_t));
    }
      ...
      Action<HTTPRequestDataReceived_t, bool> CallbackFunction)
    {
      ...
      if (Config.UseThisCall)
      {
        ...
        Callback.ThisCall.GetSize d3 = _ => Marshal.SizeOf(typeof (HTTPRequestDataReceived_t));
      ...
      else
      {
        ...
        Callback.StdCall.GetSize d6 = () => Marshal.SizeOf(typeof (HTTPRequestDataReceived_t));
        if (Platform.PackSmall)
