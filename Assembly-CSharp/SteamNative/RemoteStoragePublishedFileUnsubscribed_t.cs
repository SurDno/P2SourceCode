...
namespace SteamNative
{
  ...
  internal struct RemoteStoragePublishedFileUnsubscribed_t
  {
    ...
    {
      return Platform.PackSmall ? (PackSmall) Marshal.PtrToStructure(p, typeof (PackSmall)) : (RemoteStoragePublishedFileUnsubscribed_t) Marshal.PtrToStructure(p, typeof (RemoteStoragePublishedFileUnsubscribed_t));
    }
      ...
      Action<RemoteStoragePublishedFileUnsubscribed_t, bool> CallbackFunction)
    {
      ...
      if (Config.UseThisCall)
      {
        ...
        Callback.ThisCall.GetSize d3 = _ => Marshal.SizeOf(typeof (RemoteStoragePublishedFileUnsubscribed_t));
      ...
      else
      {
        ...
        Callback.StdCall.GetSize d6 = () => Marshal.SizeOf(typeof (RemoteStoragePublishedFileUnsubscribed_t));
        if (Platform.PackSmall)
