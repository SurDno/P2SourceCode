...
namespace SteamNative
{
  ...
  internal struct MusicPlayerWantsVolume_t
  {
    ...
    {
      return Platform.PackSmall ? (PackSmall) Marshal.PtrToStructure(p, typeof (PackSmall)) : (MusicPlayerWantsVolume_t) Marshal.PtrToStructure(p, typeof (MusicPlayerWantsVolume_t));
    }
      ...
      Action<MusicPlayerWantsVolume_t, bool> CallbackFunction)
    {
      ...
      if (Config.UseThisCall)
      {
        ...
        Callback.ThisCall.GetSize d3 = _ => Marshal.SizeOf(typeof (MusicPlayerWantsVolume_t));
      ...
      else
      {
        ...
        Callback.StdCall.GetSize d6 = () => Marshal.SizeOf(typeof (MusicPlayerWantsVolume_t));
        if (Platform.PackSmall)
    ...
    internal struct PackSmall
    {
      ...
      public static implicit operator MusicPlayerWantsVolume_t(PackSmall d)
      {
