...
namespace SteamNative
{
  ...
  internal struct AvatarImageLoaded_t
  {
    ...
    {
      return Platform.PackSmall ? (PackSmall) Marshal.PtrToStructure(p, typeof (PackSmall)) : (AvatarImageLoaded_t) Marshal.PtrToStructure(p, typeof (AvatarImageLoaded_t));
    }
      ...
      Action<AvatarImageLoaded_t, bool> CallbackFunction)
    {
      ...
      if (Config.UseThisCall)
      {
        ...
        Callback.ThisCall.GetSize d3 = _ => Marshal.SizeOf(typeof (AvatarImageLoaded_t));
      ...
      else
      {
        ...
        Callback.StdCall.GetSize d6 = () => Marshal.SizeOf(typeof (AvatarImageLoaded_t));
        if (Platform.PackSmall)
    ...
    internal struct PackSmall
    {
      ...
      public static implicit operator AvatarImageLoaded_t(PackSmall d)
      {
