...
namespace SteamNative
{
  ...
  internal struct GetVideoURLResult_t
  {
    ...
    {
      return Platform.PackSmall ? (PackSmall) Marshal.PtrToStructure(p, typeof (PackSmall)) : (GetVideoURLResult_t) Marshal.PtrToStructure(p, typeof (GetVideoURLResult_t));
    }
      ...
      Action<GetVideoURLResult_t, bool> CallbackFunction)
    {
      ...
      if (Config.UseThisCall)
      {
        ...
        Callback.ThisCall.GetSize d3 = _ => Marshal.SizeOf(typeof (GetVideoURLResult_t));
      ...
      else
      {
        ...
        Callback.StdCall.GetSize d6 = () => Marshal.SizeOf(typeof (GetVideoURLResult_t));
        if (Platform.PackSmall)
    ...
    internal struct PackSmall
    {
      ...
      public static implicit operator GetVideoURLResult_t(PackSmall d)
      {
