...
internal class SteamMatchmakingServers : IDisposable {
	...
	public gameserveritem_t GetServerDetails(HServerListRequest hRequest, int iServer) {
		var serverDetails = platform.ISteamMatchmakingServers_GetServerDetails(hRequest.Value, iServer);
	...
	public HServerListRequest RequestFavoritesServerList(
		...
		return platform.ISteamMatchmakingServers_RequestFavoritesServerList(iApp.Value, ppchFilters, nFilters,
	...
	public HServerListRequest RequestFriendsServerList(
		...
		uint nFilters,
		IntPtr pRequestServersResponse) {
		return platform.ISteamMatchmakingServers_RequestFriendsServerList(iApp.Value, ppchFilters, nFilters,
			pRequestServersResponse);
	}
	...
	public HServerListRequest RequestHistoryServerList(
		...
		uint nFilters,
		IntPtr pRequestServersResponse) {
		return platform.ISteamMatchmakingServers_RequestHistoryServerList(iApp.Value, ppchFilters, nFilters,
			pRequestServersResponse);
	}
	...
	public HServerListRequest RequestInternetServerList(
		...
		uint nFilters,
		IntPtr pRequestServersResponse) {
		return platform.ISteamMatchmakingServers_RequestInternetServerList(iApp.Value, ppchFilters, nFilters,
			pRequestServersResponse);
	}
	...
	public HServerListRequest RequestSpectatorServerList(
		...
		uint nFilters,
		IntPtr pRequestServersResponse) {
		return platform.ISteamMatchmakingServers_RequestSpectatorServerList(iApp.Value, ppchFilters, nFilters,
			pRequestServersResponse);
	}
