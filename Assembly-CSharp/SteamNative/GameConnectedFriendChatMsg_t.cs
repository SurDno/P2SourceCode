...
namespace SteamNative
{
  ...
  internal struct GameConnectedFriendChatMsg_t
  {
    ...
    {
      return Platform.PackSmall ? (PackSmall) Marshal.PtrToStructure(p, typeof (PackSmall)) : (GameConnectedFriendChatMsg_t) Marshal.PtrToStructure(p, typeof (GameConnectedFriendChatMsg_t));
    }
      ...
      Action<GameConnectedFriendChatMsg_t, bool> CallbackFunction)
    {
      ...
      if (Config.UseThisCall)
      {
        ...
        Callback.ThisCall.GetSize d3 = _ => Marshal.SizeOf(typeof (GameConnectedFriendChatMsg_t));
      ...
      else
      {
        ...
        Callback.StdCall.GetSize d6 = () => Marshal.SizeOf(typeof (GameConnectedFriendChatMsg_t));
        if (Platform.PackSmall)
