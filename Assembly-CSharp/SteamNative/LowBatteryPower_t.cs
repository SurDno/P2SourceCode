...
namespace SteamNative
{
  ...
  internal struct LowBatteryPower_t
  {
    ...
    {
      return Platform.PackSmall ? (PackSmall) Marshal.PtrToStructure(p, typeof (PackSmall)) : (LowBatteryPower_t) Marshal.PtrToStructure(p, typeof (LowBatteryPower_t));
    }
      ...
      Action<LowBatteryPower_t, bool> CallbackFunction)
    {
      ...
      if (Config.UseThisCall)
      {
        ...
        Callback.ThisCall.GetSize d3 = _ => Marshal.SizeOf(typeof (LowBatteryPower_t));
      ...
      else
      {
        ...
        Callback.StdCall.GetSize d6 = () => Marshal.SizeOf(typeof (LowBatteryPower_t));
        if (Platform.PackSmall)
    ...
    internal struct PackSmall
    {
      ...
      public static implicit operator LowBatteryPower_t(PackSmall d)
      {
