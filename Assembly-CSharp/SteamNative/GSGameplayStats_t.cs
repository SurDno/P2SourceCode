...
namespace SteamNative
{
  ...
  internal struct GSGameplayStats_t
  {
    ...
    {
      return Platform.PackSmall ? (PackSmall) Marshal.PtrToStructure(p, typeof (PackSmall)) : (GSGameplayStats_t) Marshal.PtrToStructure(p, typeof (GSGameplayStats_t));
    }
      ...
      Action<GSGameplayStats_t, bool> CallbackFunction)
    {
      ...
      if (Config.UseThisCall)
      {
        ...
        Callback.ThisCall.GetSize d3 = _ => Marshal.SizeOf(typeof (GSGameplayStats_t));
      ...
      else
      {
        ...
        Callback.StdCall.GetSize d6 = () => Marshal.SizeOf(typeof (GSGameplayStats_t));
        if (Platform.PackSmall)
    ...
    internal struct PackSmall
    {
      ...
      public static implicit operator GSGameplayStats_t(PackSmall d)
      {
