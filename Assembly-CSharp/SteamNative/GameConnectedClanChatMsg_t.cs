...
namespace SteamNative
{
  ...
  internal struct GameConnectedClanChatMsg_t
  {
    ...
    {
      return Platform.PackSmall ? (PackSmall) Marshal.PtrToStructure(p, typeof (PackSmall)) : (GameConnectedClanChatMsg_t) Marshal.PtrToStructure(p, typeof (GameConnectedClanChatMsg_t));
    }
      ...
      Action<GameConnectedClanChatMsg_t, bool> CallbackFunction)
    {
      ...
      if (Config.UseThisCall)
      {
        ...
        Callback.ThisCall.GetSize d3 = _ => Marshal.SizeOf(typeof (GameConnectedClanChatMsg_t));
      ...
      else
      {
        ...
        Callback.StdCall.GetSize d6 = () => Marshal.SizeOf(typeof (GameConnectedClanChatMsg_t));
        if (Platform.PackSmall)
