...
namespace SteamNative
{
  ...
  internal struct LeaderboardUGCSet_t
  {
    ...
    {
      return Platform.PackSmall ? (PackSmall) Marshal.PtrToStructure(p, typeof (PackSmall)) : (LeaderboardUGCSet_t) Marshal.PtrToStructure(p, typeof (LeaderboardUGCSet_t));
    }
      ...
      Action<LeaderboardUGCSet_t, bool> CallbackFunction)
    {
      ...
      if (Config.UseThisCall)
      {
        ...
        Callback.ThisCall.GetSize d3 = _ => Marshal.SizeOf(typeof (LeaderboardUGCSet_t));
      ...
      else
      {
        ...
        Callback.StdCall.GetSize d6 = () => Marshal.SizeOf(typeof (LeaderboardUGCSet_t));
        if (Platform.PackSmall)
    ...
    internal struct PackSmall
    {
      ...
      public static implicit operator LeaderboardUGCSet_t(PackSmall d)
      {
