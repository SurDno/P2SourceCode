...
namespace SteamNative
{
  ...
  internal struct PS3TrophiesInstalled_t
  {
    ...
    {
      return Platform.PackSmall ? (PackSmall) Marshal.PtrToStructure(p, typeof (PackSmall)) : (PS3TrophiesInstalled_t) Marshal.PtrToStructure(p, typeof (PS3TrophiesInstalled_t));
    }
      ...
      Action<PS3TrophiesInstalled_t, bool> CallbackFunction)
    {
      ...
      if (Config.UseThisCall)
      {
        ...
        Callback.ThisCall.GetSize d3 = _ => Marshal.SizeOf(typeof (PS3TrophiesInstalled_t));
      ...
      else
      {
        ...
        Callback.StdCall.GetSize d6 = () => Marshal.SizeOf(typeof (PS3TrophiesInstalled_t));
        if (Platform.PackSmall)
    ...
    internal struct PackSmall
    {
      ...
      public static implicit operator PS3TrophiesInstalled_t(PackSmall d)
      {
