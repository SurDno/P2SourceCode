...
namespace SteamNative
{
  ...
  internal struct VolumeHasChanged_t
  {
    ...
    {
      return Platform.PackSmall ? (PackSmall) Marshal.PtrToStructure(p, typeof (PackSmall)) : (VolumeHasChanged_t) Marshal.PtrToStructure(p, typeof (VolumeHasChanged_t));
    }
      ...
      Action<VolumeHasChanged_t, bool> CallbackFunction)
    {
      ...
      if (Config.UseThisCall)
      {
        ...
        Callback.ThisCall.GetSize d3 = _ => Marshal.SizeOf(typeof (VolumeHasChanged_t));
      ...
      else
      {
        ...
        Callback.StdCall.GetSize d6 = () => Marshal.SizeOf(typeof (VolumeHasChanged_t));
        if (Platform.PackSmall)
    ...
    internal struct PackSmall
    {
      ...
      public static implicit operator VolumeHasChanged_t(PackSmall d)
      {
