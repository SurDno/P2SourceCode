...
internal struct GameConnectedChatLeave_t {
	...
	[MarshalAs(UnmanagedType.I1)] public bool Kicked;
	[MarshalAs(UnmanagedType.I1)] public bool Dropped;
	...
	public static GameConnectedChatLeave_t FromPointer(IntPtr p) {
		return Platform.PackSmall
			...
			: (GameConnectedChatLeave_t)Marshal.PtrToStructure(p, typeof(GameConnectedChatLeave_t));
	}
	...
	public static void RegisterCallback(
		...
		if (Config.UseThisCall) {
			...
			Callback.ThisCall.GetSize d3 = _ => Marshal.SizeOf(typeof(GameConnectedChatLeave_t));
			...
			Callback.StdCall.ResultWithInfo d5 = (p, bIOFailure, hSteamAPICall) =>
				CallbackFunction(FromPointer(p), bIOFailure);
			Callback.StdCall.GetSize d6 = () => Marshal.SizeOf(typeof(GameConnectedChatLeave_t));
			if (Platform.PackSmall)
	...
	internal struct PackSmall {
		...
		public static implicit operator GameConnectedChatLeave_t(PackSmall d) {
