...
namespace SteamNative
{
  ...
  internal struct GameConnectedChatJoin_t
  {
    ...
    {
      return Platform.PackSmall ? (PackSmall) Marshal.PtrToStructure(p, typeof (PackSmall)) : (GameConnectedChatJoin_t) Marshal.PtrToStructure(p, typeof (GameConnectedChatJoin_t));
    }
      ...
      Action<GameConnectedChatJoin_t, bool> CallbackFunction)
    {
      ...
      if (Config.UseThisCall)
      {
        ...
        Callback.ThisCall.GetSize d3 = _ => Marshal.SizeOf(typeof (GameConnectedChatJoin_t));
      ...
      else
      {
        ...
        Callback.StdCall.GetSize d6 = () => Marshal.SizeOf(typeof (GameConnectedChatJoin_t));
        if (Platform.PackSmall)
    ...
    internal struct PackSmall
    {
      ...
      public static implicit operator GameConnectedChatJoin_t(PackSmall d)
      {
