...
namespace SteamNative
{
  ...
  internal struct SetUserItemVoteResult_t
  {
    ...
    {
      return Platform.PackSmall ? (PackSmall) Marshal.PtrToStructure(p, typeof (PackSmall)) : (SetUserItemVoteResult_t) Marshal.PtrToStructure(p, typeof (SetUserItemVoteResult_t));
    }
      ...
      Action<SetUserItemVoteResult_t, bool> CallbackFunction)
    {
      ...
      if (Config.UseThisCall)
      {
        ...
        Callback.ThisCall.GetSize d3 = _ => Marshal.SizeOf(typeof (SetUserItemVoteResult_t));
      ...
      else
      {
        ...
        Callback.StdCall.GetSize d6 = () => Marshal.SizeOf(typeof (SetUserItemVoteResult_t));
        if (Platform.PackSmall)
    ...
    internal struct PackSmall
    {
      ...
      public static implicit operator SetUserItemVoteResult_t(PackSmall d)
      {
