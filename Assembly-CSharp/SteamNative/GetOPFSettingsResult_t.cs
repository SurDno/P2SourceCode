...
namespace SteamNative
{
  ...
  internal struct GetOPFSettingsResult_t
  {
    ...
    {
      return Platform.PackSmall ? (PackSmall) Marshal.PtrToStructure(p, typeof (PackSmall)) : (GetOPFSettingsResult_t) Marshal.PtrToStructure(p, typeof (GetOPFSettingsResult_t));
    }
      ...
      Action<GetOPFSettingsResult_t, bool> CallbackFunction)
    {
      ...
      if (Config.UseThisCall)
      {
        ...
        Callback.ThisCall.GetSize d3 = _ => Marshal.SizeOf(typeof (GetOPFSettingsResult_t));
      ...
      else
      {
        ...
        Callback.StdCall.GetSize d6 = () => Marshal.SizeOf(typeof (GetOPFSettingsResult_t));
        if (Platform.PackSmall)
    ...
    internal struct PackSmall
    {
      ...
      public static implicit operator GetOPFSettingsResult_t(PackSmall d)
      {
