...
// Type: SteamNative.GetOPFSettingsResult_t
...
namespace SteamNative
{
  ...
  {
    public const int CallbackId = 4624;
    public Result Result;
    public uint VideoAppID;

    public static GetOPFSettingsResult_t FromPointer(IntPtr p)
    {
      return Platform.PackSmall ? (GetOPFSettingsResult_t) (GetOPFSettingsResult_t.PackSmall) Marshal.PtrToStructure(p, typeof (GetOPFSettingsResult_t.PackSmall)) : (GetOPFSettingsResult_t) Marshal.PtrToStructure(p, typeof (GetOPFSettingsResult_t));
    }

    public static void RegisterCallback(
      BaseSteamworks steamworks,
      Action<GetOPFSettingsResult_t, bool> CallbackFunction)
    {
      CallbackHandle handle = new CallbackHandle();
      handle.steamworks = steamworks;
      if (Config.UseThisCall)
      {
        Callback.ThisCall.Result d1 = (Callback.ThisCall.Result) ((_, p) => CallbackFunction(GetOPFSettingsResult_t.FromPointer(p), false));
        Callback.ThisCall.ResultWithInfo d2 = (Callback.ThisCall.ResultWithInfo) ((_, p, bIOFailure, hSteamAPICall) => CallbackFunction(GetOPFSettingsResult_t.FromPointer(p), bIOFailure));
        Callback.ThisCall.GetSize d3 = (Callback.ThisCall.GetSize) (_ => Marshal.SizeOf(typeof (GetOPFSettingsResult_t)));
        if (Platform.PackSmall)
          d3 = (Callback.ThisCall.GetSize) (_ => Marshal.SizeOf(typeof (GetOPFSettingsResult_t.PackSmall)));
      ...
      {
        Callback.StdCall.Result d4 = (Callback.StdCall.Result) (p => CallbackFunction(GetOPFSettingsResult_t.FromPointer(p), false));
        Callback.StdCall.ResultWithInfo d5 = (Callback.StdCall.ResultWithInfo) ((p, bIOFailure, hSteamAPICall) => CallbackFunction(GetOPFSettingsResult_t.FromPointer(p), bIOFailure));
        Callback.StdCall.GetSize d6 = (Callback.StdCall.GetSize) (() => Marshal.SizeOf(typeof (GetOPFSettingsResult_t)));
        if (Platform.PackSmall)
          d6 = (Callback.StdCall.GetSize) (() => Marshal.SizeOf(typeof (GetOPFSettingsResult_t.PackSmall)));
      ...
      steamworks.native.api.SteamAPI_RegisterCallback(handle.PinnedCallback.AddrOfPinnedObject(), 4624);
