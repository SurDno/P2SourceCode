...
namespace SteamNative
{
  ...
  internal struct DlcInstalled_t
  {
    ...
    {
      return Platform.PackSmall ? (PackSmall) Marshal.PtrToStructure(p, typeof (PackSmall)) : (DlcInstalled_t) Marshal.PtrToStructure(p, typeof (DlcInstalled_t));
    }
      ...
      Action<DlcInstalled_t, bool> CallbackFunction)
    {
      ...
      if (Config.UseThisCall)
      {
        ...
        Callback.ThisCall.GetSize d3 = _ => Marshal.SizeOf(typeof (DlcInstalled_t));
      ...
      else
      {
        ...
        Callback.StdCall.GetSize d6 = () => Marshal.SizeOf(typeof (DlcInstalled_t));
        if (Platform.PackSmall)
    ...
    internal struct PackSmall
    {
      ...
      public static implicit operator DlcInstalled_t(PackSmall d)
      {
