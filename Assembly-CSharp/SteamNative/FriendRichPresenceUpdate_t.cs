...
namespace SteamNative
{
  ...
  internal struct FriendRichPresenceUpdate_t
  {
    ...
    {
      return Platform.PackSmall ? (PackSmall) Marshal.PtrToStructure(p, typeof (PackSmall)) : (FriendRichPresenceUpdate_t) Marshal.PtrToStructure(p, typeof (FriendRichPresenceUpdate_t));
    }
      ...
      Action<FriendRichPresenceUpdate_t, bool> CallbackFunction)
    {
      ...
      if (Config.UseThisCall)
      {
        ...
        Callback.ThisCall.GetSize d3 = _ => Marshal.SizeOf(typeof (FriendRichPresenceUpdate_t));
      ...
      else
      {
        ...
        Callback.StdCall.GetSize d6 = () => Marshal.SizeOf(typeof (FriendRichPresenceUpdate_t));
        if (Platform.PackSmall)
