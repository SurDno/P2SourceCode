...
namespace SteamNative
{
  ...
  internal struct PSNGameBootInviteResult_t
  {
    ...
    {
      return Platform.PackSmall ? (PackSmall) Marshal.PtrToStructure(p, typeof (PackSmall)) : (PSNGameBootInviteResult_t) Marshal.PtrToStructure(p, typeof (PSNGameBootInviteResult_t));
    }
      ...
      Action<PSNGameBootInviteResult_t, bool> CallbackFunction)
    {
      ...
      if (Config.UseThisCall)
      {
        ...
        Callback.ThisCall.GetSize d3 = _ => Marshal.SizeOf(typeof (PSNGameBootInviteResult_t));
      ...
      else
      {
        ...
        Callback.StdCall.GetSize d6 = () => Marshal.SizeOf(typeof (PSNGameBootInviteResult_t));
        if (Platform.PackSmall)
