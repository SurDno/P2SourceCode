...
namespace SteamNative
{
  ...
  internal struct MusicPlayerWantsPlayingRepeatStatus_t
  {
    ...
    {
      return Platform.PackSmall ? (PackSmall) Marshal.PtrToStructure(p, typeof (PackSmall)) : (MusicPlayerWantsPlayingRepeatStatus_t) Marshal.PtrToStructure(p, typeof (MusicPlayerWantsPlayingRepeatStatus_t));
    }
      ...
      Action<MusicPlayerWantsPlayingRepeatStatus_t, bool> CallbackFunction)
    {
      ...
      if (Config.UseThisCall)
      {
        ...
        Callback.ThisCall.GetSize d3 = _ => Marshal.SizeOf(typeof (MusicPlayerWantsPlayingRepeatStatus_t));
      ...
      else
      {
        ...
        Callback.StdCall.GetSize d6 = () => Marshal.SizeOf(typeof (MusicPlayerWantsPlayingRepeatStatus_t));
        if (Platform.PackSmall)
