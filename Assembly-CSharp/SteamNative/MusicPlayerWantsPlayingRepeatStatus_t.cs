...
// Type: SteamNative.MusicPlayerWantsPlayingRepeatStatus_t
...
namespace SteamNative
{
  ...
  {
    public const int CallbackId = 4114;
    public int PlayingRepeatStatus;

    public static MusicPlayerWantsPlayingRepeatStatus_t FromPointer(IntPtr p)
    {
      return Platform.PackSmall ? (MusicPlayerWantsPlayingRepeatStatus_t) (MusicPlayerWantsPlayingRepeatStatus_t.PackSmall) Marshal.PtrToStructure(p, typeof (MusicPlayerWantsPlayingRepeatStatus_t.PackSmall)) : (MusicPlayerWantsPlayingRepeatStatus_t) Marshal.PtrToStructure(p, typeof (MusicPlayerWantsPlayingRepeatStatus_t));
    }

    public static void RegisterCallback(
      BaseSteamworks steamworks,
      Action<MusicPlayerWantsPlayingRepeatStatus_t, bool> CallbackFunction)
    {
      CallbackHandle handle = new CallbackHandle();
      handle.steamworks = steamworks;
      if (Config.UseThisCall)
      {
        Callback.ThisCall.Result d1 = (Callback.ThisCall.Result) ((_, p) => CallbackFunction(MusicPlayerWantsPlayingRepeatStatus_t.FromPointer(p), false));
        Callback.ThisCall.ResultWithInfo d2 = (Callback.ThisCall.ResultWithInfo) ((_, p, bIOFailure, hSteamAPICall) => CallbackFunction(MusicPlayerWantsPlayingRepeatStatus_t.FromPointer(p), bIOFailure));
        Callback.ThisCall.GetSize d3 = (Callback.ThisCall.GetSize) (_ => Marshal.SizeOf(typeof (MusicPlayerWantsPlayingRepeatStatus_t)));
        if (Platform.PackSmall)
          d3 = (Callback.ThisCall.GetSize) (_ => Marshal.SizeOf(typeof (MusicPlayerWantsPlayingRepeatStatus_t.PackSmall)));
      ...
      {
        Callback.StdCall.Result d4 = (Callback.StdCall.Result) (p => CallbackFunction(MusicPlayerWantsPlayingRepeatStatus_t.FromPointer(p), false));
        Callback.StdCall.ResultWithInfo d5 = (Callback.StdCall.ResultWithInfo) ((p, bIOFailure, hSteamAPICall) => CallbackFunction(MusicPlayerWantsPlayingRepeatStatus_t.FromPointer(p), bIOFailure));
        Callback.StdCall.GetSize d6 = (Callback.StdCall.GetSize) (() => Marshal.SizeOf(typeof (MusicPlayerWantsPlayingRepeatStatus_t)));
        if (Platform.PackSmall)
          d6 = (Callback.StdCall.GetSize) (() => Marshal.SizeOf(typeof (MusicPlayerWantsPlayingRepeatStatus_t.PackSmall)));
      ...
      steamworks.native.api.SteamAPI_RegisterCallback(handle.PinnedCallback.AddrOfPinnedObject(), 4114);
    ...
    internal struct PackSmall
    {
      ...
      public static implicit operator MusicPlayerWantsPlayingRepeatStatus_t(
        MusicPlayerWantsPlayingRepeatStatus_t.PackSmall d)
      {
