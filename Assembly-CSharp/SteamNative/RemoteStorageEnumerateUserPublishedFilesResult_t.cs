...
namespace SteamNative
{
  ...
  internal struct RemoteStorageEnumerateUserPublishedFilesResult_t
  {
    ...
    {
      return Platform.PackSmall ? (PackSmall) Marshal.PtrToStructure(p, typeof (PackSmall)) : (RemoteStorageEnumerateUserPublishedFilesResult_t) Marshal.PtrToStructure(p, typeof (RemoteStorageEnumerateUserPublishedFilesResult_t));
    }
      ...
      Action<RemoteStorageEnumerateUserPublishedFilesResult_t, bool> CallbackFunction)
    {
      ...
      if (Config.UseThisCall)
      {
        ...
        Callback.ThisCall.GetSize d3 = _ => Marshal.SizeOf(typeof (RemoteStorageEnumerateUserPublishedFilesResult_t));
      ...
      else
      {
        ...
        Callback.StdCall.GetSize d6 = () => Marshal.SizeOf(typeof (RemoteStorageEnumerateUserPublishedFilesResult_t));
        if (Platform.PackSmall)
