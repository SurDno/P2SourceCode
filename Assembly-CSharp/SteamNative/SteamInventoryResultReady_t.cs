...
namespace SteamNative
{
  ...
  internal struct SteamInventoryResultReady_t
  {
    ...
    {
      return Platform.PackSmall ? (PackSmall) Marshal.PtrToStructure(p, typeof (PackSmall)) : (SteamInventoryResultReady_t) Marshal.PtrToStructure(p, typeof (SteamInventoryResultReady_t));
    }
      ...
      Action<SteamInventoryResultReady_t, bool> CallbackFunction)
    {
      ...
      if (Config.UseThisCall)
      {
        ...
        Callback.ThisCall.GetSize d3 = _ => Marshal.SizeOf(typeof (SteamInventoryResultReady_t));
      ...
      else
      {
        ...
        Callback.StdCall.GetSize d6 = () => Marshal.SizeOf(typeof (SteamInventoryResultReady_t));
        if (Platform.PackSmall)
