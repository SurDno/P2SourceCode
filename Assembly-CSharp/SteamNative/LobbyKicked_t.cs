...
namespace SteamNative
{
  ...
  internal struct LobbyKicked_t
  {
    ...
    {
      return Platform.PackSmall ? (PackSmall) Marshal.PtrToStructure(p, typeof (PackSmall)) : (LobbyKicked_t) Marshal.PtrToStructure(p, typeof (LobbyKicked_t));
    }
      ...
      Action<LobbyKicked_t, bool> CallbackFunction)
    {
      ...
      if (Config.UseThisCall)
      {
        ...
        Callback.ThisCall.GetSize d3 = _ => Marshal.SizeOf(typeof (LobbyKicked_t));
      ...
      else
      {
        ...
        Callback.StdCall.GetSize d6 = () => Marshal.SizeOf(typeof (LobbyKicked_t));
        if (Platform.PackSmall)
    ...
    internal struct PackSmall
    {
      ...
      public static implicit operator LobbyKicked_t(PackSmall d)
      {
