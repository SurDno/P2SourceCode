...
namespace SteamNative
{
  ...
  internal struct HTML_SetCursor_t
  {
    ...
    {
      return Platform.PackSmall ? (PackSmall) Marshal.PtrToStructure(p, typeof (PackSmall)) : (HTML_SetCursor_t) Marshal.PtrToStructure(p, typeof (HTML_SetCursor_t));
    }
      ...
      Action<HTML_SetCursor_t, bool> CallbackFunction)
    {
      ...
      if (Config.UseThisCall)
      {
        ...
        Callback.ThisCall.GetSize d3 = _ => Marshal.SizeOf(typeof (HTML_SetCursor_t));
      ...
      else
      {
        ...
        Callback.StdCall.GetSize d6 = () => Marshal.SizeOf(typeof (HTML_SetCursor_t));
        if (Platform.PackSmall)
    ...
    internal struct PackSmall
    {
      ...
      public static implicit operator HTML_SetCursor_t(PackSmall d)
      {
