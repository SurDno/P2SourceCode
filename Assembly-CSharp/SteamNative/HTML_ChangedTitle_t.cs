...
namespace SteamNative
{
  ...
  internal struct HTML_ChangedTitle_t
  {
    ...
    {
      return Platform.PackSmall ? (PackSmall) Marshal.PtrToStructure(p, typeof (PackSmall)) : (HTML_ChangedTitle_t) Marshal.PtrToStructure(p, typeof (HTML_ChangedTitle_t));
    }
      ...
      Action<HTML_ChangedTitle_t, bool> CallbackFunction)
    {
      ...
      if (Config.UseThisCall)
      {
        ...
        Callback.ThisCall.GetSize d3 = _ => Marshal.SizeOf(typeof (HTML_ChangedTitle_t));
      ...
      else
      {
        ...
        Callback.StdCall.GetSize d6 = () => Marshal.SizeOf(typeof (HTML_ChangedTitle_t));
        if (Platform.PackSmall)
    ...
    internal struct PackSmall
    {
      ...
      public static implicit operator HTML_ChangedTitle_t(PackSmall d)
      {
