...
namespace SteamNative
{
  ...
  internal struct HTML_OpenLinkInNewTab_t
  {
    ...
    {
      return Platform.PackSmall ? (PackSmall) Marshal.PtrToStructure(p, typeof (PackSmall)) : (HTML_OpenLinkInNewTab_t) Marshal.PtrToStructure(p, typeof (HTML_OpenLinkInNewTab_t));
    }
      ...
      Action<HTML_OpenLinkInNewTab_t, bool> CallbackFunction)
    {
      ...
      if (Config.UseThisCall)
      {
        ...
        Callback.ThisCall.GetSize d3 = _ => Marshal.SizeOf(typeof (HTML_OpenLinkInNewTab_t));
      ...
      else
      {
        ...
        Callback.StdCall.GetSize d6 = () => Marshal.SizeOf(typeof (HTML_OpenLinkInNewTab_t));
        if (Platform.PackSmall)
    ...
    internal struct PackSmall
    {
      ...
      public static implicit operator HTML_OpenLinkInNewTab_t(PackSmall d)
      {
