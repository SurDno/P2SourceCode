...
namespace SteamNative
{
  ...
  internal struct UserStatsReceived_t
  {
    ...
    {
      return Platform.PackSmall ? (PackSmall) Marshal.PtrToStructure(p, typeof (PackSmall)) : (UserStatsReceived_t) Marshal.PtrToStructure(p, typeof (UserStatsReceived_t));
    }
      ...
      Action<UserStatsReceived_t, bool> CallbackFunction)
    {
      ...
      if (Config.UseThisCall)
      {
        ...
        Callback.ThisCall.GetSize d3 = _ => Marshal.SizeOf(typeof (UserStatsReceived_t));
      ...
      else
      {
        ...
        Callback.StdCall.GetSize d6 = () => Marshal.SizeOf(typeof (UserStatsReceived_t));
        if (Platform.PackSmall)
    ...
    internal struct PackSmall
    {
      ...
      public static implicit operator UserStatsReceived_t(PackSmall d)
      {
