...
namespace SteamNative
{
  internal class SteamUGC : IDisposable
  {
      ...
      Action<AddUGCDependencyResult_t, bool> CallbackFunction = null)
    {
      ...
      SteamAPICall_t call = platform.ISteamUGC_AddDependency(nParentPublishedFileID.Value, nChildPublishedFileID.Value);
      return CallbackFunction == null ? null : AddUGCDependencyResult_t.CallResult(steamworks, call, CallbackFunction);
    }
    ...
    {
      SteamAPICall_t steamApiCallT = 0UL;
      SteamAPICall_t favorites = platform.ISteamUGC_AddItemToFavorites(nAppId.Value, nPublishedFileID.Value);
      return CallbackFunction == null ? null : UserFavoriteItemsListChanged_t.CallResult(steamworks, favorites, CallbackFunction);
    }
    ...
    {
      SteamAPICall_t steamApiCallT = 0UL;
      SteamAPICall_t call = platform.ISteamUGC_CreateItem(nConsumerAppId.Value, eFileType);
      ...
      out uint punTimeStamp)
    {
      ...
      bool itemInstallInfo = platform.ISteamUGC_GetItemInstallInfo(nPublishedFileID.Value, out punSizeOnDisk, stringBuilder, cchFolderSize, out punTimeStamp);
      if (!itemInstallInfo)
    ...
    public uint GetNumSubscribedItems() => platform.ISteamUGC_GetNumSubscribedItems();
      ...
      out ItemPreviewType pPreviewType)
    {
      ...
      bool additionalPreview = platform.ISteamUGC_GetQueryUGCAdditionalPreview(handle.Value, index, previewIndex, stringBuilder1, cchURLSize, stringBuilder2, cchOriginalFileNameSize, out pPreviewType);
      ...
      out string pchValue)
    {
      ...
      bool queryUgcKeyValueTag = platform.ISteamUGC_GetQueryUGCKeyValueTag(handle.Value, index, keyValueTagIndex, stringBuilder1, cchKeySize, stringBuilder2, cchValueSize);
    ...
    public bool GetQueryUGCMetadata(UGCQueryHandle_t handle, uint index, out string pchMetadata)
    {
      ...
      bool queryUgcMetadata = platform.ISteamUGC_GetQueryUGCMetadata(handle.Value, index, stringBuilder, cchMetadatasize);
      if (!queryUgcMetadata)
    ...
    public bool GetQueryUGCPreviewURL(UGCQueryHandle_t handle, uint index, out string pchURL)
    {
      ...
      StringBuilder stringBuilder = Helpers.TakeStringBuilder();
      uint cchURLSize = 4096;
      bool queryUgcPreviewUrl = platform.ISteamUGC_GetQueryUGCPreviewURL(handle.Value, index, stringBuilder, cchURLSize);
    ...
    {
      SteamAPICall_t steamApiCallT = 0UL;
      SteamAPICall_t userItemVote = platform.ISteamUGC_GetUserItemVote(nPublishedFileID.Value);
      return CallbackFunction == null ? null : GetUserItemVoteResult_t.CallResult(steamworks, userItemVote, CallbackFunction);
    }
    ...
    {
      SteamAPICall_t steamApiCallT = 0UL;
      SteamAPICall_t call = platform.ISteamUGC_RemoveDependency(nParentPublishedFileID.Value, nChildPublishedFileID.Value);
      return CallbackFunction == null ? null : RemoveUGCDependencyResult_t.CallResult(steamworks, call, CallbackFunction);
    }
    ...
    {
      SteamAPICall_t steamApiCallT = 0UL;
      SteamAPICall_t call = platform.ISteamUGC_RemoveItemFromFavorites(nAppId.Value, nPublishedFileID.Value);
      return CallbackFunction == null ? null : UserFavoriteItemsListChanged_t.CallResult(steamworks, call, CallbackFunction);
    }
    ...
    {
      SteamAPICall_t steamApiCallT = 0UL;
      SteamAPICall_t call = platform.ISteamUGC_SendQueryUGCRequest(handle.Value);
      return CallbackFunction == null ? null : SteamUGCQueryCompleted_t.CallResult(steamworks, call, CallbackFunction);
    }
    ...
    {
      SteamAPICall_t steamApiCallT = 0UL;
      SteamAPICall_t call = platform.ISteamUGC_SetUserItemVote(nPublishedFileID.Value, bVoteUp);
      ...
      Action<StartPlaytimeTrackingResult_t, bool> CallbackFunction = null)
    {
      ...
      return CallbackFunction == null ? null : StartPlaytimeTrackingResult_t.CallResult(steamworks, call, CallbackFunction);
    }
      ...
      Action<StopPlaytimeTrackingResult_t, bool> CallbackFunction = null)
    {
      ...
      return CallbackFunction == null ? null : StopPlaytimeTrackingResult_t.CallResult(steamworks, call, CallbackFunction);
    }
    ...
    {
      SteamAPICall_t steamApiCallT = 0UL;
      SteamAPICall_t call = platform.ISteamUGC_StopPlaytimeTrackingForAllItems();
      return CallbackFunction == null ? null : StopPlaytimeTrackingResult_t.CallResult(steamworks, call, CallbackFunction);
    }
    ...
    {
      SteamAPICall_t steamApiCallT = 0UL;
      SteamAPICall_t call = platform.ISteamUGC_SubmitItemUpdate(handle.Value, pchChangeNote);
      return CallbackFunction == null ? null : SubmitItemUpdateResult_t.CallResult(steamworks, call, CallbackFunction);
    }
    ...
    {
      SteamAPICall_t steamApiCallT = 0UL;
      SteamAPICall_t call = platform.ISteamUGC_SubscribeItem(nPublishedFileID.Value);
    ...
    {
      SteamAPICall_t steamApiCallT = 0UL;
      SteamAPICall_t call = platform.ISteamUGC_UnsubscribeItem(nPublishedFileID.Value);
