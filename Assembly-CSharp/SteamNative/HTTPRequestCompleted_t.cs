...
namespace SteamNative
{
  ...
  internal struct HTTPRequestCompleted_t
  {
    ...
    {
      return Platform.PackSmall ? (PackSmall) Marshal.PtrToStructure(p, typeof (PackSmall)) : (HTTPRequestCompleted_t) Marshal.PtrToStructure(p, typeof (HTTPRequestCompleted_t));
    }
      ...
      Action<HTTPRequestCompleted_t, bool> CallbackFunction)
    {
      ...
      if (Config.UseThisCall)
      {
        ...
        Callback.ThisCall.GetSize d3 = _ => Marshal.SizeOf(typeof (HTTPRequestCompleted_t));
      ...
      else
      {
        ...
        Callback.StdCall.GetSize d6 = () => Marshal.SizeOf(typeof (HTTPRequestCompleted_t));
        if (Platform.PackSmall)
    ...
    internal struct PackSmall
    {
      ...
      public static implicit operator HTTPRequestCompleted_t(PackSmall d)
      {
