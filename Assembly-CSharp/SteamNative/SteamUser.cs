...
namespace SteamNative
{
  internal class SteamUser : IDisposable
  {
    ...
    public bool BIsBehindNAT() => platform.ISteamUser_BIsBehindNAT();

    public bool BIsPhoneIdentifying() => platform.ISteamUser_BIsPhoneIdentifying();
    ...
    public bool BIsPhoneVerified() => platform.ISteamUser_BIsPhoneVerified();

    public bool BIsTwoFactorEnabled() => platform.ISteamUser_BIsTwoFactorEnabled();

    public bool BLoggedOn() => platform.ISteamUser_BLoggedOn();
    ...
    {
      return platform.ISteamUser_DecompressVoice(pCompressed, cbCompressed, pDestBuffer, cbDestBufferSize, out nBytesWritten, nDesiredSampleRate);
    }
    ...
    public HSteamUser GetHSteamUser() => platform.ISteamUser_GetHSteamUser();

    public int GetPlayerSteamLevel() => platform.ISteamUser_GetPlayerSteamLevel();

    public ulong GetSteamID() => (ulong) platform.ISteamUser_GetSteamID();
    ...
    public VoiceResult GetVoice(
      ...
      uint nUncompressedVoiceDesiredSampleRate_Deprecated)
    {
      return platform.ISteamUser_GetVoice(bWantCompressed, pDestBuffer, cbDestBufferSize, out nBytesWritten, bWantUncompressed_Deprecated, pUncompressedDestBuffer_Deprecated, cbUncompressedDestBufferSize_Deprecated, out nUncompressBytesWritten_Deprecated, nUncompressedVoiceDesiredSampleRate_Deprecated);
    }

    public uint GetVoiceOptimalSampleRate() => platform.ISteamUser_GetVoiceOptimalSampleRate();
    ...
    public int InitiateGameConnection(
      ...
      bool bSecure)
    {
      return platform.ISteamUser_InitiateGameConnection(pAuthBlob, cbMaxAuthBlob, steamIDGameServer.Value, unIPServer, usPortServer, bSecure);
    }
      ...
      Action<EncryptedAppTicketResponse_t, bool> CallbackFunction = null)
    {
      ...
      SteamAPICall_t call = platform.ISteamUser_RequestEncryptedAppTicket(pDataToInclude, cbDataToInclude);
      return CallbackFunction == null ? null : EncryptedAppTicketResponse_t.CallResult(steamworks, call, CallbackFunction);
    }
    ...
    {
      SteamAPICall_t steamApiCallT = 0UL;
      SteamAPICall_t call = platform.ISteamUser_RequestStoreAuthURL(pchRedirectURL);
      return CallbackFunction == null ? null : StoreAuthURLResponse_t.CallResult(steamworks, call, CallbackFunction);
    }

    public void StartVoiceRecording() => platform.ISteamUser_StartVoiceRecording();

    public void StopVoiceRecording() => platform.ISteamUser_StopVoiceRecording();
