...
internal class SteamRemoteStorage : IDisposable {
	...
	public CallbackHandle CommitPublishedFileUpdate(
		...
		var call = platform.ISteamRemoteStorage_CommitPublishedFileUpdate(updateHandle.Value);
		return CallbackFunction == null
			? null
			: RemoteStorageUpdatePublishedFileResult_t.CallResult(steamworks, call, CallbackFunction);
	}
	...
	public CallbackHandle DeletePublishedFile(
		...
		SteamAPICall_t steamApiCallT = 0UL;
		var call = platform.ISteamRemoteStorage_DeletePublishedFile(unPublishedFileId.Value);
		return CallbackFunction == null
			? null
			: RemoteStorageDeletePublishedFileResult_t.CallResult(steamworks, call, CallbackFunction);
	}
	...
	public CallbackHandle EnumeratePublishedFilesByUserAction(
		...
		SteamAPICall_t steamApiCallT = 0UL;
		var call = platform.ISteamRemoteStorage_EnumeratePublishedFilesByUserAction(eAction, unStartIndex);
		return CallbackFunction == null
			? null
			: RemoteStorageEnumeratePublishedFilesByUserActionResult_t.CallResult(steamworks, call, CallbackFunction);
	}
	...
	public CallbackHandle EnumeratePublishedWorkshopFiles(
		...
		try {
			...
			var steamParamStringArrayT = new SteamParamStringArray_t {
				Strings = destination,
				NumStrings = pTags.Length
			};
			call = platform.ISteamRemoteStorage_EnumeratePublishedWorkshopFiles(eEnumerationType, unStartIndex, unCount,
				unDays, ref steamParamStringArrayT, ref pUserTags);
		} finally {
		...
		return CallbackFunction == null
			? null
			: RemoteStorageEnumerateWorkshopFilesResult_t.CallResult(steamworks, call, CallbackFunction);
	}
	...
	public CallbackHandle EnumerateUserPublishedFiles(
		...
		SteamAPICall_t steamApiCallT = 0UL;
		var call = platform.ISteamRemoteStorage_EnumerateUserPublishedFiles(unStartIndex);
		return CallbackFunction == null
			? null
			: RemoteStorageEnumerateUserPublishedFilesResult_t.CallResult(steamworks, call, CallbackFunction);
	}
	...
	public CallbackHandle EnumerateUserSharedWorkshopFiles(
		...
		Action<RemoteStorageEnumerateUserPublishedFilesResult_t, bool> CallbackFunction = null) {
		SteamAPICall_t call = 0UL;
		var source = new IntPtr[pRequiredTags.Length];
		for (var index = 0; index < pRequiredTags.Length; ++index)
		...
		try {
			...
			call = platform.ISteamRemoteStorage_EnumerateUserSharedWorkshopFiles(steamId.Value, unStartIndex,
				ref steamParamStringArrayT, ref pExcludedTags);
		} finally {
			foreach (var hglobal in source)
				Marshal.FreeHGlobal(hglobal);
		}
	...
	public CallbackHandle EnumerateUserSubscribedFiles(
		...
		SteamAPICall_t steamApiCallT = 0UL;
		var call = platform.ISteamRemoteStorage_EnumerateUserSubscribedFiles(unStartIndex);
		return CallbackFunction == null
			? null
			: RemoteStorageEnumerateUserSubscribedFilesResult_t.CallResult(steamworks, call, CallbackFunction);
	}
	...
	public CallbackHandle FileReadAsync(
		...
		SteamAPICall_t steamApiCallT = 0UL;
		var call = platform.ISteamRemoteStorage_FileReadAsync(pchFile, nOffset, cubToRead);
		return CallbackFunction == null
			? null
			: RemoteStorageFileReadAsyncComplete_t.CallResult(steamworks, call, CallbackFunction);
	}
	...
	public CallbackHandle FileShare(
		...
		SteamAPICall_t steamApiCallT = 0UL;
		var call = platform.ISteamRemoteStorage_FileShare(pchFile);
		return CallbackFunction == null
			? null
			: RemoteStorageFileShareResult_t.CallResult(steamworks, call, CallbackFunction);
	}
	...
	public CallbackHandle FileWriteAsync(
		...
		SteamAPICall_t steamApiCallT = 0UL;
		var call = platform.ISteamRemoteStorage_FileWriteAsync(pchFile, pvData, cubData);
		return CallbackFunction == null
			? null
			: RemoteStorageFileWriteAsyncComplete_t.CallResult(steamworks, call, CallbackFunction);
	}
	...
	public CallbackHandle GetPublishedFileDetails(
		...
		SteamAPICall_t steamApiCallT = 0UL;
		var publishedFileDetails =
			platform.ISteamRemoteStorage_GetPublishedFileDetails(unPublishedFileId.Value, unMaxSecondsOld);
		return CallbackFunction == null
			? null
			: RemoteStorageGetPublishedFileDetailsResult_t.CallResult(steamworks, publishedFileDetails,
				CallbackFunction);
	}
	...
	public CallbackHandle GetPublishedItemVoteDetails(
		...
		SteamAPICall_t steamApiCallT = 0UL;
		var publishedItemVoteDetails =
			platform.ISteamRemoteStorage_GetPublishedItemVoteDetails(unPublishedFileId.Value);
		return CallbackFunction == null
			? null
			: RemoteStorageGetPublishedItemVoteDetailsResult_t.CallResult(steamworks, publishedItemVoteDetails,
				CallbackFunction);
	}
	...
	public bool GetUGCDetails(
		...
		var pnFileSizeInBytes = 4096;
		var ugcDetails = platform.ISteamRemoteStorage_GetUGCDetails(hContent.Value, ref pnAppID.Value, stringBuilder,
			out pnFileSizeInBytes, out pSteamIDOwner.Value);
		if (!ugcDetails)
			return ugcDetails;
	...
	public bool GetUGCDownloadProgress(
		...
		return platform.ISteamRemoteStorage_GetUGCDownloadProgress(hContent.Value, out pnBytesDownloaded,
			out pnBytesExpected);
	}
	...
	public CallbackHandle GetUserPublishedItemVoteDetails(
		...
		SteamAPICall_t steamApiCallT = 0UL;
		var publishedItemVoteDetails =
			platform.ISteamRemoteStorage_GetUserPublishedItemVoteDetails(unPublishedFileId.Value);
		return CallbackFunction == null
			? null
			: RemoteStorageGetPublishedItemVoteDetailsResult_t.CallResult(steamworks, publishedItemVoteDetails,
				CallbackFunction);
	...
	public CallbackHandle PublishVideo(
		...
		try {
			...
			call = platform.ISteamRemoteStorage_PublishVideo(eVideoProvider, pchVideoAccount, pchVideoIdentifier,
				pchPreviewFile, nConsumerAppId.Value, pchTitle, pchDescription, eVisibility,
				ref steamParamStringArrayT);
		} finally {
			foreach (var hglobal in source)
				Marshal.FreeHGlobal(hglobal);
		}
		...
		return CallbackFunction == null
			? null
			: RemoteStoragePublishFileProgress_t.CallResult(steamworks, call, CallbackFunction);
	}
	...
	public CallbackHandle PublishWorkshopFile(
		...
		try {
			...
			call = platform.ISteamRemoteStorage_PublishWorkshopFile(pchFile, pchPreviewFile, nConsumerAppId.Value,
				pchTitle, pchDescription, eVisibility, ref steamParamStringArrayT, eWorkshopFileType);
		} finally {
			foreach (var hglobal in source)
				Marshal.FreeHGlobal(hglobal);
		}
	...
	public CallbackHandle SetUserPublishedFileAction(
		...
		SteamAPICall_t steamApiCallT = 0UL;
		var call = platform.ISteamRemoteStorage_SetUserPublishedFileAction(unPublishedFileId.Value, eAction);
		return CallbackFunction == null
			? null
			: RemoteStorageSetUserPublishedFileActionResult_t.CallResult(steamworks, call, CallbackFunction);
	}
	...
	public CallbackHandle SubscribePublishedFile(
		...
		SteamAPICall_t steamApiCallT = 0UL;
		var call = platform.ISteamRemoteStorage_SubscribePublishedFile(unPublishedFileId.Value);
		return CallbackFunction == null
			? null
	...
	public CallbackHandle UGCDownload(
		...
		SteamAPICall_t steamApiCallT = 0UL;
		var call = platform.ISteamRemoteStorage_UGCDownload(hContent.Value, unPriority);
		return CallbackFunction == null
			? null
			: RemoteStorageDownloadUGCResult_t.CallResult(steamworks, call, CallbackFunction);
	}
	...
	public CallbackHandle UGCDownloadToLocation(
		...
		Action<RemoteStorageDownloadUGCResult_t, bool> CallbackFunction = null) {
		SteamAPICall_t steamApiCallT = 0UL;
		var location = platform.ISteamRemoteStorage_UGCDownloadToLocation(hContent.Value, pchLocation, unPriority);
		return CallbackFunction == null
			? null
			: RemoteStorageDownloadUGCResult_t.CallResult(steamworks, location, CallbackFunction);
	}
	...
	public CallbackHandle UnsubscribePublishedFile(
		...
		SteamAPICall_t steamApiCallT = 0UL;
		var call = platform.ISteamRemoteStorage_UnsubscribePublishedFile(unPublishedFileId.Value);
		return CallbackFunction == null
			? null
	...
	public bool UpdatePublishedFileSetChangeDescription(
		...
		return platform.ISteamRemoteStorage_UpdatePublishedFileSetChangeDescription(updateHandle.Value,
	...
	public CallbackHandle UpdateUserPublishedItemVote(
		...
		SteamAPICall_t steamApiCallT = 0UL;
		var call = platform.ISteamRemoteStorage_UpdateUserPublishedItemVote(unPublishedFileId.Value, bVoteUp);
		return CallbackFunction == null
			? null
			: RemoteStorageUpdateUserPublishedItemVoteResult_t.CallResult(steamworks, call, CallbackFunction);
	}
}