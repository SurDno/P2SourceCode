...
public class POIBench : POIBase {
	...
	private void GetClosestSurfacePoint(
		...
		var vector3_1 = transform.position - transform.right * Width / 2f + Vector3.up * Height;
		var vector3_2 = transform.position + transform.right * Width / 2f + Vector3.up * Height;
