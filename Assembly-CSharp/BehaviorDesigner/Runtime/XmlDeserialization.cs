...
public static class XmlDeserialization {
	public static void LoadXml(
		...
		try {
			var behaviorSourceData = DefaultDataReadUtility.ReadSerialize<BehaviorSourceData>(
				new XmlNodeDataReader(XmlDeserializationCache.GetOrCreateData(taskData.XmlData), context), "Object");
