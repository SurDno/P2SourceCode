...
public class FightParameterQuickBlock : Action, IStub, ISerializeDataWrite, ISerializeDataRead {
	[Tooltip("Вероятность (0-1) заблокировать удар")] [DataReadProxy] [DataWriteProxy] [CopyableProxy] [SerializeField]
	...
	public void DataRead(IDataReader reader, Type type) {
		...
		QuickBlockProbability =
			BehaviorTreeDataReadUtility.ReadShared(reader, "QuickBlockProbability", QuickBlockProbability);
