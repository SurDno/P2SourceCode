...
public class POISequenceGroupAnswer : POISequence, IStub, ISerializeDataWrite, ISerializeDataRead {
	...
	public override void OnStart() {
		OutPOI = null;
		var component1 = gameObject.GetComponent<POISetup>();
		if (component1 == null)
			...
			if (CallingPOI.Value == null)
				return;
			var component2 = CallingPOI.Value.GetComponent<POIBase>();
			var poiAnimationEnum = component2.SupportedAnimations & component1.SupportedAnimations;
			var num1 = Random.Range(0, 32);
			for (var index = 0; index < 32; ++index) {
				var num2 = (num1 + index) % 32;
				if ((poiAnimationEnum & (POIAnimationEnum)(1 << num2)) != 0) {
					var animation = (POIAnimationEnum)(1 << num2);
					var animationSetup = component1.GetAnimationSetup(animation);
					...
					component2.GetRandomTargetPoint(animation, OutAnimationIndex, component1, out targetPosition,
						out targetRotation);
					OutPOI = component2;
