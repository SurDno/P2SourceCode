...
public class RunBlueprint : Action, IStub, ISerializeDataWrite, ISerializeDataRead {
	[Tooltip("Сколько ждать секунд (0 - бесконечно)")] [DataReadProxy] [DataWriteProxy] [CopyableProxy] [SerializeField]
	...
	public override TaskStatus OnUpdate() {
		...
		return waitDuration != 0.0 && startTime + (double)waitDuration < Time.time
			? TaskStatus.Success
			: TaskStatus.Running;
	}
