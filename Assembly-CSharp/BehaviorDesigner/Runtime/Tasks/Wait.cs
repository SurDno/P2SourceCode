...
public class Wait : Action, IStub, ISerializeDataWrite, ISerializeDataRead {
	[Tooltip("The amount of time to wait")] [DataReadProxy] [DataWriteProxy] [CopyableProxy] [SerializeField]
	public SharedFloat waitTime = 1f;

	[Tooltip("Should the wait be randomized?")] [DataReadProxy] [DataWriteProxy] [CopyableProxy] [SerializeField]
