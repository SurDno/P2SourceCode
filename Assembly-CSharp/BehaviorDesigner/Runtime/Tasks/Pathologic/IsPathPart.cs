...
// Type: BehaviorDesigner.Runtime.Tasks.Pathologic.IsPathPart
  ...
  public class IsPathPart : Conditional, IStub, ISerializeDataWrite, ISerializeDataRead
  {
    ...
    public override void OnStart()
    {
      ...
      if (!(bool) (UnityEngine.Object) this.Target.Value)
        return;
      if ((UnityEngine.Object) this.Target.Value.GetComponent<PathPart>() != (UnityEngine.Object) null)
        this.success = true;
      else
        Debug.LogError((object) (this.gameObject.name + " has wrong path object! Needs PathPart script"));
    }
