...
public class RunDialog : Action, IStub, ISerializeDataWrite, ISerializeDataRead {
	...
	[Tooltip("Interact blueprint prefab")] [DataReadProxy] [DataWriteProxy] [CopyableProxy()] [SerializeField]
	...
	public override void OnStart() {
		failed = false;
		var blueprintPrefab = blueprint.Value;
	...
	public override TaskStatus OnUpdate() {
		...
		return !PlayerUtility.IsPlayerCanControlling
			? EndOnFailure.Value ? TaskStatus.Failure : TaskStatus.Running
			: TaskStatus.Success;
	}
