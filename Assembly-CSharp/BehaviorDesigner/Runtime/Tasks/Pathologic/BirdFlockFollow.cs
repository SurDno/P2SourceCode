...
namespace BehaviorDesigner.Runtime.Tasks.Pathologic
{
  ...
  public class BirdFlockFollow : Action, IStub, ISerializeDataWrite, ISerializeDataRead
  {
    ...
    [Tooltip("Adds to target position")]
    [DataReadProxy]
    [DataWriteProxy]
    [CopyableProxy()]
    [SerializeField]
    ...
    public override TaskStatus OnUpdate()
    {
      if ((UnityEngine.Object) behavior == (UnityEngine.Object) null)
      {
        ...
        if ((UnityEngine.Object) behavior == (UnityEngine.Object) null)
        {
          Debug.LogWarning((object) (gameObject.name + ": doesn't contain Behavior unity component"), (UnityEngine.Object) gameObject);
          return TaskStatus.Failure;
        }
      }
      if ((UnityEngine.Object) Target.Value == (UnityEngine.Object) null)
        return TaskStatus.Failure;
      Vector3 direction = Offset.Value + Target.Value.transform.position - gameObject.transform.position;
