...
namespace BehaviorDesigner.Runtime.Tasks.Pathologic
{
  ...
  public class FollowTeleport : Action, IStub, ISerializeDataWrite, ISerializeDataRead
  {
    ...
    {
      if ((UnityEngine.Object) npcState == (UnityEngine.Object) null || npcState.CurrentNpcState != NpcStateEnum.MoveFollowTeleport)
    ...
    public void DataRead(IDataReader reader, Type type)
    {
      ...
      WaitForPlayerFacesYou = BehaviorTreeDataReadUtility.ReadShared(reader, "WaitForPlayerFacesYou", WaitForPlayerFacesYou);
    }
  }
}
