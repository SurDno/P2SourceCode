...
// Type: BehaviorDesigner.Runtime.Tasks.Pathologic.RotateAt
...
namespace BehaviorDesigner.Runtime.Tasks.Pathologic
{
  ...
  public class RotateAt : BehaviorDesigner.Runtime.Tasks.Action, IStub, ISerializeDataWrite, ISerializeDataRead
  {
    ...
    public override void OnStart()
    {
      ...
      if ((UnityEngine.Object) this.Target.Value == (UnityEngine.Object) null)
        Debug.LogWarningFormat("{0}: RotateAtOn with null target", (object) this.gameObject.name);
      else
        this.npcState.Rotate(this.Target.Value);
    }

    public override TaskStatus OnUpdate()
    {
      if ((UnityEngine.Object) this.Target.Value == (UnityEngine.Object) null || (UnityEngine.Object) this.npcState == (UnityEngine.Object) null || this.npcState.CurrentNpcState != NpcStateEnum.Rotate)
