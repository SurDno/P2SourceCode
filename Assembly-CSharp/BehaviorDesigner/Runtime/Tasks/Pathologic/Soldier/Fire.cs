...
public class Fire : Action, IStub, ISerializeDataWrite, ISerializeDataRead {
	...
	public void DataRead(IDataReader reader, Type type) {
		...
		RotationAngularVelocity =
			BehaviorTreeDataReadUtility.ReadShared(reader, "RotationAngularVelocity", RotationAngularVelocity);
	}
}