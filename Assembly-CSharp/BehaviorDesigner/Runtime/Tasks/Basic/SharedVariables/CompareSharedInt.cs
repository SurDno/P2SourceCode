...
// Type: BehaviorDesigner.Runtime.Tasks.Basic.SharedVariables.CompareSharedInt
...
namespace BehaviorDesigner.Runtime.Tasks.Basic.SharedVariables
{
  ...
  public class CompareSharedInt : Conditional, IStub, ISerializeDataWrite, ISerializeDataRead
  {
    ...
    public void DataWrite(IDataWriter writer)
    {
      ...
      BehaviorTreeDataWriteUtility.WriteShared<SharedInt>(writer, "Variable", this.variable);
      BehaviorTreeDataWriteUtility.WriteShared<SharedInt>(writer, "CompareTo", this.compareTo);
    }
    ...
    public void DataRead(IDataReader reader, System.Type type)
    {
      ...
      this.variable = BehaviorTreeDataReadUtility.ReadShared<SharedInt>(reader, "Variable", this.variable);
      this.compareTo = BehaviorTreeDataReadUtility.ReadShared<SharedInt>(reader, "CompareTo", this.compareTo);
    }
