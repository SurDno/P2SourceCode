...
// Type: BehaviorDesigner.Runtime.Tasks.Basic.UnityNavMeshAgent.SetSpeed
...
namespace BehaviorDesigner.Runtime.Tasks.Basic.UnityNavMeshAgent
{
  ...
  public class SetSpeed : BehaviorDesigner.Runtime.Tasks.Action, IStub, ISerializeDataWrite, ISerializeDataRead
  {
    ...
    public void DataWrite(IDataWriter writer)
    {
      ...
      BehaviorTreeDataWriteUtility.WriteShared<SharedFloat>(writer, "Speed", this.speed);
    }
    ...
    public void DataRead(IDataReader reader, System.Type type)
    {
      ...
      this.speed = BehaviorTreeDataReadUtility.ReadShared<SharedFloat>(reader, "Speed", this.speed);
    }
