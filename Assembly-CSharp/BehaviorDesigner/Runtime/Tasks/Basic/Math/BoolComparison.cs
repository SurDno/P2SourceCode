...
public class BoolComparison : Conditional, IStub, ISerializeDataWrite, ISerializeDataRead {
	[Tooltip("The first bool")] [DataReadProxy] [DataWriteProxy] [CopyableProxy] [SerializeField]
	public SharedBool bool1;

	[Tooltip("The second bool")] [DataReadProxy] [DataWriteProxy] [CopyableProxy()] [SerializeField]
