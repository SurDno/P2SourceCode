...
public class RandomFloat : Action, IStub, ISerializeDataWrite, ISerializeDataRead {
	[Tooltip("The minimum amount")] [DataReadProxy] [DataWriteProxy] [CopyableProxy] [SerializeField]
	public SharedFloat min;

	[Tooltip("The maximum amount")] [DataReadProxy] [DataWriteProxy] [CopyableProxy] [SerializeField]
	public SharedFloat max;

	[Tooltip("Is the maximum value inclusive?")] [DataReadProxy] [DataWriteProxy] [CopyableProxy] [SerializeField]
