...
public class IsStaminaLessThan : Conditional, IStub, ISerializeDataWrite, ISerializeDataRead {
	...
	public override void OnAwake() {
		if (gameObject == null)
			return;
		var component1 = gameObject.GetComponent<EngineGameObject>();
		if (component1 == null)
			return;
		var owner = component1.Owner;
		if (owner == null)
			return;
		var component2 = owner.GetComponent<ParametersComponent>();
		if (component2 == null)
			return;
	...
	public override TaskStatus OnUpdate() {
		return staminaParameter == null ? TaskStatus.Failure :
			staminaParameter.Value <= (double)StaminaThreshold.Value ? TaskStatus.Success : TaskStatus.Failure;
	}
