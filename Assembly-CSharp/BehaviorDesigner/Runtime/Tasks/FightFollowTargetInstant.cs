...
public class FightFollowTargetInstant : Action, IStub, ISerializeDataWrite, ISerializeDataRead {
	...
	[Tooltip("Надо ли прицеливаться из оружия.")] [DataReadProxy] [DataWriteProxy] [CopyableProxy()] [SerializeField]
	...
	public override void OnStart() {
		...
		if (Target == null || Target.Value == null)
			return;
		npcState.FightFollowTarget(StopDistance.Value, RunDistance.Value, RetreatDistance.Value, Target.Value,
			Aim.Value);
	}
