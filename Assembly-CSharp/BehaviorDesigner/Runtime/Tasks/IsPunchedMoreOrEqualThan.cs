...
public class IsPunchedMoreOrEqualThan : Conditional, IStub, ISerializeDataWrite, ISerializeDataRead {
	...
	public override void OnAwake() {
		owner = gameObject.GetComponent<NPCEnemy>();
	}

	public override TaskStatus OnUpdate() {
		return owner == null ? TaskStatus.Success :
			owner.GetPunchesCount(CalculationTime.Value) >= PunchedMoreOrEqualThan.Value ? TaskStatus.Success :
			TaskStatus.Failure;
	}
	...
	public void DataRead(IDataReader reader, Type type) {
		...
		PunchedMoreOrEqualThan =
			BehaviorTreeDataReadUtility.ReadShared(reader, "PunchedMoreOrEqualThan", PunchedMoreOrEqualThan);
