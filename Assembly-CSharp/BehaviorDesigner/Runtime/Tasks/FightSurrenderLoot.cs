...
// Type: BehaviorDesigner.Runtime.Tasks.FightSurrenderLoot
...
namespace BehaviorDesigner.Runtime.Tasks
{
  ...
  public class FightSurrenderLoot : Action, IStub, ISerializeDataWrite, ISerializeDataRead
  {
    ...
    [SerializeField]
    public SharedFloat LootTime = (SharedFloat) 10f;
    ...
    public override void OnStart()
    {
      ...
      this.npcState.FightSurrenderLoot(this.LootTime.Value);
    }

    public override TaskStatus OnUpdate()
    {
      if (this.npcState.CurrentNpcState != NpcStateEnum.FightSurrenderLoot)
    ...
    public void DataWrite(IDataWriter writer)
    {
      ...
      BehaviorTreeDataWriteUtility.WriteShared<SharedFloat>(writer, "LootTime", this.LootTime);
    }
    ...
    public void DataRead(IDataReader reader, System.Type type)
    {
      ...
      this.LootTime = BehaviorTreeDataReadUtility.ReadShared<SharedFloat>(reader, "LootTime", this.LootTime);
    }
  }
}
