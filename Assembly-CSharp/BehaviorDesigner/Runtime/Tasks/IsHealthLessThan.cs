...
namespace BehaviorDesigner.Runtime.Tasks
{
  ...
  public class IsHealthLessThan : Conditional, IStub, ISerializeDataWrite, ISerializeDataRead
  {
    ...
    {
      IEntity owner = gameObject.GetComponent<EngineGameObject>().Owner;
      if (owner == null)
        return;
    ...
    {
      return healthParameter == null ? TaskStatus.Failure : (healthParameter.Value <= (double) HealthThreshold.Value ? TaskStatus.Success : TaskStatus.Failure);
    }
