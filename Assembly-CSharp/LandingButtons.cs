public class LandingButtons : MonoBehaviour
{
  ...
  public void OnGUI()
  {
    GUI.Label(new Rect(20f, 20f, 125f, 18f), "Landing Spots: " + (object) _landingSpotController.transform.childCount);
    ...
    if (GUI.Button(new Rect(20f, 80f, 125f, 18f), "Land Instant"))
      this.StartCoroutine(_landingSpotController.InstantLand(0.01f));
    ...
    _flockController._childAmount = (int) GUI.HorizontalSlider(new Rect(20f, 140f, 125f, 18f), (float) _flockController._childAmount, 0.0f, 250f);
  }
}
