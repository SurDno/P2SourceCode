...
public class SPRectShape : Shape {
	...
	private void OnDrawGizmosSelected() {
		...
		var vector2 = new Vector2(Size.x * 0.5f, Size.y * 0.5f);
		var vector3_1 = localToWorldMatrix.MultiplyPoint(new Vector3(-vector2.x, -vector2.y, 0.0f));
		var vector3_2 = localToWorldMatrix.MultiplyPoint(new Vector3(-vector2.x, vector2.y, 0.0f));
		var vector3_3 = localToWorldMatrix.MultiplyPoint(new Vector3(vector2.x, vector2.y, 0.0f));
		var vector3_4 = localToWorldMatrix.MultiplyPoint(new Vector3(vector2.x, -vector2.y, 0.0f));
