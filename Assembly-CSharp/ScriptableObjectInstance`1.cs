...
public class ScriptableObjectInstance<T> : ScriptableObject where T : ScriptableObject {
	...
	public static T Instance {
		get {
			if (instance == null) {
				var path = "Assets/Data/Settings/Resources/" + typeof(T).Name + ".asset";
				var customAttributes =
					(ScriptableObjectInstanceAttribute[])typeof(T).GetCustomAttributes(
						typeof(ScriptableObjectInstanceAttribute), false);
