...
public class FightAnimatorBehavior : StateMachineBehaviour {
	...
	public override void OnStateEnter(Animator animator, AnimatorStateInfo stateInfo, int layerIndex) {
		var animatorState = GetAnimatorState(animator);
	...
	public override void OnStateExit(Animator animator, AnimatorStateInfo stateInfo, int layerIndex) {
		var animatorState = GetAnimatorState(animator);
		if (layerIndex != animator.GetLayerIndex("Fight Reaction Layer") &&
		    layerIndex != animator.GetLayerIndex("Fight Knife Reaction Layer"))
			return;
	...
	public class AnimatorState {
		...
		public bool IsAttacking => IsRunPunching || IsPunching || IsStepPunching || IsTelegraphPunching ||
		                           IsSuperPunching || IsCheating || IsThrowing || IsAiming || IsShoting;

		public bool IsPushing { get; set; }

		public bool IsReaction => ReactionEmptyCount > 0 || ReactionHandsCount > 0 || ReactionKnifeCount > 0 ||
		                          ReactionBombCount > 0 || ReactionPushCount > 0;
