...
public class TextureSettings : ScriptableObject {
	[SerializeField] private float memoryBudget = 512f;
	[SerializeField] private int maxLevelReduction = 2;
	[SerializeField] private int maxFileIORequests = 1024;
	[SerializeField] private int memoryRequirement = 1024;
	...
	public bool CheckMemoryRequirement() {
		return memoryRequirement <= SystemInfo.graphicsMemorySize;
	}
}