...
public class GraphicSettingsPreset : ScriptableObject {
	[SerializeField] private bool additionalReflections;
	[SerializeField] private float aiLodDistance;
	[SerializeField] private bool anisotropicFiltering;
	[SerializeField] private bool antialiasing;
	[SerializeField] private bool aoFields;
	[SerializeField] private bool contactShadows;
	[SerializeField] private bool dof;
	[SerializeField] [Range(0.5f, 2f)] private float levelOfDetails;
	[SerializeField] private bool motionBlur;
	[SerializeField] [Range(5f, 75f)] private float shadowDistance;
	[SerializeField] private int shadowQuality;
	[SerializeField] private bool softParticles;
	[SerializeField] private bool ssao;
	[SerializeField] private bool ssr;
	[SerializeField] [Range(0.0f, 3f)] private int volumetricLighting;
	...
	public bool IsCurrent() {
		var instance = InstanceByRequest<GraphicsGameSettings>.Instance;
		return instance.AdditionalReflections.Value == additionalReflections &&
		       instance.AILodDistance.Value == (double)aiLodDistance &&
		       instance.AnisotropicFiltering.Value == anisotropicFiltering &&
		       instance.Antialiasing.Value == antialiasing && instance.AOFields.Value == aoFields &&
		       instance.ContactShadows.Value == contactShadows && instance.DOF.Value == dof &&
		       instance.LevelOfDetails.Value == (double)levelOfDetails && instance.MotionBlur.Value == motionBlur &&
		       instance.ShadowDistance.Value == (double)shadowDistance &&
		       instance.ShadowQuality.Value == shadowQuality && instance.SoftParticles.Value == softParticles &&
		       instance.SSAO.Value == ssao && instance.SSR.Value == ssr &&
		       instance.VolumetricLighting.Value == volumetricLighting;
	}
}