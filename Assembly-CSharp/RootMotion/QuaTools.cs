  ...
  public static class QuaTools
  {
    public static Quaternion Lerp(Quaternion fromRotation, Quaternion toRotation, float weight)
    {
      if ((double) weight <= 0.0)
        return fromRotation;
      return (double) weight >= 1.0 ? toRotation : Quaternion.Lerp(fromRotation, toRotation, weight);
    }
    ...
    public static Quaternion Slerp(Quaternion fromRotation, Quaternion toRotation, float weight)
    {
      if ((double) weight <= 0.0)
        return fromRotation;
      return (double) weight >= 1.0 ? toRotation : Quaternion.Slerp(fromRotation, toRotation, weight);
    }
    ...
    public static Quaternion LinearBlend(Quaternion q, float weight)
    {
      ...
      return (double) weight >= 1.0 ? q : Quaternion.Lerp(Quaternion.identity, q, weight);
    }
    ...
    public static Quaternion SphericalBlend(Quaternion q, float weight)
    {
      if ((double) weight <= 0.0)
        return Quaternion.identity;
      return (double) weight >= 1.0 ? q : Quaternion.Slerp(Quaternion.identity, q, weight);
    }
    ...
    public static Vector3 GetAxis(Vector3 v)
    {
      ...
      if ((double) Mathf.Abs(f3) > (double) num1)
      {
      ...
      int clampSmoothing)
    {
      ...
      float num2 = Mathf.Clamp((float) (1.0 - ((double) clampWeight - (double) num1) / (1.0 - (double) num1)), 0.0f, 1f);
