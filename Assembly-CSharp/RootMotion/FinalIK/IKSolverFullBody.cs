...
public class IKSolverFullBody : IKSolver {
	[Range(0.0f, 10f)] public int iterations = 4;
	...
	public override Point[] GetPoints() {
		...
		var index1 = 0;
		for (var index2 = 0; index2 < chain.Length; ++index2) {
			for (var index3 = 0; index3 < chain[index2].nodes.Length; ++index3)
	...
	public override Point GetPoint(Transform transform) {
		for (var index1 = 0; index1 < chain.Length; ++index1) {
			for (var index2 = 0; index2 < chain[index1].nodes.Length; ++index2)
	...
	public override void StoreDefaultLocalState() {
		...
		for (var index = 0; index < limbMappings.Length; ++index)
	...
	protected virtual void ReadPose() {
		for (var index = 0; index < chain.Length; ++index)
			if (chain[index].bendConstraint.initiated)
				chain[index].bendConstraint.LimitBend(IKPositionWeight,
					GetEffector(chain[index].nodes[2].transform).positionWeight);
		for (var index = 0; index < effectors.Length; ++index)
