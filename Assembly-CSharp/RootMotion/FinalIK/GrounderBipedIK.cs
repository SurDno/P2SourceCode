  ...
  public class GrounderBipedIK : Grounder
  {
    ...
    private void OnSolverUpdate()
    {
      ...
      if (spineBend != 0.0 && ik.references.spine.Length != 0)
      {
        ...
        Quaternion rotation1 = ik.references.leftUpperArm.rotation;
        Quaternion rotation2 = ik.references.rightUpperArm.rotation;
        Vector3 up = solver.up;
        ik.references.spine[0].rotation = Quaternion.FromToRotation(up, up + spineOffset) * ik.references.spine[0].rotation;
