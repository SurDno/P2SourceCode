...
public class VRIK : IK {
	...
	[Tooltip(
		"Bone mapping. Right-click on the component header and select 'Auto-detect References' of fill in manually if not a Humanoid character.")]
	public References references = new();

	[Tooltip("The VRIK solver.")] public IKSolverVR solver = new();
	...
	public class References {
		...
		public bool isFilled => !(root == null) && !(pelvis == null) && !(spine == null) && !(head == null) &&
		...
		public bool isEmpty => !(root != null) && !(pelvis != null) && !(spine != null) && !(chest != null) &&
		                       !(neck != null) && !(head != null) && !(leftShoulder != null) &&
		                       !(leftUpperArm != null) && !(leftForearm != null) && !(leftHand != null) &&
		                       !(rightShoulder != null) && !(rightUpperArm != null) && !(rightForearm != null) &&
		                       !(rightHand != null) && !(leftThigh != null) && !(leftCalf != null) &&
		                       !(leftFoot != null) && !(leftToes != null) && !(rightThigh != null) &&
		                       !(rightCalf != null) && !(rightFoot != null) && !(rightToes != null);
		...
		public static bool AutoDetectReferences(Transform root, out References references) {
			...
			if (componentInChildren == null || !componentInChildren.isHuman) {
				Debug.LogWarning(
					"VRIK needs a Humanoid Animator to auto-detect biped references. Please assign references manually.");
				return false;
			}
