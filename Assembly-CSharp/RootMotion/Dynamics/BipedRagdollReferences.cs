...
public struct BipedRagdollReferences {
	...
	public bool IsValid(ref string msg) {
		if (root == null || hips == null || head == null || leftUpperArm == null || leftLowerArm == null ||
		    leftHand == null || rightUpperArm == null || rightLowerArm == null || rightHand == null ||
		    leftUpperLeg == null || leftLowerLeg == null || leftFoot == null || rightUpperLeg == null ||
		    rightLowerLeg == null || rightFoot == null) {
			msg = "Invalid References, one or more Transforms missing.";
			return false;
		}

		var transformArray = new Transform[15] {
			root,
			hips,
			head,
			leftUpperArm,
		...
		for (var index = 1; index < transformArray.Length; ++index)
		...
		for (var index1 = 0; index1 < transformArray.Length; ++index1) {
	...
	public bool IsEmpty(bool considerRoot) {
		return (!considerRoot || !(root != null)) && !(hips != null) && !(head != null) && !(spine != null) &&
		       !(chest != null) && !(leftUpperArm != null) && !(leftLowerArm != null) && !(leftHand != null) &&
	...
	public bool Contains(Transform t, bool ignoreRoot = false) {
		return (!ignoreRoot && root == t) || hips == t || spine == t || chest == t || leftUpperLeg == t ||
		       leftLowerLeg == t || leftFoot == t || rightUpperLeg == t || rightLowerLeg == t || rightFoot == t ||
		       leftUpperArm == t || leftLowerArm == t || leftHand == t || rightUpperArm == t || rightLowerArm == t ||
		       rightHand == t || head == t;
	}
	...
	public static BipedRagdollReferences FromAvatar(Animator animator) {
		var ragdollReferences = new BipedRagdollReferences();
		if (!animator.isHuman)
