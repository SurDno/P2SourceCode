...
public class Booster {
	...
	[Tooltip("Immunity to apply to the muscles. If muscle immunity is 1, it can not be damaged.")] [Range(0.0f, 1f)]
	...
	public void Boost(BehaviourPuppet puppet) {
		if (fullBody)
			...
			foreach (var muscle in muscles)
				for (var muscleIndex = 0; muscleIndex < puppet.puppetMaster.muscles.Length; ++muscleIndex)
