...
public class BipedLimbOrientations {
	...
	public static BipedLimbOrientations UMA => new(
	...
	public static BipedLimbOrientations MaxBiped => new(new LimbOrientation(Vector3.down, Vector3.down, Vector3.down),
