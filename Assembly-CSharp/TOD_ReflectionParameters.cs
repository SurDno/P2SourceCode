...
public class TOD_ReflectionParameters {
	[Tooltip("Reflection probe mode.")] public TOD_ReflectionType Mode = TOD_ReflectionType.None;
	...
	[Tooltip("Refresh interval of the reflection cubemap in seconds.")] [TOD_Min(0.0f)]
