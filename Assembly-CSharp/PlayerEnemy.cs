...
public class PlayerEnemy : EnemyBase {
	...
	[Inspected] public override bool IsStagger => animatorState.IsStagger;
	...
	public override void Punch(
		...
		if ((punchType == PunchTypeEnum.Strong || punchType == PunchTypeEnum.Moderate) &&
		    Random.value < 0.20000000298023224)
