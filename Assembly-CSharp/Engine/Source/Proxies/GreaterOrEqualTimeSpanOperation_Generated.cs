...
public class GreaterOrEqualTimeSpanOperation_Generated :
	...
	ISerializeDataRead {
	public object Clone() {
		var instance = Activator.CreateInstance<GreaterOrEqualTimeSpanOperation_Generated>();
		CopyTo(instance);
		return instance;
	}

	public void CopyTo(object target2) {
		var operationGenerated = (GreaterOrEqualTimeSpanOperation_Generated)target2;
