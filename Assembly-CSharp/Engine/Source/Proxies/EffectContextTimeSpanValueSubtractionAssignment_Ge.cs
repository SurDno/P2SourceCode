...
public class EffectContextTimeSpanValueSubtractionAssignment_Generated :
	...
	ISerializeDataRead {
	public object Clone() {
		var instance = Activator.CreateInstance<EffectContextTimeSpanValueSubtractionAssignment_Generated>();
		CopyTo(instance);
		return instance;
	}

	public void CopyTo(object target2) {
		var assignmentGenerated = (EffectContextTimeSpanValueSubtractionAssignment_Generated)target2;
