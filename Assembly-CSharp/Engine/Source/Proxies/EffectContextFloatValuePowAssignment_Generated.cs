...
public class EffectContextFloatValuePowAssignment_Generated :
	...
	ISerializeDataRead {
	public object Clone() {
		var instance = Activator.CreateInstance<EffectContextFloatValuePowAssignment_Generated>();
		CopyTo(instance);
		return instance;
	}

	public void CopyTo(object target2) {
		var assignmentGenerated = (EffectContextFloatValuePowAssignment_Generated)target2;
