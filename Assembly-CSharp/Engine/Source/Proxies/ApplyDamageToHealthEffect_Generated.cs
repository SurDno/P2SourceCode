...
public class ApplyDamageToHealthEffect_Generated :
	...
	ISerializeDataRead {
	public object Clone() {
		var instance = Activator.CreateInstance<ApplyDamageToHealthEffect_Generated>();
		CopyTo(instance);
		return instance;
	}

	public void CopyTo(object target2) {
		var healthEffectGenerated = (ApplyDamageToHealthEffect_Generated)target2;
	...
	public void DataRead(IDataReader reader, Type type) {
		...
		isCombatIgnoredParameterName =
			DefaultDataReadUtility.ReadEnum<ParameterNameEnum>(reader, "IsCombatIgnoredParameterName");
		immortalParameterName = DefaultDataReadUtility.ReadEnum<ParameterNameEnum>(reader, "ImmortalParameterName");
		ballisticDamageParameterName =
			DefaultDataReadUtility.ReadEnum<ParameterNameEnum>(reader, "BallisticDamageParameterName");
		fireDamageParameterName = DefaultDataReadUtility.ReadEnum<ParameterNameEnum>(reader, "FireDamageParameterName");
		meleeDamageParameterName =
			DefaultDataReadUtility.ReadEnum<ParameterNameEnum>(reader, "MeleeDamageParameterName");
		fallDamageParameterName = DefaultDataReadUtility.ReadEnum<ParameterNameEnum>(reader, "FallDamageParameterName");
		fistsDamageParameterName =
			DefaultDataReadUtility.ReadEnum<ParameterNameEnum>(reader, "FistsDamageParameterName");
