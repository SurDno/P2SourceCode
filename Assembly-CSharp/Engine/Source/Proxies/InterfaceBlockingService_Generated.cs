...
public class InterfaceBlockingService_Generated :
	...
	public void StateLoad(IDataReader reader, Type type) {
		...
		mindMapInterfaceBlocked =
			DefaultDataReadUtility.Read(reader, "MindMapInterfaceBlocked", mindMapInterfaceBlocked);
		inventoryInterfaceBlocked =
			DefaultDataReadUtility.Read(reader, "InventoryInterfaceBlocked", inventoryInterfaceBlocked);
