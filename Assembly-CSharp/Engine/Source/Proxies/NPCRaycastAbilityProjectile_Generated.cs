...
public class NPCRaycastAbilityProjectile_Generated :
	...
	ISerializeDataRead {
	public object Clone() {
		var instance = Activator.CreateInstance<NPCRaycastAbilityProjectile_Generated>();
		CopyTo(instance);
		return instance;
	}

	public void CopyTo(object target2) {
		var projectileGenerated = (NPCRaycastAbilityProjectile_Generated)target2;
	...
	public void DataRead(IDataReader reader, Type type) {
		...
		minimumDirectionScatter =
			DefaultDataReadUtility.Read(reader, "MinimumDirectionScatter", minimumDirectionScatter);
		maximumDirectionScatter =
			DefaultDataReadUtility.Read(reader, "MaximumDirectionScatter", maximumDirectionScatter);
