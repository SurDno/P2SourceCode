...
namespace Engine.Source.Proxies
{
    ...
    ISerializeStateLoad
  {
    ...
    public void DataRead(IDataReader reader, Type type)
    {
      ...
      HerbsGrowTimeInMinutesMin = DefaultDataReadUtility.Read(reader, "HerbsGrowTimeInMinutesMin", HerbsGrowTimeInMinutesMin);
      herbsGrowTimeInMinutesMax = DefaultDataReadUtility.Read(reader, "HerbsGrowTimeInMinutesMax", herbsGrowTimeInMinutesMax);
    }
    ...
    public void StateLoad(IDataReader reader, Type type)
    {
      ...
      herbGrowTimesLeftSorted = DefaultDataReadUtility.ReadList(reader, "HerbGrowTimesLeftSorted", herbGrowTimesLeftSorted);
