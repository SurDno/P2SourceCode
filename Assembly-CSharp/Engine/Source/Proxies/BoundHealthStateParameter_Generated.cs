...
public class BoundHealthStateParameter_Generated :
	...
	public void ComputeNeedSave(object target2) {
		NeedSave = true;
		var parameterGenerated = (BoundHealthStateParameter_Generated)target2;
	...
	public object Clone() {
		var instance = Activator.CreateInstance<BoundHealthStateParameter_Generated>();
		CopyTo(instance);
		return instance;
	}
	...
	public void DataRead(IDataReader reader, Type type) {
		...
		value = DefaultDataReadUtility.ReadEnum<BoundHealthStateEnum>(reader, "Value");
	}
