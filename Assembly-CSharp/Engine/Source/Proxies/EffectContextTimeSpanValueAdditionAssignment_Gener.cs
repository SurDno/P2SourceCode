...
public class EffectContextTimeSpanValueAdditionAssignment_Generated :
	...
	ISerializeDataRead {
	public object Clone() {
		var instance = Activator.CreateInstance<EffectContextTimeSpanValueAdditionAssignment_Generated>();
		CopyTo(instance);
		return instance;
	}

	public void CopyTo(object target2) {
		var assignmentGenerated = (EffectContextTimeSpanValueAdditionAssignment_Generated)target2;
