...
public class ExternalInputSettings_Generated :
	...
	ISerializeDataRead {
	public object Clone() {
		var instance = Activator.CreateInstance<ExternalInputSettings_Generated>();
		CopyTo(instance);
		return instance;
	}

	public void CopyTo(object target2) {
		var settingsGenerated = (ExternalInputSettings_Generated)target2;
	...
	public void DataRead(IDataReader reader, Type type) {
		...
		JoystickScaleSensitivity =
			DefaultDataReadUtility.Read(reader, "JoystickScaleSensitivity", JoystickScaleSensitivity);
		VirtualMouseSensitivity =
			DefaultDataReadUtility.Read(reader, "VirtualMouseSensitivity", VirtualMouseSensitivity);
