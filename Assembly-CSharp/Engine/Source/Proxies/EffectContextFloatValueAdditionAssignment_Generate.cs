...
public class EffectContextFloatValueAdditionAssignment_Generated :
	...
	ISerializeDataRead {
	public object Clone() {
		var instance = Activator.CreateInstance<EffectContextFloatValueAdditionAssignment_Generated>();
		CopyTo(instance);
		return instance;
	}

	public void CopyTo(object target2) {
		var assignmentGenerated = (EffectContextFloatValueAdditionAssignment_Generated)target2;
