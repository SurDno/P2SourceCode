...
public class ResetableIntParameter_Generated :
	...
	public void ComputeNeedSave(object target2) {
		NeedSave = true;
		var parameterGenerated = (ResetableIntParameter_Generated)target2;
		if (parameterGenerated.name != name || parameterGenerated.value != value ||
		    parameterGenerated.baseValue != baseValue || parameterGenerated.minValue != minValue ||
	...
	public object Clone() {
		var instance = Activator.CreateInstance<ResetableIntParameter_Generated>();
		CopyTo(instance);
		return instance;
	}
