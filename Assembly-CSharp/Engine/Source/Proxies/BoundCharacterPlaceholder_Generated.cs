...
public class BoundCharacterPlaceholder_Generated :
	...
	public void CopyTo(object target2) {
		var placeholderGenerated = (BoundCharacterPlaceholder_Generated)target2;
	...
	public void DataRead(IDataReader reader, Type type) {
		...
		undiscoveredNormalSprite =
			UnityDataReadUtility.Read(reader, "UndiscoveredNormalSprite", undiscoveredNormalSprite);
