...
public class BoolParameterCheckAbilityController_Generated :
	...
	ISerializeDataRead {
	public object Clone() {
		var instance = Activator.CreateInstance<BoolParameterCheckAbilityController_Generated>();
		CopyTo(instance);
		return instance;
	}

	public void CopyTo(object target2) {
		var controllerGenerated = (BoolParameterCheckAbilityController_Generated)target2;
