...
// Type: Engine.Source.Proxies.MaxIntOperation_Generated
...
{
  [FactoryProxy(typeof (MaxIntOperation))]
  public class MaxIntOperation_Generated : 
    MaxIntOperation,
    ICloneable,
    ICopyable,
    ISerializeDataWrite,
    ISerializeDataRead
  {
    public object Clone()
    {
      MaxIntOperation_Generated instance = Activator.CreateInstance<MaxIntOperation_Generated>();
    ...
    {
      MaxIntOperation_Generated operationGenerated = (MaxIntOperation_Generated) target2;
