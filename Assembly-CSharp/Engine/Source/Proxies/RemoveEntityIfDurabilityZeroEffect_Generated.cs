...
public class RemoveEntityIfDurabilityZeroEffect_Generated :
	...
	ISerializeDataRead {
	public object Clone() {
		var instance = Activator.CreateInstance<RemoveEntityIfDurabilityZeroEffect_Generated>();
		CopyTo(instance);
		return instance;
	}

	public void CopyTo(object target2) {
		var zeroEffectGenerated = (RemoveEntityIfDurabilityZeroEffect_Generated)target2;
