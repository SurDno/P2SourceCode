...
// Type: Engine.Source.Proxies.FloatParameter_Generated
...
{
  [FactoryProxy(typeof (FloatParameter))]
  public class FloatParameter_Generated : 
    FloatParameter,
    IComputeNeedSave,
    INeedSave,
    ICloneable,
    ...
    ISerializeStateLoad
  {
    ...
    {
      this.NeedSave = true;
      FloatParameter_Generated parameterGenerated = (FloatParameter_Generated) target2;
      if (parameterGenerated.name != this.name || (double) parameterGenerated.value != (double) this.value || (double) parameterGenerated.minValue != (double) this.minValue || (double) parameterGenerated.maxValue != (double) this.maxValue)
        return;
      this.NeedSave = false;
    }
    ...
    public object Clone()
    {
      FloatParameter_Generated instance = Activator.CreateInstance<FloatParameter_Generated>();
