...
public class ExternalOptimizationSettings_Generated :
	...
	ISerializeDataRead {
	public object Clone() {
		var instance = Activator.CreateInstance<ExternalOptimizationSettings_Generated>();
		CopyTo(instance);
		return instance;
	}

	public void CopyTo(object target2) {
		var settingsGenerated = (ExternalOptimizationSettings_Generated)target2;
	...
	public void DataRead(IDataReader reader, Type type) {
		...
		BlueprintsInSeparateThread =
			DefaultDataReadUtility.Read(reader, "BlueprintsInSeparateThread", BlueprintsInSeparateThread);
		InteractableAsyncBlueprintStart = DefaultDataReadUtility.Read(reader, "InteractableAsyncBlueprintStart",
			InteractableAsyncBlueprintStart);
		...
		PathfindingIterationsPerFrame =
			DefaultDataReadUtility.Read(reader, "PathfindingIterationsPerFrame", PathfindingIterationsPerFrame);
		ReduceUpdateFarObjectsDistance =
			DefaultDataReadUtility.Read(reader, "ReduceUpdateFarObjectsDistance", ReduceUpdateFarObjectsDistance);
		...
		OutdoorCrowdUpdateDelay =
			DefaultDataReadUtility.Read(reader, "OutdoorCrowdUpdateDelay", OutdoorCrowdUpdateDelay);
		...
		BehaviorTreeUpdateDelay =
			DefaultDataReadUtility.Read(reader, "BehaviorTreeUpdateDelay", BehaviorTreeUpdateDelay);
		...
		DestroyOutdoorCrowdInIndoor =
			DefaultDataReadUtility.Read(reader, "DestroyOutdoorCrowdInIndoor", DestroyOutdoorCrowdInIndoor);
		RegionDistanceDelay = DefaultDataReadUtility.Read(reader, "RegionDistanceDelay", RegionDistanceDelay);
		MaxOutdoorCrowdEntityCount =
			DefaultDataReadUtility.Read(reader, "MaxOutdoorCrowdEntityCount", MaxOutdoorCrowdEntityCount);
		LimitOutdoorAreaCrowdEntity =
			DefaultDataReadUtility.ReadListEnum(reader, "LimitOutdoorAreaCrowdEntity", LimitOutdoorAreaCrowdEntity);
		...
		VMEventsQueuePerFrameTimeMax =
			DefaultDataReadUtility.Read(reader, "VMEventsQueuePerFrameTimeMax", VMEventsQueuePerFrameTimeMax);
		ChangeLocationLoadingWindow =
			DefaultDataReadUtility.Read(reader, "ChangeLocationLoadingWindow", ChangeLocationLoadingWindow);
		ReleaseStrategyIndex = DefaultDataReadUtility.Read(reader, "ReleaseStrategyIndex", ReleaseStrategyIndex);
		DevelopmentStrategyIndex =
			DefaultDataReadUtility.Read(reader, "DevelopmentStrategyIndex", DevelopmentStrategyIndex);
		...
		MemoryStrategyTimeEventPeriod =
			DefaultDataReadUtility.Read(reader, "MemoryStrategyTimeEventPeriod", MemoryStrategyTimeEventPeriod);
