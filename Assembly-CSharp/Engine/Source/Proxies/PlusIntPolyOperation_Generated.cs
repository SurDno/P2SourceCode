...
public class PlusIntPolyOperation_Generated :
	...
	ISerializeDataRead {
	public object Clone() {
		var instance = Activator.CreateInstance<PlusIntPolyOperation_Generated>();
		CopyTo(instance);
		return instance;
	}

	public void CopyTo(object target2) {
		CloneableObjectUtility.CopyListTo(((PlusIntPolyOperation_Generated)target2).values, values);
	}
