...
public class ReduceDamageEffect_Generated :
	...
	ISerializeDataRead {
	public object Clone() {
		var instance = Activator.CreateInstance<ReduceDamageEffect_Generated>();
		CopyTo(instance);
		return instance;
	}

	public void CopyTo(object target2) {
		var damageEffectGenerated = (ReduceDamageEffect_Generated)target2;
	...
	public void DataRead(IDataReader reader, Type type) {
		...
		adsorbtionMaxParameterName =
			DefaultDataReadUtility.ReadEnum<ParameterNameEnum>(reader, "AdsorbtionMaxParameterName");
		...
		durabilityReduceKoeficient =
			DefaultDataReadUtility.Read(reader, "DurabilityReduceKoeficient", durabilityReduceKoeficient);
	}
}