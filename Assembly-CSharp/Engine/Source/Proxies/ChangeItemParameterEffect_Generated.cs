...
public class ChangeItemParameterEffect_Generated :
	...
	ISerializeDataRead {
	public object Clone() {
		var instance = Activator.CreateInstance<ChangeItemParameterEffect_Generated>();
		CopyTo(instance);
		return instance;
	}

	public void CopyTo(object target2) {
		var parameterEffectGenerated = (ChangeItemParameterEffect_Generated)target2;
	...
	public void DataRead(IDataReader reader, Type type) {
		...
		difficultyMultiplierParameterName = DefaultDataReadUtility.Read(reader, "DifficultyMultiplierParameterName",
			difficultyMultiplierParameterName);
	}
}