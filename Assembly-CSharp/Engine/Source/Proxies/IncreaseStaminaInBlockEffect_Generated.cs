...
public class IncreaseStaminaInBlockEffect_Generated :
	...
	ISerializeDataRead {
	public object Clone() {
		var instance = Activator.CreateInstance<IncreaseStaminaInBlockEffect_Generated>();
		CopyTo(instance);
		return instance;
	}

	public void CopyTo(object target2) {
		var blockEffectGenerated = (IncreaseStaminaInBlockEffect_Generated)target2;
	...
	public void DataRead(IDataReader reader, Type type) {
		...
		increaseStaminaStepMaxValue =
			DefaultDataReadUtility.Read(reader, "IncreaseStaminaStepMaxValue", increaseStaminaStepMaxValue);
	}
}