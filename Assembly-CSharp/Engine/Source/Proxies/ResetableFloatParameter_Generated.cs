...
namespace Engine.Source.Proxies
{
    ...
    ISerializeStateLoad
  {
    ...
    public void ComputeNeedSave(object target2)
    {
      ...
      if (parameterGenerated.name != name || parameterGenerated.value != (double) value || parameterGenerated.baseValue != (double) baseValue || parameterGenerated.minValue != (double) minValue || parameterGenerated.maxValue != (double) maxValue)
        return;
      NeedSave = false;
    }
