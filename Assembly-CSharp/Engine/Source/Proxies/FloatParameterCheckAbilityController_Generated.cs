...
public class FloatParameterCheckAbilityController_Generated :
	...
	ISerializeDataRead {
	public object Clone() {
		var instance = Activator.CreateInstance<FloatParameterCheckAbilityController_Generated>();
		CopyTo(instance);
		return instance;
	}

	public void CopyTo(object target2) {
		var controllerGenerated = (FloatParameterCheckAbilityController_Generated)target2;
