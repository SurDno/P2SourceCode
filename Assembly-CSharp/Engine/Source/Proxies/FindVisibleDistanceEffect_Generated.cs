...
namespace Engine.Source.Proxies
{
    ...
    ISerializeDataRead
  {
    ...
    public void DataRead(IDataReader reader, Type type)
    {
      ...
      VisibileDistanceParameterName = DefaultDataReadUtility.ReadEnum<ParameterNameEnum>(reader, "VisibileDistanceParameterName");
      FlashlightOnParameterName = DefaultDataReadUtility.ReadEnum<ParameterNameEnum>(reader, "FlashlightOnParameterName");
    }
  }
}
