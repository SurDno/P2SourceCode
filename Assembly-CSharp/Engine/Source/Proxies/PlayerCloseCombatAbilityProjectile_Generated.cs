...
public class PlayerCloseCombatAbilityProjectile_Generated :
	...
	ISerializeDataRead {
	public object Clone() {
		var instance = Activator.CreateInstance<PlayerCloseCombatAbilityProjectile_Generated>();
		CopyTo(instance);
		return instance;
	}

	public void CopyTo(object target2) {
		var projectileGenerated = (PlayerCloseCombatAbilityProjectile_Generated)target2;
