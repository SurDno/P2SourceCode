...
// Type: Engine.Source.Proxies.LessIntOperation_Generated
...
{
  [FactoryProxy(typeof (LessIntOperation))]
  public class LessIntOperation_Generated : 
    LessIntOperation,
    ICloneable,
    ICopyable,
    ISerializeDataWrite,
    ISerializeDataRead
  {
    public object Clone()
    {
      LessIntOperation_Generated instance = Activator.CreateInstance<LessIntOperation_Generated>();
    ...
    {
      LessIntOperation_Generated operationGenerated = (LessIntOperation_Generated) target2;
