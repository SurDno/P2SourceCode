...
public class PreInfectionTrialAbilityController_Generated :
	...
	ISerializeDataRead {
	public object Clone() {
		var instance = Activator.CreateInstance<PreInfectionTrialAbilityController_Generated>();
		CopyTo(instance);
		return instance;
	}

	public void CopyTo(object target2) {
		var controllerGenerated = (PreInfectionTrialAbilityController_Generated)target2;
	...
	public void DataRead(IDataReader reader, Type type) {
		...
		preinfectionCheckInterval =
			DefaultDataReadUtility.Read(reader, "PreinfectionCheckInterval", preinfectionCheckInterval);
	}
}