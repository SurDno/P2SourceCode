...
public class ApplyDamageToInfectionNPCEffect_Generated :
	...
	ISerializeDataRead {
	public object Clone() {
		var instance = Activator.CreateInstance<ApplyDamageToInfectionNPCEffect_Generated>();
		CopyTo(instance);
		return instance;
	}

	public void CopyTo(object target2) {
		var npcEffectGenerated = (ApplyDamageToInfectionNPCEffect_Generated)target2;
