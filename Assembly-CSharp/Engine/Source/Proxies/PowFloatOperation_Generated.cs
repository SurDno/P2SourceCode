...
// Type: Engine.Source.Proxies.PowFloatOperation_Generated
...
{
  [FactoryProxy(typeof (PowFloatOperation))]
  public class PowFloatOperation_Generated : 
    PowFloatOperation,
    ICloneable,
    ICopyable,
    ISerializeDataWrite,
    ISerializeDataRead
  {
    public object Clone()
    {
      PowFloatOperation_Generated instance = Activator.CreateInstance<PowFloatOperation_Generated>();
    ...
    {
      PowFloatOperation_Generated operationGenerated = (PowFloatOperation_Generated) target2;
