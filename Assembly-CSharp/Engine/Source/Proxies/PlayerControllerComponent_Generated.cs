...
public class PlayerControllerComponent_Generated :
	...
	ISerializeDataRead {
	public object Clone() {
		var instance = Activator.CreateInstance<PlayerControllerComponent_Generated>();
		CopyTo(instance);
		return instance;
	}

	public void CopyTo(object target2) {
		var componentGenerated = (PlayerControllerComponent_Generated)target2;
	...
	public void DataRead(IDataReader reader, Type type) {
		...
		thresholdNearRegionsPositive =
			DefaultDataReadUtility.Read(reader, "ThresholdNearRegionsPositive", thresholdNearRegionsPositive);
		thresholdNearRegionsNegative =
			DefaultDataReadUtility.Read(reader, "ThresholdNearRegionsNegative", thresholdNearRegionsNegative);
		coefficientNearRegionsPositive =
			DefaultDataReadUtility.Read(reader, "CoefficientNearRegionsPositive", coefficientNearRegionsPositive);
		coefficientNearRegionsNegative =
			DefaultDataReadUtility.Read(reader, "CoefficientNearRegionsNegative", coefficientNearRegionsNegative);
		thresholdPlayerInfected =
			DefaultDataReadUtility.Read(reader, "ThresholdPlayerInfected", thresholdPlayerInfected);
		thresholdRegionInfected =
			DefaultDataReadUtility.Read(reader, "ThresholdRegionInfected", thresholdRegionInfected);
