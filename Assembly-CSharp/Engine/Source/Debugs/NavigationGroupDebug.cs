...
public static class NavigationGroupDebug {
	...
	private static void Update() {
		...
		var component1 = player.GetComponent<INavigationComponent>();
		var str = "  Region : " +
		          (component1 == null || component1.Region == null ? "" : component1.Region.Owner.Name) +
		          "\n  Area : " + (component1 != null ? component1.Area.ToString() : "");
		var component2 = player.GetComponent<LocationItemComponent>();
		var text2 = str + "\n  Location : " +
		            (component2 == null || component2.Location == null ? "" : component2.Location.Owner.Name) +
		            "\n  Logic Location : " +
		            (component2 == null || component2.LogicLocation == null
			            ? ""
			            : component2.LogicLocation.Owner.Name) + "\n  Logic Location Type : " +
		            (component2 == null || component2.LogicLocation == null
			            ? ""
			            : ((LocationComponent)component2.LogicLocation).LocationType.ToString());
