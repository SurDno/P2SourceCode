...
public class SuokCircleService :
	...
	[Inspected] private List<GameObject> suokCombatants = new();
	[Inspected] private List<GameObject> suokSpectators = new();
	[Inspected] private SuokCircleTutorialStateEnum state;
	...
	public SuokCircleTutorialStateEnum GetState() {
		return state;
	}
	...
	private void SetState(SuokCircleTutorialStateEnum state) {
		...
		var byName1 = playerParameters.GetByName<float>(ParameterNameEnum.Health);
		playerParameters.GetByName<float>(ParameterNameEnum.Thirst);
		var byName2 = enemyParameters.GetByName<float>(ParameterNameEnum.Health);
		var characterSubtree = BehaviorSubtreeUtility.GetCharacterSubtree(enemyView);
		Action handlerOnBeginTalking;
		switch (state) {
			case SuokCircleTutorialStateEnum.WaitForInitialDialogEnd:
				currentStamina = 1f;
				voicesBlueprint = BlueprintServiceUtility.Start(
					ScriptableObjectInstance<IntroData>.Instance.SuokVoicesBlueprint, null, null,
					typeof(SuokCircleService).Name);
				var speaking1 = enemyEntity.GetComponent<ISpeakingComponent>();
				...
				BehaviorSubtreeUtility.SetCharacterSubtree(characterSubtree,
					ScriptableObjectInstance<IntroData>.Instance.SuokSubAI_WaitForUnholster);
				break;
			case SuokCircleTutorialStateEnum.WaitForUnholster:
				currentTooltipBlueprint = BlueprintServiceUtility.Start(
					ScriptableObjectInstance<IntroData>.Instance.SuokNotificationBlueprint, null, null,
					typeof(SuokCircleService).Name);
				var component = playerEntity.GetComponent<IAttackerPlayerComponent>();
			...
			case SuokCircleTutorialStateEnum.WaitForPunch:
				playerEntity.GetComponent<IAttackerPlayerComponent>().WeaponUnholsterEndEvent -=
					Attacker_WeaponUnholsterEndEvent;
				voicesBlueprint?.SendEvent("Stop");
				currentStamina = 1f;
				currentTooltipBlueprint?.SendEvent("WaitForPunch");
				BehaviorSubtreeUtility.SetCharacterSubtree(characterSubtree,
					ScriptableObjectInstance<IntroData>.Instance.SuokSubAI_WaitForPunch);
			...
			case SuokCircleTutorialStateEnum.WaitForUppercut:
				...
				BehaviorSubtreeUtility.SetCharacterSubtree(characterSubtree,
					ScriptableObjectInstance<IntroData>.Instance.SuokSubAI_WaitForUppercut);
			...
			case SuokCircleTutorialStateEnum.WaitForLowStamina:
				...
				BehaviorSubtreeUtility.SetCharacterSubtree(characterSubtree,
					ScriptableObjectInstance<IntroData>.Instance.SuokSubAI_WaitForLowStamina);
			...
			case SuokCircleTutorialStateEnum.YourDamageIsLow:
				...
				BehaviorSubtreeUtility.SetCharacterSubtree(characterSubtree,
					ScriptableObjectInstance<IntroData>.Instance.SuokSubAI_WaitForLowStamina);
				playerView.GetComponent<PlayerWeaponServiceNew>().WeaponShootEvent +=
					PlayerWeaponService_WeaponShootEvent;
				break;
			case SuokCircleTutorialStateEnum.BlockExample:
				...
				BehaviorSubtreeUtility.SetCharacterSubtree(characterSubtree,
					ScriptableObjectInstance<IntroData>.Instance.SuokSubAI_BlockExample);
				punchCount = 0;
			...
			case SuokCircleTutorialStateEnum.RuinBlockExample:
				playerNpc.WasPunchedToBlockEvent -= PlayerNpc_WasPuncheToBlockDone;
				BehaviorSubtreeUtility.SetCharacterSubtree(characterSubtree,
					ScriptableObjectInstance<IntroData>.Instance.SuokSubAI_RuinBlockExample);
				punchCount = 0;
			...
			case SuokCircleTutorialStateEnum.StaminaGrowsFasterInBlock:
				...
				playerNpc.WasPunchedToStaggerEvent -= PlayerNpc_WasStaggered;
				BehaviorSubtreeUtility.SetCharacterSubtree(characterSubtree,
					ScriptableObjectInstance<IntroData>.Instance.SuokSubAI_WaitForStaminaGrows);
			...
			case SuokCircleTutorialStateEnum.WaitForFreeFight:
				...
				BehaviorSubtreeUtility.SetCharacterSubtree(characterSubtree,
					ScriptableObjectInstance<IntroData>.Instance.SuokSubAI_WaitForFreeFight);
			...
			case SuokCircleTutorialStateEnum.FreeFight:
				...
				enemyNpc.WasPunchedToQuickBlock -= EnemyNpc_WasAttacked;
				BehaviorSubtreeUtility.SetCharacterSubtree(characterSubtree,
					ScriptableObjectInstance<IntroData>.Instance.SuokSubAI_FreeFight);
			...
			case SuokCircleTutorialStateEnum.YouWin:
				...
				BehaviorSubtreeUtility.SetCharacterSubtree(characterSubtree,
					ScriptableObjectInstance<IntroData>.Instance.SuokSubAI_FinishedYouWin);
				var speaking = enemyEntity.GetComponent<ISpeakingComponent>();
			...
			case SuokCircleTutorialStateEnum.YouLoose:
				...
				BehaviorSubtreeUtility.SetCharacterSubtree(characterSubtree,
					ScriptableObjectInstance<IntroData>.Instance.SuokSubAI_FinishedYouLoose);
				break;
			case SuokCircleTutorialStateEnum.Ragdoll:
				...
				enemyNpc.WasStaggeredEvent += EnemyHealth_ChangeValueEvent_Ragdoll;
				enemyNpc.WasPunchedToStaggerEvent += EnemyHealth_ChangeValueEvent_Ragdoll;
				BehaviorSubtreeUtility.SetCharacterSubtree(BehaviorSubtreeUtility.GetCharacterSubtree(enemyView),
					ScriptableObjectInstance<IntroData>.Instance.SuokSubAI_Ragdoll);
				var tooltipBlueprint = currentTooltipBlueprint;
				if (tooltipBlueprint != null) tooltipBlueprint.SendEvent("YouKilledSurrender");
				break;
		}

		this.state = state;
		var stateChangedEvent = OnStateChangedEvent;
