...
public static class WeatherUtility {
	public static void SetDefaultWeather(IWeatherController weather, IWeatherSnapshot snapshot) {
		var layerBlenderItem1 = weather.GetItem(WeatherLayer.BaseLayer);
		...
		var layerBlenderItem2 = weather.GetItem(WeatherLayer.CutSceneLayer);
		...
		var layerBlenderItem3 = weather.GetItem(WeatherLayer.DistrictLayer);
		...
		var layerBlenderItem4 = weather.GetItem(WeatherLayer.PlannedEventsLayer);
