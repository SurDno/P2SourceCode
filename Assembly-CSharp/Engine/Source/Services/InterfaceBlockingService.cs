...
public class InterfaceBlockingService : IInterfaceBlockingService, ISavesController {
	[StateSaveProxy] [StateLoadProxy] protected bool mapInterfaceBlocked;
	[StateSaveProxy] [StateLoadProxy] protected bool mindMapInterfaceBlocked;
	[StateSaveProxy] [StateLoadProxy] protected bool inventoryInterfaceBlocked;
	[StateSaveProxy] [StateLoadProxy] protected bool statsInterfaceBlocked;
	[StateSaveProxy] [StateLoadProxy()] protected bool boundsInterfaceBlocked;
	...
	private void OnInvalidate() {
		var onBlockChanged = OnBlockChanged;
