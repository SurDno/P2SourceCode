...
public class MMService : IMMService, ISavesController {
	...
	[Inspected] public IEnumerable<IMMContent> Contents => Map.Contents;
	...
	[Inspected] public IEnumerable<IMMPage> Pages => Map.Pages;

	public void AddContent(IMMContent content) {
		Map.AddContent(content);
	}

	public void AddPage(IMMPage page) {
		Map.AddPage((MMPage)page);
	}
	...
	public IMMPage GetPage(int index) {
		return Map.GetPage(index);
	}

	public bool HasUndiscovered() {
		var currentGlobalPage = CurrentGlobalPage;
	...
	public void RemoveContent(IMMContent content) {
		Map.RemoveContent(content);
	}

	public void RemovePage(IMMPage page) {
		Map.RemovePage((MMPage)page);
	}

	public void RemovePageAt(int index) {
		Map.RemovePageAt(index);
	}

	public void SetPage(int index, IMMPage page) {
		Map.SetPage(index, (MMPage)page);
	}

	public void FireChangeUndiscoveredEvent() {
		var undiscoveredEvent = ChangeUndiscoveredEvent;
