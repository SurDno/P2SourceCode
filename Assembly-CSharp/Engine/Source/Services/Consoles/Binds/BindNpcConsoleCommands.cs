...
namespace Engine.Source.Services.Consoles.Binds
{
  ...
  public static class BindNpcConsoleCommands
  {
    ...
    {
      return parameters.Length == 1 && parameters[0].Value == "?" ? command : CreateNpc(new Guid("5718c1ab-f017-4b21-961b-fe00121f60b9"), new Guid("059ed7e4-e421-1e84-bbd1-41c4f51a80a0"), command);
    }

    [ConsoleCommand("create_npc2")]
    private static string CreateNpc2(string command, ConsoleParameter[] parameters)
    {
      return parameters.Length == 1 && parameters[0].Value == "?" ? command : CreateNpc(new Guid("4273aa85-3d7b-4da4-695a-c3f397881eb2"), new Guid("059ed7e4-e421-1e84-bbd1-41c4f51a80a0"), command);
    }

    [ConsoleCommand("create_npc3")]
    private static string CreateNpc3(string command, ConsoleParameter[] parameters)
    {
      return parameters.Length == 1 && parameters[0].Value == "?" ? command : CreateNpc(new Guid("db1b5913-5c15-2094-2b7e-b1b80444f996"), new Guid("059ed7e4-e421-1e84-bbd1-41c4f51a80a0"), command);
    }
    ...
    private static string CreateNpc(Guid entityId, Guid behaviorId, string command)
    {
      ...
      IEntity entity = ServiceCache.Factory.Instantiate(service.GetTemplate<IEntity>(entityId));
