...
public class CutsceneCinemachineCameraController : ICameraController {
	...
	private void SetGameObjectTarget(GameObject gameObjectTarget) {
		...
		GameCamera.Instance.SettingsPostProcessingOverride.NestedOverride =
			gameObjectTarget?.GetComponent<PostProcessingStackOverride>();
		if (brain != null)
	...
	public void Shutdown() {
		...
		GameCamera.Instance.SettingsPostProcessingOverride.NestedOverride =
			GameCamera.Instance.GamePostProcessingOverride;
	}
