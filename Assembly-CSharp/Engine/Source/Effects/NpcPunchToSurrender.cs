...
// Type: Engine.Source.Effects.NpcPunchToSurrender
...
namespace Engine.Source.Effects
{
  ...
  public class NpcPunchToSurrender : IEffect
  {
    ...
    public bool Prepare(float currentRealTime, float currentGameTime)
    {
      ...
      component2?.PunchToSurrender(this.punchEnum, abilityController.ReactionType, abilityController.WeaponKind, component1);
      return true;
    }
