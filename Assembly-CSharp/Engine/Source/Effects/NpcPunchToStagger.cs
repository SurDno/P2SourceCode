...
// Type: Engine.Source.Effects.NpcPunchToStagger
...
namespace Engine.Source.Effects
{
  ...
  public class NpcPunchToStagger : IEffect
  {
    ...
    public bool Prepare(float currentRealTime, float currentGameTime)
    {
      ...
      component2?.PunchToStagger(this.punchEnum, abilityController.ReactionType, abilityController.WeaponKind, component1);
      return true;
    }
