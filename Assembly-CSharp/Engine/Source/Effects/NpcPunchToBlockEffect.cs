...
// Type: Engine.Source.Effects.NpcPunchToBlockEffect
...
namespace Engine.Source.Effects
{
  ...
  public class NpcPunchToBlockEffect : IEffect
  {
    ...
    public bool Prepare(float currentRealTime, float currentGameTime)
    {
      ...
      component2?.PunchToBlock(this.punchEnum, abilityController.ReactionType, abilityController.WeaponKind, component1);
      return true;
    }
