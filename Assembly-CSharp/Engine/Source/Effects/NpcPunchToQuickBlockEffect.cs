...
// Type: Engine.Source.Effects.NpcPunchToQuickBlockEffect
...
namespace Engine.Source.Effects
{
  ...
  public class NpcPunchToQuickBlockEffect : IEffect
  {
    ...
    public bool Prepare(float currentRealTime, float currentGameTime)
    {
      ...
      component2?.PunchToQuickBlock(this.punchEnum, abilityController.ReactionType, abilityController.WeaponKind, component1);
      return true;
    }
