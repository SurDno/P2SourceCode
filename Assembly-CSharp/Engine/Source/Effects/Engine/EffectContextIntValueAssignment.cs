...
// Type: Engine.Source.Effects.Engine.EffectContextIntValueAssignment
...
namespace Engine.Source.Effects.Engine
{
  ...
  public class EffectContextIntValueAssignment : EffectContextValueAssignment<int>
  {
    protected override int Compute(int a, int b) => b;
