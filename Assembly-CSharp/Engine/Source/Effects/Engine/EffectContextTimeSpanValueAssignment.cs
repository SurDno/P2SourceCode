...
// Type: Engine.Source.Effects.Engine.EffectContextTimeSpanValueAssignment
...
namespace Engine.Source.Effects.Engine
{
  ...
  public class EffectContextTimeSpanValueAssignment : EffectContextValueAssignment<TimeSpan>
  {
    protected override TimeSpan Compute(TimeSpan a, TimeSpan b) => b;
