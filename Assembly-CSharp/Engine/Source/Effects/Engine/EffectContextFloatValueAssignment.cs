...
// Type: Engine.Source.Effects.Engine.EffectContextFloatValueAssignment
...
namespace Engine.Source.Effects.Engine
{
  ...
  public class EffectContextFloatValueAssignment : EffectContextValueAssignment<float>
  {
    protected override float Compute(float a, float b) => b;
