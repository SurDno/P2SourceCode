...
public class MMNode : IMMNode, IIdSetter {
	...
	[Inspected] public MMWindow MindMap { get; set; }

	[Inspected] public Position Position { get; set; }

	[Inspected] public MMNodeKind NodeKind { get; set; }
	...
	private void Notify() {
		if (content != null) {
			var service = ServiceLocator.GetService<NotificationService>();
