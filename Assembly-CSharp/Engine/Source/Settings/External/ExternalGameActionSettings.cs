...
public class ExternalGameActionSettings : ExternalSettingsInstance<ExternalGameActionSettings> {
	...
	public List<ActionGroup> Groups_Set_1 = new();

	[DataReadProxy] [DataWriteProxy] [CopyableProxy] [Inspected(Mutable = true, Mode = ExecuteMode.EditAndRuntime)]
	public List<ActionGroup> Groups_Set_2 = new();

	[DataReadProxy] [DataWriteProxy] [CopyableProxy] [Inspected(Mutable = true, Mode = ExecuteMode.EditAndRuntime)]
	public List<ActionGroup> Groups_Set_3 = new();

	[DataReadProxy] [DataWriteProxy] [CopyableProxy()] [Inspected(Mutable = true, Mode = ExecuteMode.EditAndRuntime)]
	public List<JoystickLayout> Layouts = new();
}