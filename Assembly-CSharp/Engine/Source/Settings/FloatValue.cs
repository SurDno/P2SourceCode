...
public class FloatValue : IValue<float> {
	...
	[Inspected] private float defaultValue;
	[Inspected] private float minValue;
	[Inspected] private float maxValue;
	private float value;

	public FloatValue(string name, float defaultValue = 0.0f, float minValue = -3.40282347E+38f,
