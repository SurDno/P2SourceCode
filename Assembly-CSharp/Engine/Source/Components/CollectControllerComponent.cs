...
public class CollectControllerComponent :
	...
	[FromThis] private DynamicModelComponent model = null;
	[FromThis] private ParametersComponent parameters = null;
	...
	public void Collect() {
		...
		var component1 = itemEntity.Value?.GetComponent<IStorableComponent>();
		if (component1 != null) {
			var component2 = ServiceLocator.GetService<ISimulation>().Player?.GetComponent<IStorageComponent>();
			if (component2 != null) {
				var entity = ServiceLocator.GetService<IFactory>().Instantiate(component1.Owner);
				...
				ServiceLocator.GetService<NotificationService>()
					.AddNotify(NotificationEnum.ItemRecieve, component1.Owner);
			}
		}
		...
		ServiceLocator.GetService<ISimulation>().Player.GetComponent<PlayerControllerComponent>()
			?.ComputeAction(ActionEnum.CollectItem);
	}
	...
	public void ComputeUpdate() {
		if (model == null || collectedParameter == null)
			return;
		var flag = !collectedParameter.Value;
