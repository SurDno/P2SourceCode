...
public class FastTravelComponent : EngineComponent, IFastTravelComponent, IComponent {
	...
	[Inspected] public IParameterValue<bool> CanFastTravel { get; } = new ParameterValue<bool>();

	[Inspected]
	public IParameterValue<FastTravelPointEnum> FastTravelPointIndex { get; } =
		new ParameterValue<FastTravelPointEnum>();

	[Inspected] public IParameterValue<int> FastTravelPrice { get; } = new ParameterValue<int>();
	...
	public void FireTravelToPoint(FastTravelPointEnum target, TimeSpan travelTime) {
		var travelToPoint = TravelToPoint;
