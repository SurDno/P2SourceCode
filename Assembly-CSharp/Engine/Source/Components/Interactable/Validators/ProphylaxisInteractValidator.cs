...
internal class ProphylaxisInteractValidator {
	...
	public static ValidateResult Validate(IInteractableComponent interactable, InteractItem item) {
		...
		var byName4 = component.GetByName<bool>(ParameterNameEnum.ImmuneBoostAttempted);
		return byName4 != null && byName4.Value
			? new ValidateResult(false, "ImmuneBoostAttempted is true")
