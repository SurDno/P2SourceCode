...
public class TradeInteractValidator {
	...
	public static ValidateResult Validate(IInteractableComponent interactable, InteractItem item) {
		...
		var component3 = player.GetComponent<ParametersComponent>();
		if (component3 == null)
			return new ValidateResult(true, "ParametersComponent not found");
		var byName5 = component3.GetByName<bool>(ParameterNameEnum.CanTrade);
		if (byName5 != null && !byName5.Value)
			return new ValidateResult(false, "CanTrade is false");
		var component4 = player.GetComponent<ILocationItemComponent>();
		var component5 = interactable.GetComponent<ILocationItemComponent>();
		if (component5 == null)
			return new ValidateResult(false, "ILocationItemComponent not found");
		return !LocationItemUtility.CheckLocation(component5, component4)
