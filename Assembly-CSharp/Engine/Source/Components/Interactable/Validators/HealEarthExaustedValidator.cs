...
public class HealEarthExaustedValidator {
	...
	public static ValidateResult Validate(IInteractableComponent interactable, InteractItem item) {
		var component = interactable.Owner.GetComponent<HerbRootsComponent>();
		if (component == null)
			return new ValidateResult(false, "HerbRootsComponent not found");
		return !component.IsHerbsbudgetReached
			? new ValidateResult(false, "IsHerbsbudgetReached is false")
