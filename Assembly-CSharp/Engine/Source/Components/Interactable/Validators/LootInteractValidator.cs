...
public class LootInteractValidator {
	...
	public static ValidateResult Validate(IInteractableComponent interactable, InteractItem item) {
		...
		var byName1 = component.GetByName<bool>(ParameterNameEnum.Surrender);
		if (byName1 != null && byName1.Value)
			return new ValidateResult(true, "Surrender is true");
		var byName2 = component.GetByName<bool>(ParameterNameEnum.Dead);
		return byName2 != null && byName2.Value
			? new ValidateResult(true, "Dead is false")
