...
public static class MarkDoorInteractValidator {
	...
	public static ValidateResult Validate(IInteractableComponent interactable, InteractItem item) {
		...
		var component2 = interactable.GetComponent<IDoorComponent>();
		if (component2 == null)
		...
		return !player.GetComponent<StorageComponent>().Items.Any(x => x.Groups.Contains(StorableGroup.Chalk))
			? new ValidateResult(false, "CanBeMarked not found")
