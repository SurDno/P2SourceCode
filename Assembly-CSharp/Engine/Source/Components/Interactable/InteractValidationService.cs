...
public static class InteractValidationService {
	private static Dictionary<InteractType, Func<IInteractableComponent, InteractItem, ValidateResult>> validators =
		new();
	...
	public static ValidateResult Validate(IInteractableComponent interactable, InteractItem item) {
		...
		return validators.TryGetValue(item.Type, out func)
			? func(interactable, item)
			: new ValidateResult(true, "Validator not found");
	}
}