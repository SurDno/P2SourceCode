...
public class NoGCMemoryStrategy : IMemoryStrategy {
	public IEnumerator Compute(MemoryStrategyContextEnum context) {
		...
		else if (context == MemoryStrategyContextEnum.StartGame || context == MemoryStrategyContextEnum.EntryToIndoor ||
		         context == MemoryStrategyContextEnum.ChangeLocation || context == MemoryStrategyContextEnum.Time) {
