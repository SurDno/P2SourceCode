...
public class DeadBurningAbilityController : IAbilityController, IChangeParameterListener {
	...
	public void Initialise(AbilityItem abilityItem) {
		...
		var component = this.abilityItem.Ability.Owner.GetComponent<ParametersComponent>();
	...
	private void CheckParameters() {
		if (burningParameter == null || healthParameter == null || !burningParameter.Value ||
		    healthParameter.Value > 0.0)
			return;
