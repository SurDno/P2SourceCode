...
public struct Intersect {
	[Inspected] public bool IsIntersected;
	[Inspected] public bool IsAllowed;
	...
	[Inspected] public List<CellInfo> Cells;
	[Inspected] public HashSet<StorableComponent> Storables;
