...
// Type: Engine.Source.Blueprints.OpenLootWindowNode
...
{
  [Category("Engine")]
  public class OpenLootWindowNode : FlowControlNode
  {
    ...
    protected override void RegisterPorts()
    {
      ...
      this.AddFlowInput("In", (FlowHandler) (() =>
      {
        ...
        if (target == null)
          return;
        UIServiceUtility.PushWindow<ILootWindow>(output, (Action<ILootWindow>) (window =>
        {
