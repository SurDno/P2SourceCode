...
public class ParameterNode : FlowControlNode {
	...
	[Port("Parameter")] private ValueInput<ParameterNameEnum> parameterInput;
	[Port("DefaultValue")] private ValueInput<float> defaultValue;
	...
	private float Value() {
		...
		if (component == null)
			return defaultValue.value;
		var byName1 = component.GetByName<float>(parameterInput.value);
		var byName2 = component.GetByName<bool>(parameterInput.value);
