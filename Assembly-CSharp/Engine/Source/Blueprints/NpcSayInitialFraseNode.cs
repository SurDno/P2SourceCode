...
public class NpcSayInitialFraseNode : FlowControlNode {
	...
	protected override void RegisterPorts() {
		...
		AddFlowInput("In", () => {
			var speakingComponent = targetInput.value;
			if (speakingComponent != null) {
				var component = speakingComponent.Owner.GetComponent<LipSyncComponent>();
				if (component != null && !component.IsPlaying)
					component.Play3D(speakingComponent.InitialPhrases.Random(), minDistance.value, maxDistance.value,
						true);
			}
