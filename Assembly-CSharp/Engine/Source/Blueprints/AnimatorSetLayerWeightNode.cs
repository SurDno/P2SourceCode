...
public class AnimatorSetLayerWeightNode : FlowControlNode {
	...
	[Port("LayerName")] private ValueInput<string> layerNameInput;
	[Port("LayerWeight")] private ValueInput<float> layerWeightInput;
	...
	private void In() {
		...
		if (animator != null) {
			var layerIndex = animator.GetLayerIndex(layerNameInput.value);
