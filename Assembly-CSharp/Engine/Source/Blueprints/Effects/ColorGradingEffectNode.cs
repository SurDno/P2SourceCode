  ...
  public class ColorGradingEffectNode : FlowControlNode, IUpdatable
  {
    ...
    public void Update()
    {
      ...
      else
      {
        ...
        Color color3 = blueColorInput.value;
