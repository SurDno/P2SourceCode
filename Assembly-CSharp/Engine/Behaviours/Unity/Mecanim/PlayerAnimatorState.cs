...
namespace Engine.Behaviours.Unity.Mecanim
{
  public class PlayerAnimatorState
  {
    ...
    public void Unholster() => Animator.SetTrigger("Triggers/Unholster");

    public void Holster() => Animator.SetTrigger("Triggers/Holster");
    ...
    public void Push() => Animator.SetTrigger("Triggers/Push");

    public void RiflePush() => Animator.SetTrigger("Triggers/RiflePush");
    ...
    public void RifleShotCancel() => Animator.SetTrigger("Triggers/RifleShotCancel");

    public void RifleAim(bool aim) => Animator.SetBool("RifleIsAiming", aim);
    ...
    public void RifleUnholster() => Animator.SetTrigger("Triggers/RifleUnholster");

    public void RifleHolster() => Animator.SetTrigger("Triggers/RifleHolster");
    ...
    public void ShotgunPush() => Animator.SetTrigger("Triggers/ShotgunPush");
    ...
    public void ShotgunShotCancel() => Animator.SetTrigger("Triggers/ShotgunShotCancel");

    public void ShotgunAim(bool aim) => Animator.SetBool("ShotgunIsAiming", aim);
    ...
    public void ShotgunUnholster() => Animator.SetTrigger("Triggers/ShotgunUnholster");

    public void ShotgunHolster() => Animator.SetTrigger("Triggers/ShotgunHolster");
    ...
    public void RevolverPush() => Animator.SetTrigger("Triggers/RevolverPush");
    ...
    public void RevolverShotCancel() => Animator.SetTrigger("Triggers/RevolverShotCancel");

    public void RevolverAim(bool aim) => Animator.SetBool("RevolverIsAiming", aim);
    ...
    public void RevolverUnholster() => Animator.SetTrigger("Triggers/RevolverUnholster");

    public void RevolverHolster() => Animator.SetTrigger("Triggers/RevolverHolster");
    ...
    public void FlashlightPunch() => Animator.SetTrigger("Triggers/FlashlightPunch");
    ...
    public void FlashlightFire() => Animator.SetTrigger("Triggers/FlashlightFire");

    public void FlashlightUnholster() => Animator.SetTrigger("Triggers/FlashlightUnholster");

    public void FlashlightHolster() => Animator.SetTrigger("Triggers/FlashlightHolster");
