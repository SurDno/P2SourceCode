...
public class PivotPlayer : MonoBehaviour {
	...
	[Header("Revolver")] [Tooltip("Cам объект револьвера (базовый в иерархии револьвера)")]
	...
	[Header("Rifle")] [Tooltip("Cам объект винтовки (базовый в иерархии винтовки)")]
	public GameObject RifleGeometry;

	public ParticleBurster RifleShot;
	public GameObject RifleAmmo;

	[Header("Shotgun")] [Tooltip("Cам объект ружья (базовый в иерархии ружья)")]
	...
	[Header("Knife")] public GameObject KnifeGeometry;
	[Header("Scalpel")] public GameObject ScalpelGeometry;
	public List<GameObject> ScalpelCustomGeometry;
	[Header("Lockpick")] public GameObject LockpickGeometry;

	[Header("Visir")] [Tooltip("Cам объект визира (базовый в иерархии револьвера)")]
	...
	[Header("Flashlight")] public GameObject FlashlightGeometry;
	...
	[Header("Camera")] [Tooltip("Кость, которая врашается управлением, чтобы правильно развернут камеру.")]
	...
	public void SetScalpelCustomGeometryVisible(int kind) {
		foreach (var gameObject in ScalpelCustomGeometry)
	...
	public void MoveFlashlightToJointAnchorPosition() {
		var component1 = FlashlightGeometry.GetComponent<Rigidbody>();
		foreach (var component2 in FlashlightJoint.gameObject.GetComponents<CharacterJoint>())
