...
public class SceneObjectItem {
	[DataReadProxy] [DataWriteProxy] [Inspected(Header = true, Mode = ExecuteMode.EditAndRuntime)]
	public Guid Id;

	[DataReadProxy] [DataWriteProxy] [Inspected(Mode = ExecuteMode.EditAndRuntime)]
