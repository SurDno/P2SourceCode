...
public class Factory : IFactory {
	[Inspected] private static Dictionary<Type, Type> implements = new();

	public static void RegisterType(Type factory, Type face) {
		implements[face] = factory;
	}
	...
	public T Create<T>(Guid id) where T : class {
