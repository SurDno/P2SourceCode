...
public class SingleItemContainerView : ContainerView, IChangeParameterListener {
	[SerializeField] private ItemView storableView;
	[SerializeField] private HoldableButton2 buttonClosed;
	[SerializeField] private HideableView hideableView;
	[SerializeField] private HideableView hideableViewOpen;
	[SerializeField] private HideableView hideableViewClosed;
	...
	private void UpdateState() {
		...
		var openState = Container?.OpenState;
