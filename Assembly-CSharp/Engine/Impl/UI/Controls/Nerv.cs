...
public class Nerv : UIControl {
	...
	[SerializeField] [FormerlySerializedAs("_Localizer")]
	private Localizer localizer;

	[SerializeField] [FormerlySerializedAs("_Threshold_IsEnabled")]
	private bool thresholdIsEnabled;

	[Range(0.0f, 1f)] [SerializeField] [FormerlySerializedAs("_Threshold_Max")]
	private float thresholdMax = 1f;

	[Range(0.0f, 1f)] [SerializeField] [FormerlySerializedAs("_Threshold_Min")]
	private float thresholdMin;

	[SerializeField] private ParameterNameEnum parameterName;
	[SerializeField] private Color minBaseColor;
	[SerializeField] private Color minFillColor;
	[SerializeField] private Color maxBaseColor;
	...
	public bool Threshold {
		...
		protected set {
			...
			var thresholdEvent = ThresholdEvent;
