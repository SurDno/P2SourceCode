...
public class InfoGraphic : UIControl {
	...
	[SerializeField] [FormerlySerializedAs("_Unity_Background_Default")]
	private Image unityBackgroundDefault;

	[SerializeField] [FormerlySerializedAs("_Unity_Background_Price")]
	private Image unityBackgroundPrice;

	[SerializeField] [FormerlySerializedAs("_Unity_Image")]
	private Image unityImage;

	[SerializeField] [FormerlySerializedAs("_Unity_Information")]
	private Text unityInformation;

	[SerializeField] [FormerlySerializedAs("_Unity_Name")]
	private Text unityName;

	[SerializeField] [FormerlySerializedAs("_Unity_Price")]
	...
	public static InfoGraphic Instantiate(bool withPrice, GameObject prefab) {
		...
		var component = gameObject.GetComponent<InfoGraphic>();
		if (withPrice) {
