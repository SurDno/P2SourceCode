...
public class StartWindow : UIWindow, IStartWindow, IWindow, IMainMenu {
	...
	[SerializeField] private Button newMarbleNestGameButton;
	[SerializeField] private Button loadGameButton;
	[SerializeField] private Button settingsButton;
	[SerializeField] private Button creditsButton;
	[SerializeField] private Button exitButton;
	[SerializeField] private string marbleNestGameDataName;
	...
	public void ContinueGame() {
		var lastSaveName = ServiceLocator.GetService<ProfilesService>().GetLastSaveName();
	...
	public void NewGame() {
		CoroutineService.Instance.Route(LoadGameUtility.StartNewGame());
	}
	...
	protected override void OnJoystick(bool joystick) {
		...
		if (joystick) {
			if (currentIndex != 0)
				...
				EventSystem.current.SetSelectedGameObject(continueButton.gameObject.activeSelf
	...
	private void SetSelectionLine() {
		...
		var component = selectedGameObject != null ? selectedGameObject.GetComponent<Text>() : null;
		var flag = component != null && InputService.Instance.JoystickUsed;
		selectedLine.enabled = flag;
		if (!flag)
			return;
		var sizeDelta = selectedLine.rectTransform.sizeDelta;
	...
	private void UpdateContinueButton() {
		...
		continueButton.gameObject.SetActive(
			ProfilesUtility.IsSaveExist(ServiceLocator.GetService<ProfilesService>().GetLastSaveName()));
	}
}