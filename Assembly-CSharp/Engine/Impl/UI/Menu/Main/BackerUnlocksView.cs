...
public class BackerUnlocksView : SettingsView {
	...
	[SerializeField] private MenuInputField inputFieldPrefab;
	...
	[SerializeField] private GameObject xboxKeyboard;
	...
	public void Fill() {
		...
		if (!backerUnlocksService.PolyhedralRoomUnlocked)
			return;
		var settingsItemView1 = Instantiate(selectableViewPrefab, layout.Content, false);
