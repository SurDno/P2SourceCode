...
namespace Engine.Impl.UI.Menu.Main
{
  public class BackerUnlocksView : SettingsView
  {
    ...
    protected override void Awake()
    {
      ...
      inputField = UnityEngine.Object.Instantiate<MenuInputField>(inputFieldPrefab, (Transform) layout.Content, false);
    ...
    public void Fill()
    {
      ...
      {
        SelectableSettingsItemView settingsItemView = UnityEngine.Object.Instantiate<SelectableSettingsItemView>(selectableViewPrefab, (Transform) layout.Content, false);
      ...
      if (!backerUnlocksService.PolyhedralRoomUnlocked)
        return;
      SelectableSettingsItemView settingsItemView1 = UnityEngine.Object.Instantiate<SelectableSettingsItemView>(selectableViewPrefab, (Transform) layout.Content, false);
