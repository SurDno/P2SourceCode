...
public class GraphicsSettingsView : SettingsView {
	...
	protected override void Awake() {
		...
		var instance = ScriptableObjectInstance<GraphicSettingsData>.Instance;
		...
		var fieldOfViewView = this.fieldOfViewView;
		fieldOfViewView.VisibleValueChangeEvent =
			fieldOfViewView.VisibleValueChangeEvent + GraphicSettingsHelper.OnAutoValueChange;
		var length1 = instance.TextureSettings.Length;
		var names1 = new string[length1];
		var num = instance.MaxSupportedTextureSettings();
		for (var index = 0; index < length1; ++index) {
			var str = "{UI.Menu.Main.Settings.Graphics.TextureQuality." + index + "}";
			if (index > num)
		...
		var textureQualityView = this.textureQualityView;
		textureQualityView.VisibleValueChangeEvent =
			textureQualityView.VisibleValueChangeEvent + GraphicSettingsHelper.OnAutoValueChange;
		Instantiate(separatorPrefab, layout.Content, false);
		var length2 = instance.Presets.Length;
		var names2 = new string[length2 + 1];
		...
		var qualityView = this.qualityView;
		...
		var aiLodDistanceView = this.aiLodDistanceView;
		aiLodDistanceView.VisibleValueChangeEvent =
			aiLodDistanceView.VisibleValueChangeEvent + GraphicSettingsHelper.OnAutoValueChange;
		...
		var anisotropicFilteringView = this.anisotropicFilteringView;
		anisotropicFilteringView.VisibleValueChangeEvent = anisotropicFilteringView.VisibleValueChangeEvent +
		                                                   GraphicSettingsHelper.OnAutoValueChange;
		var length3 = instance.ShadowSettings.Length;
		var names3 = new string[length3];
		...
		var shadowQualityView = this.shadowQualityView;
		shadowQualityView.VisibleValueChangeEvent =
			shadowQualityView.VisibleValueChangeEvent + GraphicSettingsHelper.OnAutoValueChange;
		...
		var shadowDistanceView = this.shadowDistanceView;
		shadowDistanceView.VisibleValueChangeEvent =
			shadowDistanceView.VisibleValueChangeEvent + GraphicSettingsHelper.OnAutoValueChange;
		...
		var contactShadowsView = this.contactShadowsView;
		contactShadowsView.VisibleValueChangeEvent =
			contactShadowsView.VisibleValueChangeEvent + GraphicSettingsHelper.OnAutoValueChange;
		...
		var aoFieldsView = this.aoFieldsView;
		aoFieldsView.VisibleValueChangeEvent =
			aoFieldsView.VisibleValueChangeEvent + GraphicSettingsHelper.OnAutoValueChange;
		...
		var antialiasingView = this.antialiasingView;
		antialiasingView.VisibleValueChangeEvent =
			antialiasingView.VisibleValueChangeEvent + GraphicSettingsHelper.OnAutoValueChange;
		...
		var additionalReflectionsView = this.additionalReflectionsView;
		additionalReflectionsView.VisibleValueChangeEvent = additionalReflectionsView.VisibleValueChangeEvent +
		                                                    GraphicSettingsHelper.OnAutoValueChange;
		...
		var motionBlurView = this.motionBlurView;
		motionBlurView.VisibleValueChangeEvent =
			motionBlurView.VisibleValueChangeEvent + GraphicSettingsHelper.OnAutoValueChange;
		...
		var softParticlesView = this.softParticlesView;
		softParticlesView.VisibleValueChangeEvent =
			softParticlesView.VisibleValueChangeEvent + GraphicSettingsHelper.OnAutoValueChange;
		...
		var volumetricLightingView = this.volumetricLightingView;
		volumetricLightingView.VisibleValueChangeEvent = volumetricLightingView.VisibleValueChangeEvent +
		                                                 GraphicSettingsHelper.OnAutoValueChange;
		base.Awake();
	}

	private void OnQualityChange(SettingsValueView<int> view) {
		var presets = ScriptableObjectInstance<GraphicSettingsData>.Instance.Presets;
		if (view.VisibleValue >= presets.Length)
			return;
		presets[view.VisibleValue].Apply();
	}

	private string LodValueName(float value) {
		return value.ToString("F1");
	}

	private float LodValueValidation(float value) {
