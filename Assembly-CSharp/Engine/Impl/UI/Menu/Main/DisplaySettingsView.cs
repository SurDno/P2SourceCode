...
public class DisplaySettingsView : SettingsView {
	...
	[SerializeField] private float confirmationTime = 10f;
	[SerializeField] private GameObject applyButtonTipObject;
	private List<string> names = new();
	private List<int> resolutionHeights = new();
	private List<int> resolutionWidths = new();
	...
	protected override void Awake() {
		...
		var fullScreenModeView = this.fullScreenModeView;
		...
		var resolutionView = this.resolutionView;
		...
		var renderScaleView = this.renderScaleView;
	...
	private void OnSliderChange<T>(SettingsValueView<T> view) {
		ResetApplyButton();
	}
	...
	private void OnApplyButtonClick() {
		...
		var fullscreenMode = prevFullScreenMode;
		...
		var visibleValue = resolutionView.VisibleValue;
	...
	private void ResetSliders() {
		...
		foreach (var resolution in Screen.resolutions)
			if (resolution.height >= 720) {
				var flag2 = false;
				for (var index = 0; index < resolutionWidths.Count; ++index)
