...
public class GameWindow : UIWindow, IGameWindow, IWindow, IPauseMenu {
	[Header("Main menu")] [SerializeField] [FormerlySerializedAs("Button_NewGame")]
	...
	[SerializeField] private ConfirmationWindow exitConfirmationPrefab;
	...
	public void Button_BackToGame_Click_Handler() {
	...
	public void Button_ExitGame_Click_Handler() {
		ShowExitConfirmation(Exit);
	}
	...
	private bool ChangeSelectedItem(GameActionType type, bool down) {
		if (!helpPanel.activeInHierarchy ||
		    (exitConfirmationInstance != null && exitConfirmationInstance.gameObject.activeInHierarchy))
			return false;
