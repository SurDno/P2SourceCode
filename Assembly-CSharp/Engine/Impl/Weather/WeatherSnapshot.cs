...
public class WeatherSnapshot :
	...
	IObject {
	[DataReadProxy(MemberEnum.OnlyCopy)] [DataWriteProxy] [CopyableProxy(MemberEnum.OnlyCopy)] [Inspected]
	...
	public void Blend(IWeatherSnapshot aa, IWeatherSnapshot bb, IPureBlendOperation op) {
		var weatherSnapshot1 = (WeatherSnapshot)aa;
		var weatherSnapshot2 = (WeatherSnapshot)bb;
