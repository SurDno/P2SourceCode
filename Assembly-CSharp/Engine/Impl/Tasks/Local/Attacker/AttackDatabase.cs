...
public static class AttackDatabase {
	...
	public static float GetAttackImportantPhaseTime(NPCAttackKind attackKind) {
		return 1.05f;
	}

	public static float GetReactionImportantPhaseTime(NPCAttackKind attackKind) {
		return 1.05f;
	}
	...
	public static float GetSyncTime(AttackKind attackKind, bool fatalityStage) {
		if (attackKind == AttackKind.FrontPush || attackKind == AttackKind.FrontPunch ||
		    attackKind == AttackKind.FrontDodgeCounterPunch)
			return 0.3f;
		throw new NotImplementedException();
	}

	public static float GetSyncTime(PlayerAttackKind attackKind) {
		return 0.3f;
	}

	public static float GetSyncTime(NPCAttackKind attackKind) {
		return 0.3f;
	}

	public static float GetSyncTime(PlayerPushesDiseasedKind attackKind) {
		return 0.3f;
	}
	...
	public static bool CanReactionMove(AttackKind attackKind) {
		return true;
	}

	public static bool CanReactionMove(NPCAttackKind attackKind) {
		return true;
	}

	public static bool CanReactionToPlayerMove(PlayerAttackKind attackKind) {
		return true;
	}
	...
	public static bool CanReactionToPlayerMove(PlayerPushesDiseasedKind attackKind) {
		return true;
	}
}