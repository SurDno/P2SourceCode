...
// Type: Engine.BehaviourNodes.Conditionals.IsHealedSuccessfully
...
{
  [TaskDescription("Is NPC healed successfully? (use null Target to check self)")]
  [TaskCategory("Pathologic")]
  [Factory]
  [GeneratePartial(TypeEnum.Cloneable | TypeEnum.Copyable | TypeEnum.DataRead | TypeEnum.DataWrite)]
  [FactoryProxy(typeof (IsHealedSuccessfully))]
  public class IsHealedSuccessfully : Conditional, IStub, ISerializeDataWrite, ISerializeDataRead
  {
    ...
    public override TaskStatus OnUpdate()
    {
      ...
      if (component != null)
      {
        IParameter<bool> byName = component.GetByName<bool>(ParameterNameEnum.HealingSuccessfull);
        if (byName != null)
