...
// Type: Engine.BehaviourNodes.Conditionals.IsHealed
...
{
  [TaskDescription("Is NPC healing attempted? (use null Target to check self)")]
  [TaskCategory("Pathologic")]
  [Factory]
  [GeneratePartial(TypeEnum.Cloneable | TypeEnum.Copyable | TypeEnum.DataRead | TypeEnum.DataWrite)]
  [FactoryProxy(typeof (IsHealed))]
  public class IsHealed : Conditional, IStub, ISerializeDataWrite, ISerializeDataRead
  {
    ...
    public override TaskStatus OnUpdate()
    {
      ...
      if (component != null)
      {
        IParameter<bool> byName = component.GetByName<bool>(ParameterNameEnum.HealingAttempted);
        if (byName != null)
