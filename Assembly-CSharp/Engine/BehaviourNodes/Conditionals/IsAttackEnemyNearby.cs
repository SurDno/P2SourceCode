...
public class IsAttackEnemyNearby : Conditional, IStub, ISerializeDataWrite, ISerializeDataRead {
	...
	public override TaskStatus OnUpdate() {
		...
		var serviceCharacterInfo = combatService.GetCharacterInfo(entity)?.AttackEnemyNearby();
		var flag = false;
		if (serviceCharacterInfo != null && serviceCharacterInfo.Character != null &&
		    serviceCharacterInfo.Character.transform != null) {
