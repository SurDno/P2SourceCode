...
public class IsInNpcState : Conditional, IStub, ISerializeDataWrite, ISerializeDataRead {
	...
	public override TaskStatus OnUpdate() {
		var component = gameObject.GetComponent<NpcState>();
		return component == null ? TaskStatus.Failure :
			component.CurrentNpcState == npcState ? TaskStatus.Success : TaskStatus.Failure;
	}
