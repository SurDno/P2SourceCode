...
// Type: Engine.BehaviourNodes.Conditionals.CanFight
...
namespace Engine.BehaviourNodes.Conditionals
{
  ...
  public class CanFight : Conditional, IStub, ISerializeDataWrite, ISerializeDataRead
  {
    public override TaskStatus OnUpdate()
    {
      ...
      return individualCombatSettings == null ? TaskStatus.Failure : (individualCombatSettings.CanFight ? TaskStatus.Success : TaskStatus.Failure);
    }
