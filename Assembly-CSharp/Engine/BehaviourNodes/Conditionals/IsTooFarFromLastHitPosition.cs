...
// Type: Engine.BehaviourNodes.Conditionals.IsTooFarFromLastHitPosition
...
namespace Engine.BehaviourNodes.Conditionals
{
    ...
    ISerializeDataRead
  {
    ...
    {
      return this.owner == null ? TaskStatus.Failure : ((double) (this.owner.LastGotHitPosition - this.gameObject.transform.position).magnitude > (double) this.Distance ? TaskStatus.Success : TaskStatus.Failure);
    }
