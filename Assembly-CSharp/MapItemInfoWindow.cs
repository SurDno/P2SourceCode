...
public class MapItemInfoWindow : MonoBehaviour
{
  ...
  public void Show(MapItemView itemView)
  {
    ...
    if (component != null)
    {
      ...
      portraitImage.sprite = BoundCharacterUtility.StateSprite(component, boundHealthStateEnum) ?? fallbackPortraitSprite;
    ...
    icons.SetActive(craftIcon.activeSelf || saveIcon.activeSelf || sleepIcon.activeSelf || storeIcon.activeSelf || tradeIcon.activeSelf);
    UpdatePosition();
  }
