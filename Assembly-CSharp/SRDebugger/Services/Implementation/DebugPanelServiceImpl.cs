...
public class DebugPanelServiceImpl : ScriptableObject, IDebugPanelService {
	...
	public DefaultTabs? ActiveTab => _debugPanelRootObject == null
		? new DefaultTabs?()
		: _debugPanelRootObject.TabController.ActiveTab;
	...
	private void Load() {
		var prefab = Resources.Load<DebugPanelRoot>("SRDebugger/UI/Prefabs/DebugPanel");
		if (prefab == null)
