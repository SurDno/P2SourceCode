...
public class Settings : ScriptableObject {
	...
	[SerializeField] private KeyboardShortcut[] _newKeyboardShortcuts = new KeyboardShortcut[0];
	...
	private void UpgradeKeyboardShortcuts() {
		...
		var keyboardShortcutList = new List<KeyboardShortcut>();
		for (var index = 0; index < _keyboardShortcuts.Length; ++index) {
			var keyboardShortcut = _keyboardShortcuts[index];
	...
	public PinAlignment ProfilerAlignment {
		...
		set {
			if (value == PinAlignment.CenterRight || value == PinAlignment.CenterLeft ||
				...
				var profilerAlignment = _profilerAlignment;
	...
	private static Settings GetOrCreateInstance() {
		var instance = Resources.Load<Settings>("SRDebugger/Settings");
		if (instance == null)
