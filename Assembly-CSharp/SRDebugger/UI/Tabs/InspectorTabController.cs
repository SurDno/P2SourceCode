...
public class InspectorTabController : SRMonoBehaviour {
	...
	public static Rect RectTransformToScreenSpace(RectTransform transform) {
		var vector2 = Vector2.Scale(transform.rect.size, transform.lossyScale);
		var screenSpace = new Rect(transform.position.x, Screen.height - transform.position.y, vector2.x, vector2.y);
