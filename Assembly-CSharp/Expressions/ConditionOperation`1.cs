...
public abstract class ConditionOperation<T> : IValue<T> where T : struct {
	...
	public T GetValue(IEffect context) {
		return condition != null && trueResult != null && falseResult != null
			? condition.GetValue(context) ? trueResult.GetValue(context) : falseResult.GetValue(context)
			: default;
	}

	public string ValueView => "(" + (condition != null ? condition.ValueView : "null") + " ? " +
	                           (trueResult != null ? trueResult.ValueView : "null") + " : " +
	                           (falseResult != null ? falseResult.ValueView : "null") + ")";

	public string TypeView => "(" + (condition != null ? condition.TypeView : "null") + " ? " +
	                          (trueResult != null ? trueResult.TypeView : "null") + " : " +
	                          (falseResult != null ? falseResult.TypeView : "null") + ")";
}