...
public class PreIntegratedSkinProfile : ScriptableObject {
	...
	[HideInInspector] public bool needsRecalcDerived = true;
	[HideInInspector] public bool needsRenormalize = true;
	...
	public void RecalculateDerived() {
		...
		var vector3_1 = zero + gauss61 + gauss62 + gauss63 + gauss64 + gauss65 + gauss66;
		...
		var grayscale1 = new Color(gauss61.x, gauss61.y, gauss61.z).grayscale;
		var grayscale2 = new Color(gauss62.x, gauss62.y, gauss62.z).grayscale;
		var grayscale3 = new Color(gauss63.x, gauss63.y, gauss63.z).grayscale;
		var grayscale4 = new Color(gauss64.x, gauss64.y, gauss64.z).grayscale;
		var grayscale5 = new Color(gauss65.x, gauss65.y, gauss65.z).grayscale;
		var grayscale6 = new Color(gauss66.x, gauss66.y, gauss66.z).grayscale;
		...
		_PSSProfileMedium_weighths1_var1 = new Vector4(gauss61.x + gauss62.x, gauss61.y + gauss62.y,
			gauss61.z + gauss62.z,
			(float)((gauss6_1.w * (double)grayscale1 + gauss6_2.w * (double)grayscale2) /
			        (grayscale1 + (double)grayscale2)));
		_PSSProfileMedium_weighths2_var2 = new Vector4(gauss63.x + gauss64.x, gauss63.y + gauss64.y,
			gauss63.z + gauss64.z,
			(float)((gauss6_3.w * (double)grayscale3 + gauss6_4.w * (double)grayscale4) /
			        (grayscale3 + (double)grayscale4)));
		_PSSProfileMedium_weighths3_var3 = new Vector4(gauss65.x + gauss66.x, gauss65.y + gauss66.y,
			gauss65.z + gauss66.z,
			(float)((gauss6_5.w * (double)grayscale5 + gauss6_6.w * (double)grayscale6) /
			        (grayscale5 + (double)grayscale6)));
		_PSSProfileLow_weighths1_var1 = new Vector4(gauss61.x + gauss62.x + gauss63.x,
			gauss61.y + gauss62.y + gauss63.y, gauss61.z + gauss62.z + gauss63.z,
			(float)((gauss6_1.w * (double)grayscale1 + gauss6_2.w * (double)grayscale2 +
			         gauss6_3.w * (double)grayscale3) / (grayscale1 + (double)grayscale2 + grayscale3)));
		_PSSProfileLow_weighths2_var2 = new Vector4(gauss64.x + gauss65.x + gauss66.x,
			gauss64.y + gauss65.y + gauss66.y, gauss64.z + gauss65.z + gauss66.z,
			(float)((gauss6_4.w * (double)grayscale4 + gauss6_5.w * (double)grayscale5 +
			         gauss6_6.w * (double)grayscale6) / (grayscale4 + (double)grayscale5 + grayscale6)));
		...
		Vector3 vector3_2;
		vector3_2.x = (float)(gauss6_1.w * (double)gauss61.x + gauss6_2.w * (double)gauss62.x +
		                      gauss6_3.w * (double)gauss63.x + gauss6_4.w * (double)gauss64.x +
		                      gauss6_5.w * (double)gauss65.x + gauss6_6.w * (double)gauss66.x);
		vector3_2.y = (float)(gauss6_1.w * (double)gauss61.y + gauss6_2.w * (double)gauss62.y +
		                      gauss6_3.w * (double)gauss63.y + gauss6_4.w * (double)gauss64.y +
		                      gauss6_5.w * (double)gauss65.y + gauss6_6.w * (double)gauss66.y);
		vector3_2.z = (float)(gauss6_1.w * (double)gauss61.z + gauss6_2.w * (double)gauss62.z +
		                      gauss6_3.w * (double)gauss63.z + gauss6_4.w * (double)gauss64.z +
		                      gauss6_5.w * (double)gauss65.z + gauss6_6.w * (double)gauss66.z);
