...
public class CraftBrewingSlotAnchor : MonoBehaviour {
	[SerializeField] private IEntitySerializable containerTemplate;
	[SerializeField] private float durabilityThreshold;
	...
	public void SetTarget(IEntity target) {
		if (target == null)
			...
			var component = target.GetComponent<IStorageComponent>();
			var containerByTemplate = component != null
				? StorageUtility.GetContainerByTemplate(component, containerTemplate.Value)
				: null;
