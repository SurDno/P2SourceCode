...
public class InputSettingsData : ScriptableObjectInstance<InputSettingsData> {
	[Header("Player")] [GetSetConsoleCommand("walk_speed")]
	public float WalkSpeed;

	[GetSetConsoleCommand("walk_back_speed")]
	public float WalkBackSpeed;

	[GetSetConsoleCommand("run_speed")] public float RunSpeed;

	[GetSetConsoleCommand("run_back_speed")]
	public float RunBackSpeed;

	[GetSetConsoleCommand("sneak_speed")] public float SneakSpeed;
	[GetSetConsoleCommand("jump_speed")] public float JumpSpeed;

	[GetSetConsoleCommand("gravity_multiplier")]
	public float GravityMultiplier;

	[Header("Player fight speeds")] [GetSetConsoleCommand("fight_forward_speed")]
	...
	[Header("Player fight sneak speeds")] [GetSetConsoleCommand("fight_forward_sneak_speed")]
	...
	[Header("Player fight run speeds")] [GetSetConsoleCommand("fight_forward_run_speed")]
