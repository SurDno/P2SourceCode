...
public class RainManager : MonoBehaviour {
	...
	[Header("Controls")] [Range(0.0f, 1f)] public float rainIntensity;
	...
	[Header("State")] [Range(0.0f, 1f)] public float actualRainIntensity;
	[Range(0.0f, 1f)] public float terrainWetness;
	[Range(0.0f, 1f)] public float puddleWetness;
	...
	private void Update() {
		...
		var num = terrainWetness * (float)(0.5 + actualRainIntensity * 0.5);
