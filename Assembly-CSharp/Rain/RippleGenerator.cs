...
public class RippleGenerator : MonoBehaviour {
	...
	private void Update() {
		...
		_jitteredWindVector = Vector2.SmoothDamp(_jitteredWindVector, _targetWindJitter, ref _windJitterVelocity, 0.5f,
			float.PositiveInfinity, Time.deltaTime);
		var vector2 = Vector2.MoveTowards(_jitteredWindVector, Vector2.zero, 0.25f);
