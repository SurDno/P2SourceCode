...
namespace Scripts.Utility
{
  public static class EasyUtility
  {
    ...
    public static float QuadraticEaseOut(float p) => (float) -(p * (p - 2.0));
    ...
    public static float BackEaseInOut(float p)
    {
      ...
      float num1 = (float) (1.0 - (2.0 * p - 1.0));
      return (float) (0.5 * (1.0 - (num1 * (double) num1 * num1 - num1 * (double) Mathf.Sin(num1 * 3.14159274f))) + 0.5);
    }

    public static float BounceEaseIn(float p) => 1f - BounceEaseOut(1f - p);
    ...
    public static float BounceEaseOut(float p)
    {
      ...
      return p < 0.89999997615814209 ? (float) (12.066481590270996 * p * p - 19.635457992553711 * p + 8.89806079864502) : (float) (10.800000190734863 * p * p - 20.520000457763672 * p + 10.720000267028809);
    }
