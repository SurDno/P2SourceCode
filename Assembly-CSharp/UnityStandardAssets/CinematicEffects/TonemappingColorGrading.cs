...
namespace UnityStandardAssets.CinematicEffects
{
  ...
  public class TonemappingColorGrading : MonoBehaviour
  {
    ...
    private Texture2D identityLut
    {
      get
      {
        if ((UnityEngine.Object) m_IdentityLut == (UnityEngine.Object) null || m_IdentityLut.height != lutSize)
        {
          UnityEngine.Object.DestroyImmediate((UnityEngine.Object) m_IdentityLut);
    ...
    private RenderTexture internalLutRt
    {
      get
      {
        if ((UnityEngine.Object) m_InternalLut == (UnityEngine.Object) null || !m_InternalLut.IsCreated() || m_InternalLut.height != lutSize)
        {
          UnityEngine.Object.DestroyImmediate((UnityEngine.Object) m_InternalLut);
    ...
    private Texture2D curveTexture
    {
      get
      {
        if ((UnityEngine.Object) m_CurveTexture == (UnityEngine.Object) null)
        {
    ...
    private Texture2D tonemapperCurve
    {
      get
      {
        if ((UnityEngine.Object) m_TonemapperCurve == (UnityEngine.Object) null)
        {
    ...
    private void OnDisable()
    {
      ...
      if ((UnityEngine.Object) m_IdentityLut != (UnityEngine.Object) null)
        UnityEngine.Object.DestroyImmediate((UnityEngine.Object) m_IdentityLut);
      if ((UnityEngine.Object) m_InternalLut != (UnityEngine.Object) null)
        UnityEngine.Object.DestroyImmediate((UnityEngine.Object) internalLutRt);
      if ((UnityEngine.Object) m_SmallAdaptiveRt != (UnityEngine.Object) null)
        UnityEngine.Object.DestroyImmediate((UnityEngine.Object) m_SmallAdaptiveRt);
      if ((UnityEngine.Object) m_CurveTexture != (UnityEngine.Object) null)
        UnityEngine.Object.DestroyImmediate((UnityEngine.Object) m_CurveTexture);
      if ((UnityEngine.Object) m_TonemapperCurve != (UnityEngine.Object) null)
        UnityEngine.Object.DestroyImmediate((UnityEngine.Object) m_TonemapperCurve);
      m_Material = (Material) null;
      m_IdentityLut = (Texture2D) null;
      m_InternalLut = (RenderTexture) null;
      m_SmallAdaptiveRt = (RenderTexture) null;
      m_CurveTexture = (Texture2D) null;
      m_TonemapperCurve = (Texture2D) null;
    }
    ...
    private void GenerateLiftGammaGain(out Color lift, out Color gamma, out Color gain)
    {
      ...
      float r1 = (float) (((double) color1.r - num1) * 0.10000000149011612);
      float g1 = (float) (((double) color1.g - num1) * 0.10000000149011612);
      float b1 = (float) (((double) color1.b - num1) * 0.10000000149011612);
      float b2 = Mathf.Pow(2f, (float) (((double) color2.r - num2) * 0.5));
      float b3 = Mathf.Pow(2f, (float) (((double) color2.g - num2) * 0.5));
      float b4 = Mathf.Pow(2f, (float) (((double) color2.b - num2) * 0.5));
      float r2 = Mathf.Pow(2f, (float) (((double) color3.r - num3) * 0.5));
      float g2 = Mathf.Pow(2f, (float) (((double) color3.g - num3) * 0.5));
      float b5 = Mathf.Pow(2f, (float) (((double) color3.b - num3) * 0.5));
    ...
    {
      validUserLutSize = lut.texture.height == (int) Mathf.Sqrt((float) lut.texture.width);
    ...
    private void OnGUI()
    {
      if (Event.current.type != EventType.Repaint)
        return;
      int y = 0;
      if ((UnityEngine.Object) m_InternalLut != (UnityEngine.Object) null && colorGrading.enabled && colorGrading.showDebug)
      {
        Graphics.DrawTexture(new Rect(0.0f, (float) y, (float) (lutSize * lutSize), (float) lutSize), (Texture) internalLutRt);
        y += lutSize;
      }
      if (!((UnityEngine.Object) m_SmallAdaptiveRt != (UnityEngine.Object) null) || !eyeAdaptation.enabled || !eyeAdaptation.showDebug)
        return;
      m_Material.SetPass(12);
      Graphics.DrawTexture(new Rect(0.0f, (float) y, 256f, 16f), (Texture) m_SmallAdaptiveRt, m_Material);
    }
    ...
    private void OnRenderImage(RenderTexture source, RenderTexture destination)
    {
      ...
      if (eyeAdaptation.enabled)
      {
        ...
        Graphics.Blit((Texture) renderTexture, renderTextureArray[0], material, 1);
        ...
        Graphics.Blit((Texture) source1, m_SmallAdaptiveRt, material, flag ? 3 : 2);
        ...
        material.SetTexture("_LumTex", (Texture) m_SmallAdaptiveRt);
      ...
      if (tonemapping.enabled)
      {
        if (tonemapping.tonemapper == Tonemapper.Curve)
        {
          ...
          material.SetTexture("_ToneCurve", (Texture) tonemapperCurve);
        }
      ...
      if (colorGrading.enabled)
      {
        if (m_Dirty || !m_InternalLut.IsCreated())
        {
          ...
          GenCurveTexture();
          material.SetVector("_WhiteBalance", (Vector4) GetWhiteBalance());
          material.SetVector("_Lift", (Vector4) lift);
          material.SetVector("_Gamma", (Vector4) gamma);
          material.SetVector("_Gain", (Vector4) gain);
          material.SetVector("_ContrastGainGamma", (Vector4) new Vector3(colorGrading.basics.contrast, colorGrading.basics.gain, 1f / colorGrading.basics.gamma));
          ...
          material.SetVector("_ChannelMixerRed", (Vector4) colorGrading.channelMixer.channels[0]);
          material.SetVector("_ChannelMixerGreen", (Vector4) colorGrading.channelMixer.channels[1]);
          material.SetVector("_ChannelMixerBlue", (Vector4) colorGrading.channelMixer.channels[2]);
          material.SetTexture("_CurveTex", (Texture) curveTexture);
          internalLutRt.MarkRestoreExpected();
          Graphics.Blit((Texture) identityLut, internalLutRt, material, 0);
          m_Dirty = false;
        }
        material.EnableKeyword("ENABLE_COLOR_GRADING");
        if (colorGrading.useDithering)
          material.EnableKeyword("ENABLE_DITHERING");
        material.SetTexture("_InternalLutTex", (Texture) internalLutRt);
        material.SetVector("_InternalLutParams", (Vector4) new Vector3(1f / (float) internalLutRt.width, 1f / (float) internalLutRt.height, (float) internalLutRt.height - 1f));
      }
      if (lut.enabled && (UnityEngine.Object) lut.texture != (UnityEngine.Object) null && CheckUserLut())
      {
