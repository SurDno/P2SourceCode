  ...
  public class VignetteAndChromaticAberration : PostEffectsBase
  {
    ...
    private void OnRenderImage(RenderTexture source, RenderTexture destination)
    {
      ...
      else
      {
        ...
        bool flag = Mathf.Abs(blur) > 0.0 || Mathf.Abs(intensity) > 0.0;
        ...
        Graphics.Blit(flag ? renderTexture1 : (Texture) source, destination, m_ChromAberrationMaterial, mode == AberrationMode.Advanced ? 2 : 1);
