...
public class PostProcessingStackOverride : MonoBehaviour {
	[SerializeField] private PostProcessingStackOverride nestedOverride;
	[Space] [SerializeField] private AntialiasingOverride antialiasing;
	[SerializeField] private AmbientOcclusionOverride ambientOcclusion;
	[SerializeField] private ScreenSpaceReflectionOverride screenSpaceReflection;
	[SerializeField] private DepthOfFieldOverride depthOfField;
	[SerializeField] private MotionBlurOverride motionBlur;
	[SerializeField] private ColorGradingOverride colorGrading;
	[SerializeField] private ChromaticAberrationOverride chromaticAberration;
	[SerializeField] private VignetteOverride vignette;
	...
	public void ApplyTo(PostProcessingProfile source, PostProcessingProfile target) {
		...
		screenSpaceReflection.Apply(source.screenSpaceReflection, ref target.screenSpaceReflection,
			ref screenSpaceReflectionModel);
		...
		chromaticAberration.Apply(source.chromaticAberration, ref target.chromaticAberration,
			ref chromaticAberrationModel);
	...
	public class DepthOfFieldOverride : ModelOverride<DepthOfFieldModel> {
		[UnityEngine.Min(0.1f)] [Tooltip("Distance to the point of focus.")]
		...
		protected override void ApplySettings(DepthOfFieldModel source, DepthOfFieldModel target) {
			var settings = source.settings with {
	...
	public class ColorGradingOverride : ModelOverride<ColorGradingModel> {
		...
		public ColorGradingModel.ChannelMixerSettings ChannelMixer =
			ColorGradingModel.Settings.defaultSettings.channelMixer;
	...
	public class ChromaticAberrationOverride :
		...
		[Range(0.0f, 1f)] [Tooltip("Amount of tangential distortion.")]
	...
	public class VignetteOverride : ModelOverride<VignetteModel> {
		...
		[Range(0.0f, 1f)] [Tooltip("Amount of vignetting on screen.")]
