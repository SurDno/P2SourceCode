...
namespace Cinemachine.Utility
{
  public static class UnityVectorExtensions
  {
    ...
    public static float ClosestPointOnSegment(this Vector3 p, Vector3 s0, Vector3 s1)
    {
      ...
      return (double) num < 9.9999997473787516E-05 ? 0.0f : Mathf.Clamp01(Vector3.Dot(p - s0, vector3) / num);
    }
    ...
    public static float ClosestPointOnSegment(this Vector2 p, Vector2 s0, Vector2 s1)
    {
      ...
      return (double) num < 9.9999997473787516E-05 ? 0.0f : Mathf.Clamp01(Vector2.Dot(p - s0, vector2) / num);
    }
    ...
    public static Vector3 SlerpWithReferenceUp(Vector3 vA, Vector3 vB, float t, Vector3 up)
    {
      ...
      if ((double) magnitude1 < 9.9999997473787516E-05 || (double) magnitude2 < 9.9999997473787516E-05)
