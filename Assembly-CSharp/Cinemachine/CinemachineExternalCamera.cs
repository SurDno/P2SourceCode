...
public class CinemachineExternalCamera : CinemachineVirtualCameraBase {
	[Tooltip(
		"The object that the camera is looking at.  Setting this will improve the quality of the blends to and from this camera")]
	[NoSaveDuringPlay]
	...
	public override void UpdateCameraState(Vector3 worldUp, float deltaTime) {
		...
		var vector3 = m_State.ReferenceLookAt - State.RawPosition;
		if (!vector3.AlmostZero())
			m_State.ReferenceLookAt =
				m_State.RawPosition + Vector3.Project(vector3, State.RawOrientation * Vector3.forward);
	}
}