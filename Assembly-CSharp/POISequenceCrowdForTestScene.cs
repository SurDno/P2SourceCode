...
// Type: POISequenceCrowdForTestScene
  ...
  ISerializeDataRead
{
  ...
  {
    this.poiCache.Clear();
    this.FindPOIsInGameObject(this.SearchGO.Value.gameObject, this.poiCache);
  ...
  public new void DataWrite(IDataWriter writer)
  {
    ...
    BehaviorTreeDataWriteUtility.WriteShared<SharedTransform>(writer, "SearchGO", this.SearchGO);
  }
  ...
  public new void DataRead(IDataReader reader, System.Type type)
  {
    ...
    this.SearchGO = BehaviorTreeDataReadUtility.ReadShared<SharedTransform>(reader, "SearchGO", this.SearchGO);
  }
}
