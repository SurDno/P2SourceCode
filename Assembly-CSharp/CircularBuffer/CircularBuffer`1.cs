...
public class CircularBuffer<T> : IEnumerable<T>, IEnumerable {
	...
	public IEnumerator<T> GetEnumerator() {
		var arraySegmentArray = new ArraySegment<T>[2] {
			ArrayOne(),
			ArrayTwo()
		};
		for (var index = 0; index < arraySegmentArray.Length; ++index) {
			var segment = arraySegmentArray[index];
	...
	public T[] ToArray() {
		...
		foreach (var arraySegment in arraySegmentArray) {
