...
public class NPCSoundBankDescription : ScriptableObject {
	...
	[Tooltip("Отходы")] public AudioClip[] StrafeLeftSounds;
	public AudioClip[] StrafeRightSounds;
	public AudioClip[] StepBackSounds;
	[Tooltip("Удар попал в быстрый блок")] public AudioClip[] QuickBlockHittedSounds;
	...
	[Tooltip("Удар ножом попал в тело")] public AudioClip[] StabSounds;
	[Tooltip("Удар ножом попал в блок")] public AudioClip[] StabBlockSounds;
	[Tooltip("Попадание пули")] public AudioClip[] BulletHitSounds;
