...
public class Rootmotion45 : MonoBehaviour {
	[Header("Agent speed")]
	[Tooltip(
		"Желательно подобрать эту скорость максимально близко с скорости цикла шага. Навигационный агент будет передвигаться на такой скорости во время бега.")]
	public float WalkSpeed;

	[Tooltip(
		"Желательно подобрать эту скорость максимально близко с скорости цикла бега. Навигационный агент будет передвигаться на такой скорости во время бега.")]
	...
	[Tooltip("Длина цикла шага в метрах")] public float WalkCycleLength = 1f;
	...
	[Header("Exact positioning data (Run)")] [Tooltip("Длина цикла шага в метрах")]
