...
public class LockPickingPinSpot : MonoBehaviour {
	[Header("Settings")] [SerializeField] private Vector2 rotationRange = new(0.0f, 45f);
	[SerializeField] private float sizeMapping = 10f;
	[SerializeField] private float border;
	[SerializeField] private RectTransform image;
	[Header("State")] [SerializeField] private float size = 0.1f;
	...
	private void ApplyState() {
		...
		var z = Mathf.Lerp(rotationRange.x, rotationRange.y, position);
