...
public class VMSample :
	...
	IEngineTemplated {
	private ulong guid;
	[FieldData("SampleType")] private string sampleTypeStr = "";
	[FieldData("EngineID")] private Guid engineID;
	...
	public virtual bool IsEqual(IObject other) {
		return other != null && typeof(VMSample) == other.GetType() &&
		       (long)BaseGuid == (long)((VMSample)other).BaseGuid;
	}
