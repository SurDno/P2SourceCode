...
[TypeData(EDataType.TCombination)]
[DataFactory("Combination")]
public class VMCombinationItem : VMWorldObject, IStub, IEditorDataReader {
	...
	public VMCombinationItem(ulong guid)
		: base(guid) { }
	...
	public override bool IsPhysic => false;
}