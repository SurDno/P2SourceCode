...
public class VMSampleRef :
	...
	public void Initialize(ISample obj) {
	...
	public override VMType Type =>
		Sample != null ? new VMType(typeof(ISampleRef), Sample.SampleType) : new VMType(typeof(ISampleRef));
	...
	protected override void Load() {
		...
		if (StaticInstance == null && engineSampleGuid != Guid.Empty)
			LoadStaticInstance(IStaticDataContainer.StaticDataContainer.GetObjectByGuid(
				IStaticDataContainer.StaticDataContainer.GameRoot.GetBaseGuidByEngineTemplateGuid(engineSampleGuid)));
