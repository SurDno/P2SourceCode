...
public static class Paths {
	...
	public static readonly List<string> ComplexExts = new() {
		"_AI.asset",
		"_Blueprint.prefab",
		"_ItemSoundGroup.asset"
	};

	public static readonly HashSet<string> AudioExts = new() {
		".aif",
		".wav",
		".mp3",
		".ogg",
	...
	public static readonly HashSet<string> TextureExts = new() {
		".bmp",
		".tif",
		".tga",
		".jpg",
	...
	public static readonly HashSet<string> ReferenceExts = new() {
		".unity",
		".prefab",
		".fbx",
		".bytes",
	...
	public static readonly List<string> ContentFolders = new() {
