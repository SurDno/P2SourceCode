...
namespace PLVirtualMachine.Common.EngineAPI.VMECS
{
  ...
  public class VMBehavior : VMEngineComponent<IBehaviorComponent>
  {
    ...
    public void SetValue(string name, IEntity value) => Component.SetValue(name, value);

    [Method("SetBoolValue", "name,value", "")]
    public void SetBoolValue(string name, bool value) => Component.SetBoolValue(name, value);

    [Method("SetIntValue", "name,value", "")]
    public void SetIntValue(string name, int value) => Component.SetIntValue(name, value);
